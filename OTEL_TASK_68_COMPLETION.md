...
Verified that all 13 MCP tools in `crates/mcpp-a2a-mcp/` emit proper OpenTelemetry (OTEL) spans with required attributes.
...
| **Tools with `mcpp.mcp.tool_call` span** | 13 | ✅ 100% |
...
|---|------|-----------|-----------------|---------------------|
| 1 | `generate` | ✅ | mcpp_server.rs:355 | ✅ `mcp.tool_name="generate"` |
| 2 | `validate` | ✅ | mcpp_server.rs:431 | ✅ `mcp.tool_name="validate"` |
| 3 | `sync` | ✅ | mcpp_server.rs:489 | ✅ `mcp.tool_name="sync"` |
| 4 | `list_generators` | ✅ | mcpp_server.rs:567 | ✅ `mcp.tool_name="list_generators"` |
| 5 | `list_examples` | ✅ | mcpp_server.rs:593 | ✅ `mcp.tool_name="list_examples"` |
| 6 | `get_example` | ✅ | mcpp_server.rs:636 | ✅ `mcp.tool_name="get_example"` |
| 7 | `search` | ✅ | mcpp_server.rs:689 | ✅ `mcp.tool_name="search"` |
| 8 | `scaffold_from_example` | ✅ | mcpp_server.rs:751 | ✅ `mcp.tool_name="scaffold_from_example"` |
| 9 | `query_ontology` | ✅ | mcpp_server.rs:805 | ✅ `mcp.tool_name="query_ontology"` |
| 10 | `validate_pipeline` | ✅ | mcpp_server.rs:912 | ✅ `mcp.tool_name="validate_pipeline"` |
| 11 | `validate_sparql` | ✅ | mcpp_server.rs:1015 | ✅ `mcp.tool_name="validate_sparql"` |
| 12 | `validate_templates` | ✅ | mcpp_server.rs:1066 | ✅ `mcp.tool_name="validate_templates"` |
| 13 | `fix_cycles` | ✅ | mcpp_server.rs:1139 | ✅ `mcp.tool_name="fix_cycles"` |
...
**File:** `crates/mcpp-a2a-mcp/src/lib.rs`
...
✅ **Spans exist** - All 13 tools emit `mcpp.mcp.tool_call` spans
...
1. **`crates/mcpp-a2a-mcp/tests/verify_otel_spans.rs`** - Test to verify all 13 tools are registered
...
grep -c "MCP_TOOL_NAME" crates/mcpp-a2a-mcp/src/mcpp_server.rs
# Output: 13

# Run verification test
cargo test -p mcpp-a2a-mcp --test verify_otel_spans

# Check runtime spans
export RUST_LOG=trace,mcpp_a2a_mcp=trace
cargo test -p mcpp-a2a-mcp 2>&1 | grep "mcpp.mcp.tool_call"
```
...
- Runtime: Test logs show `mcpp.mcp.tool_call` spans
