...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let sparql_result = generator.json_to_sparql(&sparql_json)?;
    ...
    let complex_sparql = generator.json_to_sparql(&complex_json)?;
    ...
    let ask_sparql = generator.json_to_sparql(&ask_json)?;
    println!("\n❓ ASK query:");
    println!("{}", ask_sparql);
