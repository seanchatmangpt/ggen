...
- [ggen - Ontology-Driven Code Generation](#ggen---ontology-driven-code-generation)
  - [🎉 What's New in v6](#-whats-new-in-v6)
    ...
    - [At-a-Glance Statistics](#at-a-glance-statistics)
  ...
  - [Quick Start (5 Minutes)](#quick-start-5-minutes)
    ...
    - [Your First ggen v6 Project (5 minutes)](#your-first-ggen-v6-project-5-minutes)
    - [Alternative Quick Starts](#alternative-quick-starts)
      - [Option A: Traditional (RDF → Code)](#option-a-traditional-rdf-%E2%86%92-code)
      - [Option B: AI-Powered (English → RDF → Code)](#option-b-ai-powered-english-%E2%86%92-rdf-%E2%86%92-code)
      - [Option C: Infrastructure (RDF → Docker/K8s/Terraform)](#option-c-infrastructure-rdf-%E2%86%92-dockerk8sterraform)
    - [What's New in v6?](#whats-new-in-v6)
    - [Next Steps](#next-steps)
  - [LLM-Construct Pattern](#llm-construct-pattern)
    - [Quick Start](#quick-start)
    - [Why LLM-Construct?](#why-llm-construct)
    - [How It Works](#how-it-works)
    - [Complete Examples](#complete-examples)
    - [Documentation](#documentation)
    - [Integration with ggen](#integration-with-ggen)
  - [AI-Powered Generation](#ai-powered-generation)
    - [DSPy-Inspired API](#dspy-inspired-api)
