...
- [ggen](#ggen)
  ...
  - [⚡ Quick Win (60 Seconds)](#-quick-win-60-seconds)
  - [🆚 Comparison](#-comparison)
    - [ggen vs. Traditional Approaches](#ggen-vs-traditional-approaches)
  - [🗺️ Documentation Navigator](#-documentation-navigator)
    - [📖 Learn by Doing](#-learn-by-doing)
    - [🛠️ Solve a Specific Problem](#-solve-a-specific-problem)
    - [💡 Understand the Concepts](#-understand-the-concepts)
    - [📋 Look Up Technical Details](#-look-up-technical-details)
  - [Installation](#installation)
    - [Prerequisites](#prerequisites)
    - [Method 1: Homebrew (macOS/Linux)](#method-1-homebrew-macoslinux)
    - [Method 2: Cargo (Cross-platform)](#method-2-cargo-cross-platform)
    - [Method 3: From Source](#method-3-from-source)
    - [Quick Verification (30 seconds)](#quick-verification-30-seconds)
  - [CLI Reference](#cli-reference)
    - [Template Management](#template-management)
    - [RDF Graph Operations](#rdf-graph-operations)
  ...
  - [Architecture](#architecture)
    ...
    - [Workspace Crates (14)](#workspace-crates-14)
    - [Technology Stack](#technology-stack)
    - [Design Philosophy](#design-philosophy)
  - [Configuration](#configuration)
    - [Project Config: `ggen.toml`](#project-config-ggentoml)
    - [Package Config: `gpack.toml`](#package-config-gpacktoml)
  - [Performance](#performance)
    - [Benchmarks (v4.0.0)](#benchmarks-v400)
    - [Quality Metrics](#quality-metrics)
  - [Features](#features)
    - [Production-Ready Capabilities](#production-ready-capabilities)
    - [Built-in Templates (22)](#built-in-templates-22)
  - [Use Cases](#use-cases)
    - [What ggen Excels At](#what-ggen-excels-at)
  ...
  - [Development](#development)
    ...
    - [Spec-First Workflow (Required)](#spec-first-workflow-required)
