...
**Evidence Location:**
- `~/.ggen/mcpp/specs/007-cli-jtbd-audit/evidence/` - 23 total YAML files
...
**Evidence**: `~/.ggen/mcpp/specs/007-cli-jtbd-audit/checklists/requirements.md`
...
- `~/.ggen/mcpp/specs/007-cli-jtbd-audit/GAP-ANALYSIS-80-20.json`
