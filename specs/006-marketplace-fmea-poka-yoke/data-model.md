...
### Core Types (mcpp-core)

```rust
//! crates/mcpp-core/src/types/fmea.rs
...
```rust
//! crates/mcpp-core/src/types/enterprise.rs
...
impl Default for PokaYokeConfig {
    fn default() -> Self {
        Self {
            generated_file_header: "⚠️ DO NOT EDIT - This file is auto-generated by mcpp".into(),
...
### Package Extensions (mcpp-domain)

```rust
//! crates/mcpp-domain/src/package/mod.rs (extension)

use mcpp_core::types::{EnterpriseConfig, GenerationConfig, PokaYokeConfig, FmeaConfig};
...
│  - NOT a mcpp bug - intentional design                │
└───────────────────────────────────────────────────────┘
```
...
// @generated by mcpp from RDF ontology
//
// Regenerate with:
//   mcpp generate --template clap-noun-verb --domain cli.ttl
//
