...
- **Existing use**: mcpp already uses `glob` crate; `globset` is compatible
...
//
// Regenerate with:
//   mcpp generate --template <template> --domain <domain.rdf>
//
...
Regenerate with:
  mcpp generate --template {template} --domain {domain}
...
```text
# Auto-generated by mcpp from noun OWNERS files
# DO NOT EDIT - regenerate with: mcpp generate --codeowners
