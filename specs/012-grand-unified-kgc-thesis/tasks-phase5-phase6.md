...
- [ ] **T051** [P] [US3] Define temporal event sourcing entities in RDF schema
  - **Path**: `~/.ggen/mcpp/specs/012-grand-unified-kgc-thesis/ontology/thesis-schema.ttl`
...
- [ ] **T052** [P] [US3] Author Chapter 4 introduction and temporal model overview
  - **Path**: `~/.ggen/mcpp/specs/012-grand-unified-kgc-thesis/ontology/kgc-unified-content.ttl`
...
- [ ] **T071** [US4] Create table showing fidelity measurements across targets
  ...
  - **AC**: Table 3 rows (Rust/TS/Python) × 4 cols (H(O), I(O;C), Φ, D), Rust highest fidelity (types preserve info), Python lowest (dynamic typing), values from actual mcpp, labeled tab:fidelity-comparison, references Chapter 5 TanStack case study
  - **Deps**: T069, T070
  - **Time**: 2h
