# mcpp v6 - 80/20 Implementation Plan
...
| 5 | **`mcpp sync` Command** | 2 | User-facing CLI. Makes it usable. |
...
### CAP-005: mcpp sync (2 days)

**What**: CLI command reading mcpp.toml
...
4. **Scale**: Apply to larger project (mcpp itself)
