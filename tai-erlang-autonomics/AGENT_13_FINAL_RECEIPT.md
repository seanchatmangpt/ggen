...
**File**: `~/.ggen/mcpp/tai-erlang-autonomics/apps/tai_autonomics/test/taiea_http_governor_integration_SUITE.erl`
...
**File**: `~/.ggen/mcpp/tai-erlang-autonomics/INTEGRATION_TEST_MATRIX.md`
...
### 3. Quick Start Guide
**File**: `~/.ggen/mcpp/tai-erlang-autonomics/INTEGRATION_TESTS_QUICK_START.md`
...
### 4. Delivery Summary
**File**: `~/.ggen/mcpp/tai-erlang-autonomics/AGENT_13_DELIVERY_SUMMARY.md`
...
**File**: `~/.ggen/mcpp/tai-erlang-autonomics/AGENT_13_FINAL_RECEIPT.md`
