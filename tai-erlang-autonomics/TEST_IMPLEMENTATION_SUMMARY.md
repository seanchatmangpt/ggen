...
### 1. HTTP Server Tests
**Path**: `~/.ggen/mcpp/tai-erlang-autonomics/apps/tai_autonomics/test/taiea_http_server_test.erl`
...
**Path**: `~/.ggen/mcpp/tai-erlang-autonomics/apps/tai_autonomics/test/taiea_core_app_test.erl`
...
### 3. Documentation
**Path**: `~/.ggen/mcpp/tai-erlang-autonomics/UNIT_TESTS_REPORT.md`
