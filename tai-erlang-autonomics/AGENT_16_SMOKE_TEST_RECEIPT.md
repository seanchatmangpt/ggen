...
**Location**: `~/.ggen/mcpp/tai-erlang-autonomics/tools/run_release.sh`
...
**Location**: `~/.ggen/mcpp/tai-erlang-autonomics/tools/smoke.sh`
...
ls -la ~/.ggen/mcpp/tai-erlang-autonomics/tools/

# Verify scripts are valid shell syntax
bash -n ~/.ggen/mcpp/tai-erlang-autonomics/tools/run_release.sh
bash -n ~/.ggen/mcpp/tai-erlang-autonomics/tools/smoke.sh

# Check file sizes
wc -l ~/.ggen/mcpp/tai-erlang-autonomics/tools/*.sh
```
