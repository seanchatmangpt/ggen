...
**Test Modules**: `~/.ggen/mcpp/tai-erlang-autonomics/test/perf_benchmarks/`
...
**Documentation**: `~/.ggen/mcpp/tai-erlang-autonomics/test/perf_benchmarks/`
- PERFORMANCE_REPORT.md
- README.md
- BENCHMARKING_GUIDE.md
- IMPLEMENTATION_SUMMARY.md

**Scripts**: `~/.ggen/mcpp/tai-erlang-autonomics/scripts/`
