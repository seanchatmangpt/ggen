...
> **Outcome:** Construct and verify the consumer project for **150. `ggen.toml`**.

This is chapter **150 of 336**. Its output becomes an input to the later certification laboratories.
