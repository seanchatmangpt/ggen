...
> **Outcome:** Construct and verify the consumer project for **158. Run the Consumer**.

This is chapter **158 of 336**. Its output becomes an input to the later certification laboratories.
