...
> **Outcome:** Construct and verify the consumer project for **155. Engine-Owned Aggregators**.

This is chapter **155 of 336**. Its output becomes an input to the later certification laboratories.
