...
> **Outcome:** Construct and verify the consumer project for **151. Path Dependencies**.

This is chapter **151 of 336**. Its output becomes an input to the later certification laboratories.
