...
> **Outcome:** Construct and verify the five-crate workspace for **257. `tcps-wasm`**.

This is chapter **257 of 336**. Its output becomes an input to the later certification laboratories.
