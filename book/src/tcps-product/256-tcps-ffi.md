...
> **Outcome:** Construct and verify the five-crate workspace for **256. `tcps-ffi`**.

This is chapter **256 of 336**. Its output becomes an input to the later certification laboratories.
