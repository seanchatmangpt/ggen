...
> **Outcome:** Construct and verify the five-crate workspace for **255. `tcps-std`**.

This is chapter **255 of 336**. Its output becomes an input to the later certification laboratories.
