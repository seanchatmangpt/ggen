...
> **Outcome:** Construct and verify the five-crate workspace for **260. Generate Cross-Crate Dependencies**.

This is chapter **260 of 336**. Its output becomes an input to the later certification laboratories.
