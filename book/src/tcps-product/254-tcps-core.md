...
> **Outcome:** Construct and verify the five-crate workspace for **254. `tcps-core`**.

This is chapter **254 of 336**. Its output becomes an input to the later certification laboratories.
