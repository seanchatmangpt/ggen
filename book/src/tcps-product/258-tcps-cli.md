...
> **Outcome:** Construct and verify the five-crate workspace for **258. `tcps-cli`**.

This is chapter **258 of 336**. Its output becomes an input to the later certification laboratories.
