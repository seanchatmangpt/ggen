...
> **Outcome:** Construct and verify the five-crate workspace for **259. Generate the Workspace `Cargo.toml`**.

This is chapter **259 of 336**. Its output becomes an input to the later certification laboratories.
