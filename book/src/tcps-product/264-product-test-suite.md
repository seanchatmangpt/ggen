...
> **Outcome:** Construct and verify the five-crate workspace for **264. Run the Richer Product Test Suite**.

This is chapter **264 of 336**. Its output becomes an input to the later certification laboratories.
