...
> **Outcome:** Construct and verify the RDF source law for **77. Modeling Files and Output Paths**.

This is chapter **77 of 336**. Its output becomes an input to the later certification laboratories.
