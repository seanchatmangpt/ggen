...
> **Outcome:** Construct and verify the RDF source law for **72. Modeling Types**.

This is chapter **72 of 336**. Its output becomes an input to the later certification laboratories.
