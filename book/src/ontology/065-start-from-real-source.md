...
> **Outcome:** Construct and verify the RDF source law for **65. Start from Real Source**.

This is chapter **65 of 336**. Its output becomes an input to the later certification laboratories.
