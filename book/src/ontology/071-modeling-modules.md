...
> **Outcome:** Construct and verify the RDF source law for **71. Modeling Modules**.

This is chapter **71 of 336**. Its output becomes an input to the later certification laboratories.
