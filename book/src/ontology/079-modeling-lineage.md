...
> **Outcome:** Construct and verify the RDF source law for **79. Modeling Historical Lineage**.

This is chapter **79 of 336**. Its output becomes an input to the later certification laboratories.
