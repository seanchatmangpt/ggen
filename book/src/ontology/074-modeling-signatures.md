...
> **Outcome:** Construct and verify the RDF source law for **74. Modeling Parameters and Return Types**.

This is chapter **74 of 336**. Its output becomes an input to the later certification laboratories.
