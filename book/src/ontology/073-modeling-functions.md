...
> **Outcome:** Construct and verify the RDF source law for **73. Modeling Functions**.

This is chapter **73 of 336**. Its output becomes an input to the later certification laboratories.
