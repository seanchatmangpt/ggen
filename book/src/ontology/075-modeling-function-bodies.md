...
> **Outcome:** Construct and verify the RDF source law for **75. Modeling Function Bodies**.

This is chapter **75 of 336**. Its output becomes an input to the later certification laboratories.
