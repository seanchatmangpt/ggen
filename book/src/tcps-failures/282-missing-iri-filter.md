...
> **Outcome:** Construct and verify the corrective-action record for **282. The Missing IRI Filter**.

This is chapter **282 of 336**. Its output becomes an input to the later certification laboratories.
