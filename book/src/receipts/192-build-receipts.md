...
> **Outcome:** Construct and verify the receipt chain for **192. Build Receipts**.

This is chapter **192 of 336**. Its output becomes an input to the later certification laboratories.
