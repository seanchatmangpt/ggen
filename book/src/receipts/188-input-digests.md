...
> **Outcome:** Construct and verify the receipt chain for **188. Input Digests**.

This is chapter **188 of 336**. Its output becomes an input to the later certification laboratories.
