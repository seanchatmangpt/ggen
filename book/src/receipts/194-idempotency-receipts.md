...
> **Outcome:** Construct and verify the receipt chain for **194. Idempotency Receipts**.

This is chapter **194 of 336**. Its output becomes an input to the later certification laboratories.
