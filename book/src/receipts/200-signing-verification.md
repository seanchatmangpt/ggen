...
> **Outcome:** Construct and verify the receipt chain for **200. Signing and Verification**.

This is chapter **200 of 336**. Its output becomes an input to the later certification laboratories.
