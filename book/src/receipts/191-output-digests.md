...
> **Outcome:** Construct and verify the receipt chain for **191. Output Digests**.

This is chapter **191 of 336**. Its output becomes an input to the later certification laboratories.
