...
> **Outcome:** Construct and verify the receipt chain for **196. `MANIFEST.256`**.

This is chapter **196 of 336**. Its output becomes an input to the later certification laboratories.
