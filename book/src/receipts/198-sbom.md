...
> **Outcome:** Construct and verify the receipt chain for **198. CycloneDX and SPDX**.

This is chapter **198 of 336**. Its output becomes an input to the later certification laboratories.
