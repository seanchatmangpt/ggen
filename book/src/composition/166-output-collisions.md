...
> **Outcome:** Construct and verify the composition boundary for **166. Output-Path Collisions**.

This is chapter **166 of 336**. Its output becomes an input to the later certification laboratories.
