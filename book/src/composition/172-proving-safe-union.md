...
> **Outcome:** Construct and verify the composition boundary for **172. Proving Safe Union**.

This is chapter **172 of 336**. Its output becomes an input to the later certification laboratories.
