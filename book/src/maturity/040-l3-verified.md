...
> **Outcome:** Construct and verify the maturity cell for **40. L3: Verified**.

This is chapter **40 of 336**. Its output becomes an input to the later certification laboratories.
