...
> **Outcome:** Construct and verify the maturity cell for **39. L2: Consumed**.

This is chapter **39 of 336**. Its output becomes an input to the later certification laboratories.
