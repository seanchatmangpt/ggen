...
> **Outcome:** Construct and verify the engine capability for **203. Engine-Generated Module Aggregation**.

This is chapter **203 of 336**. Its output becomes an input to the later certification laboratories.
