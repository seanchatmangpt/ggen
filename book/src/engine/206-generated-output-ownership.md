...
> **Outcome:** Construct and verify the engine capability for **206. Generated-Output Ownership**.

This is chapter **206 of 336**. Its output becomes an input to the later certification laboratories.
