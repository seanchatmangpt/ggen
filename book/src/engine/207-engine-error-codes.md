...
> **Outcome:** Construct and verify the engine capability for **207. Engine Error Codes**.

This is chapter **207 of 336**. Its output becomes an input to the later certification laboratories.
