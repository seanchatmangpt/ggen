...
> **Outcome:** Construct and verify the engine capability for **209. FM-WRITE-005 and FM-WRITE-008**.

This is chapter **209 of 336**. Its output becomes an input to the later certification laboratories.
