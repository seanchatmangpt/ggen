...
> **Outcome:** Construct and verify the reference oracle for **55. Reference Source Trees**.

This is chapter **55 of 336**. Its output becomes an input to the later certification laboratories.
