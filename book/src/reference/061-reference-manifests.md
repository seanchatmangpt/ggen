...
> **Outcome:** Construct and verify the reference oracle for **61. Reference Manifests**.

This is chapter **61 of 336**. Its output becomes an input to the later certification laboratories.
