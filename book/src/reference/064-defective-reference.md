...
> **Outcome:** Construct and verify the reference oracle for **64. When the Reference Is Defective**.

This is chapter **64 of 336**. Its output becomes an input to the later certification laboratories.
