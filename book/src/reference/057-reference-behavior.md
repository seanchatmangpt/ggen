...
> **Outcome:** Construct and verify the reference oracle for **57. Reference Behavior**.

This is chapter **57 of 336**. Its output becomes an input to the later certification laboratories.
