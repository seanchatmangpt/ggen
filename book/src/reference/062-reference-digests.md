...
> **Outcome:** Construct and verify the reference oracle for **62. Reference Digests**.

This is chapter **62 of 336**. Its output becomes an input to the later certification laboratories.
