...
> **Outcome:** Construct and verify the reference oracle for **60. Read-Only Reference Fixtures**.

This is chapter **60 of 336**. Its output becomes an input to the later certification laboratories.
