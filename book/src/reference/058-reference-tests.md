...
> **Outcome:** Construct and verify the reference oracle for **58. Reference Tests**.

This is chapter **58 of 336**. Its output becomes an input to the later certification laboratories.
