...
> **Outcome:** Construct and verify the pack classification for **28. Type Three: Case-Study Corpus Packs**.

This is chapter **28 of 336**. Its output becomes an input to the later certification laboratories.
