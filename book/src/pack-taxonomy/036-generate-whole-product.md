...
> **Outcome:** Construct and verify the pack classification for **36. When the Pack Must Generate a Whole Product**.

This is chapter **36 of 336**. Its output becomes an input to the later certification laboratories.
