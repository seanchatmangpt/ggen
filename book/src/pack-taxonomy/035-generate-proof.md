...
> **Outcome:** Construct and verify the pack classification for **35. When the Pack Must Generate Proof**.

This is chapter **35 of 336**. Its output becomes an input to the later certification laboratories.
