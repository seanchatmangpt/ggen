...
> **Outcome:** Construct and verify the inspection receipt for **294. Record `cargo clippy -- -D warnings`**.

This is chapter **294 of 336**. Its output becomes an input to the later certification laboratories.
