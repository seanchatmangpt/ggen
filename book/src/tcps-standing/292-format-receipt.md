...
> **Outcome:** Construct and verify the inspection receipt for **292. Record `cargo fmt --check`**.

This is chapter **292 of 336**. Its output becomes an input to the later certification laboratories.
