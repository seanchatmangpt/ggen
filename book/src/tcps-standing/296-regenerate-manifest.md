...
> **Outcome:** Construct and verify the inspection receipt for **296. Regenerate `MANIFEST.256`**.

This is chapter **296 of 336**. Its output becomes an input to the later certification laboratories.
