...
> **Outcome:** Construct and verify the release system for **265. Create `tcps-release-pack`**.

This is chapter **265 of 336**. Its output becomes an input to the later certification laboratories.
