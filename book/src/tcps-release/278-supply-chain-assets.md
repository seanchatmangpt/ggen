...
> **Outcome:** Construct and verify the release system for **278. Generate SBOM, Provenance, and Signing Paths**.

This is chapter **278 of 336**. Its output becomes an input to the later certification laboratories.
