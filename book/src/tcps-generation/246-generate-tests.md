...
> **Outcome:** Construct and verify the tcps-core-pack for **246. Generate the Original `試験.rs`**.

This is chapter **246 of 336**. Its output becomes an input to the later certification laboratories.
