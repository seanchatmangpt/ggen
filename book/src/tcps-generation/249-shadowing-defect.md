...
> **Outcome:** Construct and verify the tcps-core-pack for **249. Fix the Module/Struct Shadowing Defect**.

This is chapter **249 of 336**. Its output becomes an input to the later certification laboratories.
