...
> **Outcome:** Construct and verify the tcps-core-pack for **241. Create `tcps-core-pack`**.

This is chapter **241 of 336**. Its output becomes an input to the later certification laboratories.
