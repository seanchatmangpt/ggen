...
> **Outcome:** Construct and verify the tcps-core-pack for **242. Transcribe the Reference into RDF**.

This is chapter **242 of 336**. Its output becomes an input to the later certification laboratories.
