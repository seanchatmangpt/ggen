...
> **Outcome:** Construct and verify the tcps-core-pack for **247. Run the Reference Tests Unmodified**.

This is chapter **247 of 336**. Its output becomes an input to the later certification laboratories.
