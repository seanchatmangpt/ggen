...
> **Outcome:** Construct and verify the tcps-core-pack for **245. Generate Typestate Transitions**.

This is chapter **245 of 336**. Its output becomes an input to the later certification laboratories.
