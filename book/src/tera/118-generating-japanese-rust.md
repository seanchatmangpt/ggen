...
> **Outcome:** Construct and verify the Tera projection for **118. Generating Japanese Rust**.

This is chapter **118 of 336**. Its output becomes an input to the later certification laboratories.
