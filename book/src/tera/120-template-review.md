...
> **Outcome:** Construct and verify the Tera projection for **120. Template Review as Compiler Review**.

This is chapter **120 of 336**. Its output becomes an input to the later certification laboratories.
