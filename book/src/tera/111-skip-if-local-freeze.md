...
> **Outcome:** Construct and verify the Tera projection for **111. `skip_if` and Local Freeze**.

This is chapter **111 of 336**. Its output becomes an input to the later certification laboratories.
