...
> **Outcome:** Construct and verify the Tera projection for **109. Output Ownership**.

This is chapter **109 of 336**. Its output becomes an input to the later certification laboratories.
