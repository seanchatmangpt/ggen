...
> **Outcome:** Construct and verify the Tera projection for **117. Unicode Identifiers**.

This is chapter **117 of 336**. Its output becomes an input to the later certification laboratories.
