...
> **Outcome:** Construct and verify the Tera projection for **112. Injection Modes**.

This is chapter **112 of 336**. Its output becomes an input to the later certification laboratories.
