...
> **Outcome:** Construct and verify the Tera projection for **110. `force` and Regeneration**.

This is chapter **110 of 336**. Its output becomes an input to the later certification laboratories.
