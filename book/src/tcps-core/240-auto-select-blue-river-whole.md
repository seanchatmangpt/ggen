...
> **Outcome:** Construct and verify the Japanese TPS domain for **240. 自動選択, 青い川のダム, 全体**.

This is chapter **240 of 336**. Its output becomes an input to the later certification laboratories.
