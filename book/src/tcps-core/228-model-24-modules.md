...
> **Outcome:** Construct and verify the Japanese TPS domain for **228. Model the 24 Reference Modules**.

This is chapter **228 of 336**. Its output becomes an input to the later certification laboratories.
