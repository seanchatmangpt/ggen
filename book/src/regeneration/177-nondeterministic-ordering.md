...
> **Outcome:** Construct and verify the regeneration gate for **177. Detect Nondeterministic Ordering**.

This is chapter **177 of 336**. Its output becomes an input to the later certification laboratories.
