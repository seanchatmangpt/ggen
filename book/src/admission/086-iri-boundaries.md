...
> **Outcome:** Construct and verify the SPARQL admission gate for **86. IRI Boundaries**.

This is chapter **86 of 336**. Its output becomes an input to the later certification laboratories.
