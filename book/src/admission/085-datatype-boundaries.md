...
> **Outcome:** Construct and verify the SPARQL admission gate for **85. Datatype Boundaries**.

This is chapter **85 of 336**. Its output becomes an input to the later certification laboratories.
