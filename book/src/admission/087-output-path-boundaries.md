...
> **Outcome:** Construct and verify the SPARQL admission gate for **87. Output-Path Boundaries**.

This is chapter **87 of 336**. Its output becomes an input to the later certification laboratories.
