...
> **Outcome:** Construct and verify the SPARQL admission gate for **90. Cross-Resource Constraints**.

This is chapter **90 of 336**. Its output becomes an input to the later certification laboratories.
