...
> **Outcome:** Construct and verify the SPARQL admission gate for **92. Negative Fixtures**.

This is chapter **92 of 336**. Its output becomes an input to the later certification laboratories.
