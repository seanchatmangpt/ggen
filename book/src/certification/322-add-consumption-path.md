# 322. Laboratory Two: Add a Real Consumption Path

> **Outcome:** Construct and verify the certification bundle for **322. Laboratory Two: Add a Real Consumption Path**.

This is chapter **322 of 336**. Its output becomes an input to the later certification laboratories.
