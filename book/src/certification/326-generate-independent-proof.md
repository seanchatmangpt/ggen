# 326. Laboratory Six: Generate an Independent Proof

> **Outcome:** Construct and verify the certification bundle for **326. Laboratory Six: Generate an Independent Proof**.

This is chapter **326 of 336**. Its output becomes an input to the later certification laboratories.
