# 332. Laboratory Twelve: Emit a Complete Receipt Chain

> **Outcome:** Construct and verify the certification bundle for **332. Laboratory Twelve: Emit a Complete Receipt Chain**.

This is chapter **332 of 336**. Its output becomes an input to the later certification laboratories.
