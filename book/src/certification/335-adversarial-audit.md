# 335. Laboratory Fifteen: Run the Final Adversarial Audit

> **Outcome:** Construct and verify the certification bundle for **335. Laboratory Fifteen: Run the Final Adversarial Audit**.

This is chapter **335 of 336**. Its output becomes an input to the later certification laboratories.
