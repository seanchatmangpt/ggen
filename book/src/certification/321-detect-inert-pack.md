# 321. Laboratory One: Detect an Inert Pack

> **Outcome:** Construct and verify the certification bundle for **321. Laboratory One: Detect an Inert Pack**.

This is chapter **321 of 336**. Its output becomes an input to the later certification laboratories.
