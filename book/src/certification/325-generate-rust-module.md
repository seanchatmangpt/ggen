# 325. Laboratory Five: Generate a Complete Rust Module

> **Outcome:** Construct and verify the certification bundle for **325. Laboratory Five: Generate a Complete Rust Module**.

This is chapter **325 of 336**. Its output becomes an input to the later certification laboratories.
