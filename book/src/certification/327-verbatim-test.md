# 327. Laboratory Seven: Reuse a Verbatim Test

> **Outcome:** Construct and verify the certification bundle for **327. Laboratory Seven: Reuse a Verbatim Test**.

This is chapter **327 of 336**. Its output becomes an input to the later certification laboratories.
