# 324. Laboratory Four: Resolve Output Ownership

> **Outcome:** Construct and verify the certification bundle for **324. Laboratory Four: Resolve Output Ownership**.

This is chapter **324 of 336**. Its output becomes an input to the later certification laboratories.
