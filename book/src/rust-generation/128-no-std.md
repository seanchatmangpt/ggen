...
> **Outcome:** Construct and verify the Rust subsystem for **128. Generate `no_std` Code**.

This is chapter **128 of 336**. Its output becomes an input to the later certification laboratories.
