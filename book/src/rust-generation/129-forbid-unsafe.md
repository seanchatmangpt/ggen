...
> **Outcome:** Construct and verify the Rust subsystem for **129. Forbid Unsafe Code**.

This is chapter **129 of 336**. Its output becomes an input to the later certification laboratories.
