...
> **Outcome:** Construct and verify the Rust subsystem for **122. Generate Public Types**.

This is chapter **122 of 336**. Its output becomes an input to the later certification laboratories.
