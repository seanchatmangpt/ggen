...
> **Outcome:** Construct and verify the Rust subsystem for **126. Generate Functions**.

This is chapter **126 of 336**. Its output becomes an input to the later certification laboratories.
