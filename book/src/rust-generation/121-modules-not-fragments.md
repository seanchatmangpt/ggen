...
> **Outcome:** Construct and verify the Rust subsystem for **121. Generate Modules, Not Fragments**.

This is chapter **121 of 336**. Its output becomes an input to the later certification laboratories.
