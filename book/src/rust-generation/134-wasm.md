...
> **Outcome:** Construct and verify the Rust subsystem for **134. Generate WebAssembly Surfaces**.

This is chapter **134 of 336**. Its output becomes an input to the later certification laboratories.
