...
> **Outcome:** Construct and verify the Rust subsystem for **127. Generate Typestate**.

This is chapter **127 of 336**. Its output becomes an input to the later certification laboratories.
