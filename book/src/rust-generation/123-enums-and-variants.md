...
> **Outcome:** Construct and verify the Rust subsystem for **123. Generate Enums and Variants**.

This is chapter **123 of 336**. Its output becomes an input to the later certification laboratories.
