...
> **Outcome:** Construct and verify the Rust subsystem for **133. Generate C ABI Surfaces**.

This is chapter **133 of 336**. Its output becomes an input to the later certification laboratories.
