...
> **Outcome:** Construct and verify the Rust subsystem for **132. Generate Multiple Crates**.

This is chapter **132 of 336**. Its output becomes an input to the later certification laboratories.
