...
> **Outcome:** Construct and verify the Rust subsystem for **124. Generate Structs and Fields**.

This is chapter **124 of 336**. Its output becomes an input to the later certification laboratories.
