...
> **Outcome:** Construct and verify the projection query for **95. SELECT as a Typed Extraction Surface**.

This is chapter **95 of 336**. Its output becomes an input to the later certification laboratories.
