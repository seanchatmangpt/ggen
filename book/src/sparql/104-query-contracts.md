...
> **Outcome:** Construct and verify the projection query for **104. Query Contracts**.

This is chapter **104 of 336**. Its output becomes an input to the later certification laboratories.
