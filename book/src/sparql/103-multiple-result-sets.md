...
> **Outcome:** Construct and verify the projection query for **103. Multiple Result Sets**.

This is chapter **103 of 336**. Its output becomes an input to the later certification laboratories.
