...
> **Outcome:** Construct and verify the projection query for **102. Coalescing Missing Documentation**.

This is chapter **102 of 336**. Its output becomes an input to the later certification laboratories.
