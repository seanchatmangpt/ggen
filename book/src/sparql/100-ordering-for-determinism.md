...
> **Outcome:** Construct and verify the projection query for **100. Ordering for Determinism**.

This is chapter **100 of 336**. Its output becomes an input to the later certification laboratories.
