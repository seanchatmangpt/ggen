...
> **Outcome:** Construct and verify the projection query for **105. Query Fixtures**.

This is chapter **105 of 336**. Its output becomes an input to the later certification laboratories.
