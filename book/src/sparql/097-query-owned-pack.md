...
> **Outcome:** Construct and verify the projection query for **97. Query Only the Pack You Own**.

This is chapter **97 of 336**. Its output becomes an input to the later certification laboratories.
