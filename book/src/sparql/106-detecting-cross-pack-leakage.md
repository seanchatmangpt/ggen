...
> **Outcome:** Construct and verify the projection query for **106. Detecting Cross-Pack Leakage**.

This is chapter **106 of 336**. Its output becomes an input to the later certification laboratories.
