...
> **Outcome:** Construct and verify the projection query for **96. CONSTRUCT as Derived Law**.

This is chapter **96 of 336**. Its output becomes an input to the later certification laboratories.
