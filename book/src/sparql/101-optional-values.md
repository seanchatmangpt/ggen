...
> **Outcome:** Construct and verify the projection query for **101. Optional Values**.

This is chapter **101 of 336**. Its output becomes an input to the later certification laboratories.
