...
> **Outcome:** Construct and verify the projection query for **99. IRI-Prefix Filters**.

This is chapter **99 of 336**. Its output becomes an input to the later certification laboratories.
