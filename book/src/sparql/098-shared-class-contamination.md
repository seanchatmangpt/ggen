...
> **Outcome:** Construct and verify the projection query for **98. Shared Classes and Union Contamination**.

This is chapter **98 of 336**. Its output becomes an input to the later certification laboratories.
