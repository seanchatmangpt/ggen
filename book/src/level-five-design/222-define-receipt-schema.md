...
> **Outcome:** Construct and verify the ARD/PRD matrix for **222. Define the Receipt Schema**.

This is chapter **222 of 336**. Its output becomes an input to the later certification laboratories.
