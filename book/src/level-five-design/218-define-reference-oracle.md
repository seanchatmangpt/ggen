...
> **Outcome:** Construct and verify the ARD/PRD matrix for **218. Define the Reference Oracle**.

This is chapter **218 of 336**. Its output becomes an input to the later certification laboratories.
