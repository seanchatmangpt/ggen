...
> **Outcome:** Construct and verify the ARD/PRD matrix for **223. Define the Release Surface**.

This is chapter **223 of 336**. Its output becomes an input to the later certification laboratories.
