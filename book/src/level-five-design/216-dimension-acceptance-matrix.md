...
> **Outcome:** Construct and verify the ARD/PRD matrix for **216. Build the Dimension-to-Acceptance Matrix**.

This is chapter **216 of 336**. Its output becomes an input to the later certification laboratories.
