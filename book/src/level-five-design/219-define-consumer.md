...
> **Outcome:** Construct and verify the ARD/PRD matrix for **219. Define the Consumer**.

This is chapter **219 of 336**. Its output becomes an input to the later certification laboratories.
