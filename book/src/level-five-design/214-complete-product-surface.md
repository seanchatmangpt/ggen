...
> **Outcome:** Construct and verify the ARD/PRD matrix for **214. Define the Complete Product Surface**.

This is chapter **214 of 336**. Its output becomes an input to the later certification laboratories.
