...
> **Outcome:** Construct and verify the manufacturing pipeline for **5. Tera as Rendering Surface**.

This is chapter **5 of 336**. Its output becomes an input to the later certification laboratories.
