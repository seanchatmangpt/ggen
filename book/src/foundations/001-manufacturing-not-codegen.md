...
> **Outcome:** Construct and verify the manufacturing pipeline for **1. From Code Generation to Manufacturing**.

This is chapter **1 of 336**. Its output becomes an input to the later certification laboratories.
