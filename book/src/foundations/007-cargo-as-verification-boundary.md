...
> **Outcome:** Construct and verify the manufacturing pipeline for **7. Cargo as Verification Boundary**.

This is chapter **7 of 336**. Its output becomes an input to the later certification laboratories.
