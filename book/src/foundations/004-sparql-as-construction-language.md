...
> **Outcome:** Construct and verify the manufacturing pipeline for **4. SPARQL as Construction Language**.

This is chapter **4 of 336**. Its output becomes an input to the later certification laboratories.
