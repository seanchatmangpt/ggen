...
> **Outcome:** Construct and verify the pack boundary for **20. Pack Gates**.

This is chapter **20 of 336**. Its output becomes an input to the later certification laboratories.
