...
> **Outcome:** Construct and verify the pack boundary for **13. Packs as Routable Capability Cells**.

This is chapter **13 of 336**. Its output becomes an input to the later certification laboratories.
