...
│   ├── native pictl process mining/   # Process discovery + conformance
...
| ggen-dspy | — | DSPy-inspired LLM constructs |
| native pictl process mining | — | Process discovery and conformance checking |
| ggen-receipt | 0.2.0 | Ed25519 cryptographic receipts |
| ggen-consensus | 26.5.4 | Byzantine PBFT consensus |
