...
(define (problem ggen-v2681-governance-1-10)
 ...
 (:objects v2681 - release
  governance authority scope standing claims loss-law precedence generated-authority change-control release-decision risk-register - subsystem
 ...
 (:init
  ...
  (= (coverage risk-register) 0) (= (total-cost) 0))
