...
- [Git Submodule CLI Design - Summary](#git-submodule-cli-design---summary)
  - [Executive Summary](#executive-summary)
    - [Key Characteristics](#key-characteristics)
  - [What Was Designed](#what-was-designed)
    - [1. **RDF CLI Ontology** (`.specify/cli-commands.ttl`)](#1-rdf-cli-ontology-specifycli-commandsttl)
    - [2. **Generation Rules** (`ggen-paas-cli.toml`)](#2-generation-rules-ggen-paas-clitoml)
    - [3. **Code Generation Templates**](#3-code-generation-templates)
      - [`templates/cli-command.tera` (320 lines)](#templatescli-commandtera-320-lines)
      - [`templates/cli-dispatcher.tera` (280 lines)](#templatescli-dispatchertera-280-lines)
    - [4. **Architecture Documentation**](#4-architecture-documentation)
      - [`docs/CLI_SUBMODULE_DESIGN.md` (850 lines)](#docscli_submodule_designmd-850-lines)
      - [`docs/CLI_QUICK_REFERENCE.md` (500 lines)](#docscli_quick_referencemd-500-lines)
    - [5. **Concrete Example Implementation**](#5-concrete-example-implementation)
      - [`ggen-paas/lib/commands/generate.js` (480 lines)](#ggen-paaslibcommandsgeneratejs-480-lines)
  - [Architecture Overview](#architecture-overview)
    - [Three-Layer Model](#three-layer-model)
    - [Code Generation Pipeline](#code-generation-pipeline)
    - [Naming Conventions](#naming-conventions)
    - [Exit Codes (Poka-Yoke Error Proofing)](#exit-codes-poka-yoke-error-proofing)
    - [Andon Signals](#andon-signals)
  - [Specification Closures](#specification-closures)
    - [RDF Ontology Closure](#rdf-ontology-closure)
    - [Specification Completeness](#specification-completeness)
    - [Generated Artifacts Verification](#generated-artifacts-verification)
  - [Design Principles Applied](#design-principles-applied)
    - [1. **RDF-First** (From CLAUDE.md)](#1-rdf-first-from-claudemd)
    - [2. **Big Bang 80/20** (From CLAUDE.md)](#2-big-bang-8020-from-claudemd)
    - [3. **EPIC 9 Ready** (From CLAUDE.md)](#3-epic-9-ready-from-claudemd)
    - [4. **Chicago TDD** (From CLAUDE.md)](#4-chicago-tdd-from-claudemd)
    - [5. **Poka-Yoke Error Proofing** (From CLAUDE.md)](#5-poka-yoke-error-proofing-from-claudemd)
    - [6. **Deterministic Outputs** (From CLAUDE.md)](#6-deterministic-outputs-from-claudemd)
  ...
  - [Next Implementation Steps](#next-implementation-steps)
    - [Phase 1: Code Generation (Week 1)](#phase-1-code-generation-week-1)
    - [Phase 2: Handler Implementation (Week 2)](#phase-2-handler-implementation-week-2)
    - [Phase 3: Integration (Week 3)](#phase-3-integration-week-3)
    - [Phase 4: Testing & Refinement (Week 4)](#phase-4-testing--refinement-week-4)
  - [Comparison: With vs Without RDF](#comparison-with-vs-without-rdf)
    - [❌ Without RDF (Traditional Approach)](#-without-rdf-traditional-approach)
    - [✓ With RDF (Design Delivered)](#%E2%9C%93-with-rdf-design-delivered)
