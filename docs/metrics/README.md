...
- [Week 3: Coverage & Health Metrics Tracking](#week-3-coverage--health-metrics-tracking)
  - [Quick Start](#quick-start)
    - [View Current Metrics Dashboard](#view-current-metrics-dashboard)
    - [Run Daily Coverage Report](#run-daily-coverage-report)
    - [View Baseline Report](#view-baseline-report)
    - [View Latest Daily Report](#view-latest-daily-report)
  - [Documentation](#documentation)
  - [Current Status (Day 1)](#current-status-day-1)
  - [Week 3 Goals](#week-3-goals)
    - [Primary Objectives](#primary-objectives)
    - [Focus Areas](#focus-areas)
  - [Automation Scripts](#automation-scripts)
    - [`/scripts/coverage_tracker.sh`](#scriptscoverage_trackersh)
    - [`/scripts/health_dashboard.sh`](#scriptshealth_dashboardsh)
  - [Reports Structure](#reports-structure)
    - [Baseline Report (`week3_baseline_report.md`)](#baseline-report-week3_baseline_reportmd)
    - [Daily Reports (`daily_reports/coverage_YYYY-MM-DD.md`)](#daily-reports-daily_reportscoverage_yyyy-mm-ddmd)
  ...
  - [Success Criteria](#success-criteria)
    - [Week 3 Complete When:](#week-3-complete-when)
  - [Resources](#resources)
    - [Tools](#tools)
