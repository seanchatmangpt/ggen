...
- [Jidoka: Autonomation with a Human Touch](#jidoka-autonomation-with-a-human-touch)
  - [Table of Contents](#table-of-contents)
  - [Core Concept](#core-concept)
    - [Definition](#definition)
    - [Key Characteristics](#key-characteristics)
    - [Jidoka ≠ Automation](#jidoka-%E2%89%A0-automation)
  - [Jidoka in Manufacturing](#jidoka-in-manufacturing)
    - [Andon Cord System](#andon-cord-system)
    - [Real Example: Defect Detection](#real-example-defect-detection)
  - [Jidoka in Software Systems](#jidoka-in-software-systems)
    - [Principle Mapping](#principle-mapping)
    - [Defect Propagation Without Jidoka](#defect-propagation-without-jidoka)
    - [Defect Handling WITH Jidoka](#defect-handling-with-jidoka)
  ...
  - [Implementation Guide](#implementation-guide)
    - [Step 1: Start the Jidoka System](#step-1-start-the-jidoka-system)
    - [Step 2: Integrate into Your Application](#step-2-integrate-into-your-application)
    - [Step 3: Implement Request Handling](#step-3-implement-request-handling)
    - [Step 4: Monitor Status](#step-4-monitor-status)
    - [Step 5: Operational Recovery](#step-5-operational-recovery)
  - [Testing & Verification](#testing--verification)
    - [Unit Test Example](#unit-test-example)
    - [Integration Test: Full System Overload](#integration-test-full-system-overload)
    - [Stress Test: 1000 Concurrent Requests](#stress-test-1000-concurrent-requests)
  - [Operational Runbook](#operational-runbook)
    - [Daily Monitoring](#daily-monitoring)
    - [When Circuit Breaker Opens](#when-circuit-breaker-opens)
    - [When Rate Limiter Rejects Requests](#when-rate-limiter-rejects-requests)
    - [When Worker Pool Exhausted](#when-worker-pool-exhausted)
  - [Troubleshooting](#troubleshooting)
    - [Problem: Circuit Breaker Won't Close](#problem-circuit-breaker-wont-close)
    - [Problem: Rate Limiter Always Rejecting](#problem-rate-limiter-always-rejecting)
    - [Problem: Worker Pool Consistently Full](#problem-worker-pool-consistently-full)
    - [Problem: Memory Usage Growing](#problem-memory-usage-growing)
  - [Metrics & SLOs](#metrics--slos)
    - [Service Level Objectives (SLOs)](#service-level-objectives-slos)
    - [Key Metrics to Monitor](#key-metrics-to-monitor)
    - [Grafana Dashboard Queries](#grafana-dashboard-queries)
  - [References](#references)
    - [Manufacturing Jidoka](#manufacturing-jidoka)
    - [Software Circuit Breaker](#software-circuit-breaker)
    - [Erlang Supervision](#erlang-supervision)
    - [Related Patterns](#related-patterns)
  - [Quick Start](#quick-start)
    - [1. Start Jidoka](#1-start-jidoka)
    - [2. Execute Request with Jidoka Protection](#2-execute-request-with-jidoka-protection)
    - [3. Monitor](#3-monitor)
    - [4. Recover from Failure](#4-recover-from-failure)
  - [Summary](#summary)
