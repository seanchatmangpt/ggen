...
- [TPS Reference Implementation - Complete Guide](#tps-reference-implementation---complete-guide)
  ...
  - [Quick Start](#quick-start)
    - [60-Second Startup](#60-second-startup)
  ...
  - [Installation & Setup](#installation--setup)
    ...
    - [4. Verify Port Availability](#4-verify-port-availability)
  ...
  - [Load Testing](#load-testing)
    - [Load Test Scenarios](#load-test-scenarios)
      - [1. Normal Load (100 req/s)](#1-normal-load-100-reqs)
      - [2. Traffic Spike (1000 req/s)](#2-traffic-spike-1000-reqs)
      - [3. Sustained Stress (500 req/s)](#3-sustained-stress-500-reqs)
      - [4. Chaos Testing](#4-chaos-testing)
  ...
  - [Troubleshooting](#troubleshooting)
    - [Common Issues & Solutions](#common-issues--solutions)
      - [Issue: "Connection refused" on port 8080](#issue-connection-refused-on-port-8080)
      - [Issue: Circuit breaker stuck in "Open" state](#issue-circuit-breaker-stuck-in-open-state)
      - [Issue: Queue growing unbounded](#issue-queue-growing-unbounded)
      - [Issue: High error rate (> 5%)](#issue-high-error-rate--5)
      - [Issue: "Port already in use"](#issue-port-already-in-use)
      - [Issue: Docker out of disk space](#issue-docker-out-of-disk-space)
      - [Issue: Services won't start (Docker error)](#issue-services-wont-start-docker-error)
    - [Performance Troubleshooting](#performance-troubleshooting)
      - [Latency increasing over time](#latency-increasing-over-time)
      - [CPU usage very high](#cpu-usage-very-high)
      - [Metrics not appearing in Prometheus](#metrics-not-appearing-in-prometheus)
    - [Database & Log Issues](#database--log-issues)
      - [Prometheus data missing](#prometheus-data-missing)
      - [Loki not receiving logs](#loki-not-receiving-logs)
  - [Customization](#customization)
    - [Adapting to Your Use Case](#adapting-to-your-use-case)
      - [Custom Signal Types](#custom-signal-types)
      - [Custom Metrics](#custom-metrics)
      - [Custom Alerting](#custom-alerting)
      - [Custom Dashboard](#custom-dashboard)
    - [Integration with External Systems](#integration-with-external-systems)
      - [Send signals from external app](#send-signals-from-external-app)
      - [Connect to external queue](#connect-to-external-queue)
      - [Export metrics to external system](#export-metrics-to-external-system)
