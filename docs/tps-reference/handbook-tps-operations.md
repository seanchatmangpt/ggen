...
- [TPS Operations Handbook: Complete Reference](#tps-operations-handbook-complete-reference)
  - [Table of Contents](#table-of-contents)
  - [Section 1: TPS Principles Recap](#section-1-tps-principles-recap)
    - [1.1 What is TPS and Why It Matters](#11-what-is-tps-and-why-it-matters)
    - [1.2 The Six Core Principles](#12-the-six-core-principles)
      - [Principle 1: Jidoka (Autonomation with Human Touch)](#principle-1-jidoka-autonomation-with-human-touch)
      - [Principle 2: Kanban (Pull-Based Work)](#principle-2-kanban-pull-based-work)
      - [Principle 3: Andon (Problem Visibility)](#principle-3-andon-problem-visibility)
      - [Principle 4: Kaizen (Continuous Improvement)](#principle-4-kaizen-continuous-improvement)
      - [Principle 5: Heijunka (Load Leveling)](#principle-5-heijunka-load-leveling)
      - [Principle 6: Value Stream (See the Waste)](#principle-6-value-stream-see-the-waste)
    - [1.3 How These Principles Work Together](#13-how-these-principles-work-together)
    - [1.4 Anti-Patterns (What NOT to Do)](#14-anti-patterns-what-not-to-do)
  - [Section 2: Reading Dashboards](#section-2-reading-dashboards)
    - [2.1 Dashboard Overview](#21-dashboard-overview)
    - [2.2 Key Dashboard Panels](#22-key-dashboard-panels)
      - [Panel 1: Circuit Breaker Status](#panel-1-circuit-breaker-status)
      - [Panel 2: Queue Depth](#panel-2-queue-depth)
      - [Panel 3: Worker Utilization](#panel-3-worker-utilization)
      - [Panel 4: Error Rate](#panel-4-error-rate)
      - [Panel 5: Latency Distribution](#panel-5-latency-distribution)
      - [Panel 6: Throughput](#panel-6-throughput)
      - [Panel 7: Resource Usage](#panel-7-resource-usage)
    - [2.3 Dashboard Examples](#23-dashboard-examples)
      - [Example 1: Healthy System](#example-1-healthy-system)
      - [Example 2: Approaching Capacity](#example-2-approaching-capacity)
      - [Example 3: System Overloaded](#example-3-system-overloaded)
      - [Example 4: Partial Failure](#example-4-partial-failure)
    - [2.4 Dashboard Monitoring Schedule](#24-dashboard-monitoring-schedule)
  - [Section 3: Interpreting Metrics](#section-3-interpreting-metrics)
    - [3.1 Core Metrics Glossary](#31-core-metrics-glossary)
      - [Metric 1: Queue Depth (items in queue)](#metric-1-queue-depth-items-in-queue)
      - [Metric 2: Processing Latency (time to process one item)](#metric-2-processing-latency-time-to-process-one-item)
      - [Metric 3: Throughput (items processed per second)](#metric-3-throughput-items-processed-per-second)
      - [Metric 4: Error Rate (% of items that fail)](#metric-4-error-rate--of-items-that-fail)
      - [Metric 5: Worker Utilization (% of workers busy)](#metric-5-worker-utilization--of-workers-busy)
      - [Metric 6: Dead-Letter Queue Size (failed items)](#metric-6-dead-letter-queue-size-failed-items)
      - [Metric 7: Circuit Breaker State](#metric-7-circuit-breaker-state)
    - [3.2 Metric Relationships](#32-metric-relationships)
  - [Section 4: Common Scenarios](#section-4-common-scenarios)
    - [4.1 Scenario 1: Queue is Full (100% capacity)](#41-scenario-1-queue-is-full-100-capacity)
    - [4.2 Scenario 2: Circuit Breaker is Open](#42-scenario-2-circuit-breaker-is-open)
    - [4.3 Scenario 3: Error Rate is High](#43-scenario-3-error-rate-is-high)
    - [4.4 Scenario 4: Latency Spike](#44-scenario-4-latency-spike)
    - [4.5 Scenario 5: Workers Keep Scaling Up](#45-scenario-5-workers-keep-scaling-up)
  - [Section 5: Decision Trees](#section-5-decision-trees)
    - [5.1 Quick Decision Tree](#51-quick-decision-tree)
    - [5.2 Incident Response Decision Tree](#52-incident-response-decision-tree)
  - [Section 6: Troubleshooting Guide](#section-6-troubleshooting-guide)
    - [6.1 Common Issues and Fixes](#61-common-issues-and-fixes)
      - [Issue: Queue is constantly at 100%](#issue-queue-is-constantly-at-100)
      - [Issue: Circuit breaker keeps opening and closing](#issue-circuit-breaker-keeps-opening-and-closing)
      - [Issue: Memory usage keeps growing](#issue-memory-usage-keeps-growing)
      - [Issue: Some requests timeout while others succeed](#issue-some-requests-timeout-while-others-succeed)
      - [Issue: Auto-scaling isn't working](#issue-auto-scaling-isnt-working)
    - [6.2 Troubleshooting Workflow](#62-troubleshooting-workflow)
  - [Section 7: Maintenance Operations](#section-7-maintenance-operations)
    - [7.1 Daily Maintenance Tasks](#71-daily-maintenance-tasks)
    - [7.2 Weekly Maintenance Tasks](#72-weekly-maintenance-tasks)
    - [7.3 Regular Backups and Verification](#73-regular-backups-and-verification)
    - [7.4 System Updates and Patches](#74-system-updates-and-patches)
  - [Appendix A: Glossary](#appendix-a-glossary)
  - [Appendix B: Emergency Contacts](#appendix-b-emergency-contacts)
