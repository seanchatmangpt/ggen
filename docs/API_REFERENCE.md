...
- [API Reference](#api-reference)
  ...
  - [Signature API](#signature-api)
    - [Overview](#overview)
    - [Methods](#methods)
      - [`new(name, description)`](#newname-description)
      - [`with_input(input_field)`](#with_inputinput_field)
      - [`with_inputs(inputs)`](#with_inputsinputs)
      - [`with_output(output_field)`](#with_outputoutput_field)
      - [`with_outputs(outputs)`](#with_outputsoutputs)
      - [`with_instructions(instructions)`](#with_instructionsinstructions)
      - [`input_names()`](#input_names)
      - [`output_names()`](#output_names)
      - [`get_input(name)`](#get_inputname)
      - [`get_output(name)`](#get_outputname)
      - [`as_rust_struct()`](#as_rust_struct)
      - [`schema()`](#schema)
  - [InputField & OutputField](#inputfield--outputfield)
    - [InputField](#inputfield)
      - [`InputField::new(name, type_annotation)`](#inputfieldnewname-type_annotation)
      - [`with_description(description)`](#with_descriptiondescription)
      - [`with_constraint(constraint)`](#with_constraintconstraint)
      - [`with_constraints(constraints)`](#with_constraintsconstraints)
      - [`name()`](#name)
  ...
  - [FieldConstraints API](#fieldconstraints-api)
    - [Constraint Types](#constraint-types)
    - [Creating Constraints](#creating-constraints)
      - [`FieldConstraint::required()`](#fieldconstraintrequired)
      - [`FieldConstraint::min_length(length)`](#fieldconstraintmin_lengthlength)
      - [`FieldConstraint::max_length(length)`](#fieldconstraintmax_lengthlength)
      - [`FieldConstraint::pattern(regex)`](#fieldconstraintpatternregex)
      - [`FieldConstraint::min_value(value)`](#fieldconstraintmin_valuevalue)
      - [`FieldConstraint::max_value(value)`](#fieldconstraintmax_valuevalue)
      - [`FieldConstraint::enum_values(values)`](#fieldconstraintenum_valuesvalues)
      - [`FieldConstraint::custom(name, validator)`](#fieldconstraintcustomname-validator)
  - [Tool Registry API](#tool-registry-api)
    ...
    - [Methods](#methods-1)
      ...
      - [`get(name)`](#getname)
      - [`list_all()`](#list_all)
      - [`find_by_domain(domain)`](#find_by_domaindomain)
      - [`invoke(tool_name, input)`](#invoketool_name-input)
      - [`unregister(name)`](#unregistername)
      - [`count()`](#count)
  - [SignatureValidator API](#signaturevalidator-api)
    - [Overview](#overview-2)
    - [Methods](#methods-2)
      - [`new(signature)`](#newsignature)
      - [`validate_input(input_data)`](#validate_inputinput_data)
      - [`validate_output(output_data)`](#validate_outputoutput_data)
      - [`explain_error(error)`](#explain_errorerror)
  - [Error Types](#error-types)
    - [GgenAiError](#ggenaierror)
    - [ValidationError](#validationerror)
  - [Examples](#examples)
    - [Complete Tool Registration Example](#complete-tool-registration-example)
