...
- [TAI GCP Service Integration - Complete Guide](#tai-gcp-service-integration---complete-guide)
  ...
  - [Workload Identity Setup](#workload-identity-setup)
    - [Why Workload Identity?](#why-workload-identity)
    - [Prerequisites](#prerequisites)
    - [Step 1: Enable Workload Identity on GKE Cluster](#step-1-enable-workload-identity-on-gke-cluster)
    - [Step 2: Create Google Service Account](#step-2-create-google-service-account)
    - [Step 3: Create Kubernetes Service Account](#step-3-create-kubernetes-service-account)
    - [Step 4: Deploy Application with KSA](#step-4-deploy-application-with-ksa)
    - [Step 5: Environment Variables for Application](#step-5-environment-variables-for-application)
    - [Verify Workload Identity Setup](#verify-workload-identity-setup)
  - [Service Client Initialization](#service-client-initialization)
  ...
  - [Error Handling & Retry Strategies](#error-handling--retry-strategies)
    ...
    - [Implementing Retry Logic with Backoff](#implementing-retry-logic-with-backoff)
  ...
  - [Cost Optimization](#cost-optimization)
    ...
    - [2. Request Deduplication](#2-request-deduplication)
    - [3. Connection Pooling (Automatic)](#3-connection-pooling-automatic)
    - [4. Region Selection for Cost](#4-region-selection-for-cost)
  - [Security Best Practices](#security-best-practices)
    - [1. Use Workload Identity (Never Service Account Keys)](#1-use-workload-identity-never-service-account-keys)
    - [2. Principle of Least Privilege](#2-principle-of-least-privilege)
    - [3. Encryption with Cloud KMS](#3-encryption-with-cloud-kms)
    - [4. Enable Cloud Logging](#4-enable-cloud-logging)
    - [5. Network Security](#5-network-security)
  - [Troubleshooting](#troubleshooting)
    - [Issue 1: Workload Identity Token Not Found](#issue-1-workload-identity-token-not-found)
    - [Issue 2: Circuit Breaker Always Open](#issue-2-circuit-breaker-always-open)
    - [Issue 3: Authentication Failures](#issue-3-authentication-failures)
    - [Issue 4: Timeout SLOs Exceeded](#issue-4-timeout-slos-exceeded)
    - [Issue 5: Quota Exceeded](#issue-5-quota-exceeded)
  - [Performance Benchmarks](#performance-benchmarks)
    - [Latency Benchmarks (95th Percentile)](#latency-benchmarks-95th-percentile)
    - [Throughput Benchmarks](#throughput-benchmarks)
    - [Memory Usage](#memory-usage)
    - [Optimization Tips](#optimization-tips)
  - [Example: Complete Production Application](#example-complete-production-application)
  - [Summary](#summary)
