...
- [DSPy Architecture: Rust Implementation](#dspy-architecture-rust-implementation)
  - [Table of Contents](#table-of-contents)
  - [Core Concepts](#core-concepts)
    - [What is DSPy?](#what-is-dspy)
    - [Rust DSPy Philosophy](#rust-dspy-philosophy)
  - [Architecture Overview](#architecture-overview)
    - [High-Level Component Relationships](#high-level-component-relationships)
    - [Data Flow: RDF to LLM Response](#data-flow-rdf-to-llm-response)
  - [Core Components](#core-components)
    ...
    - [3. Module Trait](#3-module-trait)
    - [4. Predictor](#4-predictor)
    - [5. ChainOfThought](#5-chainofthought)
    - [6. SignatureValidator](#6-signaturevalidator)
  - [RDF/SHACL Integration](#rdfshacl-integration)
    - [TTLToSignatureTranspiler](#ttltosignaturetranspiler)
    - [Pipeline Stages](#pipeline-stages)
      - [Stage 1: Class Discovery](#stage-1-class-discovery)
      - [Stage 2: Property Extraction](#stage-2-property-extraction)
      - [Stage 3: Field Classification](#stage-3-field-classification)
      - [Stage 4: Type Mapping](#stage-4-type-mapping)
      - [Stage 5: Name Normalization](#stage-5-name-normalization)
    - [Complete Example](#complete-example)
  - [Type-Safe LLM Workflow](#type-safe-llm-workflow)
    - [End-to-End Example](#end-to-end-example)
    - [Type Safety Guarantees](#type-safety-guarantees)
    - [Prompt Construction Details](#prompt-construction-details)
  - [Error Handling](#error-handling)
    - [Error Philosophy](#error-philosophy)
    - [Error Types](#error-types)
      - [1. ModuleError](#1-moduleerror)
      - [2. ValidationError](#2-validationerror)
      - [3. GgenAiError](#3-ggenaierror)
    - [Error Recovery Patterns](#error-recovery-patterns)
  - [Differences from Python DSPy](#differences-from-python-dspy)
    ...
    - [Key Differences](#key-differences)
      ...
      - [5. RDF Integration](#5-rdf-integration)
      - [6. Memory Safety](#6-memory-safety)
  - [Integration with ggen](#integration-with-ggen)
    - [ggen Ecosystem Context](#ggen-ecosystem-context)
    - [Configuration](#configuration)
    - [Workflow Integration](#workflow-integration)
    - [Testing Strategy](#testing-strategy)
  - [Common Patterns](#common-patterns)
    - [Pattern 1: Question Answering](#pattern-1-question-answering)
    - [Pattern 2: Classification](#pattern-2-classification)
    - [Pattern 3: Multi-Step Reasoning](#pattern-3-multi-step-reasoning)
    - [Pattern 4: Structured Extraction](#pattern-4-structured-extraction)
    - [Pattern 5: RDF-Driven Task](#pattern-5-rdf-driven-task)
    - [Pattern 6: Validation Pipeline](#pattern-6-validation-pipeline)
  ...
  - [Appendix: Quick Reference](#appendix-quick-reference)
    ...
    - [Predictor](#predictor)
    - [TTL Transpilation](#ttl-transpilation)
