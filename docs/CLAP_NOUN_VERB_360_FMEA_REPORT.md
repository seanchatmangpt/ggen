...
- [FMEA Report: clap-noun-verb-360 Template System](#fmea-report-clap-noun-verb-360-template-system)
  - [Executive Summary](#executive-summary)
  - [FMEA Methodology](#fmea-methodology)
    - [Scoring Criteria](#scoring-criteria)
  - [Complete FMEA Table](#complete-fmea-table)
  - [Top 5 Critical Failures (RPN ≥ 200)](#top-5-critical-failures-rpn-%E2%89%A5-200)
    - [FM-1: Verb Registration System Non-Functional (RPN: 300)](#fm-1-verb-registration-system-non-functional-rpn-300)
    - [FM-2: Test Compilation Failures (RPN: 270)](#fm-2-test-compilation-failures-rpn-270)
    - [FM-6: Telemetry API Mismatch (RPN: 240)](#fm-6-telemetry-api-mismatch-rpn-240)
    - [FM-9: Missing Kernel Modules (RPN: 240)](#fm-9-missing-kernel-modules-rpn-240)
    - [FM-10: Float NaN Panic (RPN: 210)](#fm-10-float-nan-panic-rpn-210)
  - [Medium-Risk Failures (RPN 100-199)](#medium-risk-failures-rpn-100-199)
    - [FM-7: Template Variable Substitution Fails (RPN: 96)](#fm-7-template-variable-substitution-fails-rpn-96)
    - [FM-12: Network Address Parse Panic (RPN: 144)](#fm-12-network-address-parse-panic-rpn-144)
    - [FM-13: Template Path Injection (RPN: 90)](#fm-13-template-path-injection-rpn-90)
  - [Critical Risk Summary by Category](#critical-risk-summary-by-category)
    - [1. Compilation & Type System (Total RPN: 810)](#1-compilation--type-system-total-rpn-810)
    - [2. Runtime Safety (Total RPN: 658)](#2-runtime-safety-total-rpn-658)
    - [3. CLI Functionality (Total RPN: 480)](#3-cli-functionality-total-rpn-480)
    - [4. Observability (Total RPN: 240)](#4-observability-total-rpn-240)
    - [5. Security (Total RPN: 90)](#5-security-total-rpn-90)
  - [Mitigation Priority Matrix](#mitigation-priority-matrix)
  - [Recommended Actions by Priority](#recommended-actions-by-priority)
    - [Phase 1: STOP THE LINE (Week 1 - P0 CRITICAL)](#phase-1-stop-the-line-week-1---p0-critical)
    - [Phase 2: Production Safety (Week 2 - P1 HIGH)](#phase-2-production-safety-week-2---p1-high)
    - [Phase 3: Quality & Security (Week 3-4 - P2/P3)](#phase-3-quality--security-week-3-4---p2p3)
  - [Preventive Controls (Process Improvements)](#preventive-controls-process-improvements)
    - [1. Compilation Validation](#1-compilation-validation)
    - [2. Runtime Safety Checks](#2-runtime-safety-checks)
    - [3. Example Validation](#3-example-validation)
    - [4. OTEL Span Verification](#4-otel-span-verification)
  ...
  - [Detection Improvements](#detection-improvements)
    - [Current Detection Capabilities](#current-detection-capabilities)
    - [Recommended Detection Enhancements](#recommended-detection-enhancements)
  - [Process Changes to Prevent Recurrence](#process-changes-to-prevent-recurrence)
    - [1. Definition of Done (Updated)](#1-definition-of-done-updated)
    - [2. Code Review Checklist](#2-code-review-checklist)
    - [3. CI/CD Pipeline (Enhanced)](#3-cicd-pipeline-enhanced)
    - [4. Testing Strategy (80/20)](#4-testing-strategy-8020)
    - [5. Andon Signal Workflow (Enhanced)](#5-andon-signal-workflow-enhanced)
  - [FMEA Statistics](#fmea-statistics)
  - [Validation Against Prior Reports](#validation-against-prior-reports)
    - [PR73 Validation Report](#pr73-validation-report)
    - [Gemba Walk Report](#gemba-walk-report)
