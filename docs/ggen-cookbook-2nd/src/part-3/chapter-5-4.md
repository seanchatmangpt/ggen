...
- [Template Composition](#template-composition)
  - [Composition Strategies](#composition-strategies)
    - [1. Sequential Composition](#1-sequential-composition)
  ...
  - [Partial Templates](#partial-templates)
    ...
    - [Endpoint Partial](#endpoint-partial)
    - [Main Template](#main-template)
  - [Template Chaining](#template-chaining)
    - [Chain Configuration](#chain-configuration)
    - [Template with Chain Logic](#template-with-chain-logic)
  ...
  - [Composition Patterns](#composition-patterns)
    ...
    - [Incremental Composition](#incremental-composition)
