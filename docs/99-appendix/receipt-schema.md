...
- [Receipt Schema (CANONICAL)](#receipt-schema-canonical)
  - [Table of Contents](#table-of-contents)
  - [Base Receipt Structure](#base-receipt-structure)
    - [Base Fields Explained](#base-fields-explained)
  - [Receipt Types Catalog](#receipt-types-catalog)
    ...
    - [Decommission Receipts](#decommission-receipts)
      ...
      - [decommission_notice_sent](#decommission_notice_sent)
      - [decommission_shutting_down](#decommission_shutting_down)
      - [decommission_export_started](#decommission_export_started)
      - [decommission_export_complete](#decommission_export_complete)
      - [decommission_resource_cleanup](#decommission_resource_cleanup)
      - [decommission_archived](#decommission_archived)
      - [decommission_forgotten](#decommission_forgotten)
    - [Entitlement Receipts](#entitlement-receipts)
      - [entitlement_active](#entitlement_active)
      - [entitlement_cancelled](#entitlement_cancelled)
    - [Health & Readiness Receipts](#health--readiness-receipts)
      - [health_check_passed](#health_check_passed)
      - [health_check_failed](#health_check_failed)
    - [Incident Receipts](#incident-receipts)
      - [incident_detected](#incident_detected)
      - [incident_resolved](#incident_resolved)
    - [Invariant & Policy Receipts](#invariant--policy-receipts)
      - [invariant_violation](#invariant_violation)
      - [invariant_check_passed](#invariant_check_passed)
      - [policy_loaded](#policy_loaded)
      - [policy_load_failed](#policy_load_failed)
    - [Permission Receipts](#permission-receipts)
      - [permission_granted](#permission_granted)
      - [permission_denied](#permission_denied)
    - [Quota & Limit Receipts](#quota--limit-receipts)
      - [quota_exceeded](#quota_exceeded)
      - [quota_reset](#quota_reset)
    - [Signal Receipts](#signal-receipts)
      - [signal_received](#signal_received)
      - [signal_storm_detected](#signal_storm_detected)
    - [Generic Refusal](#generic-refusal)
      - [refusal](#refusal)
  - [JSON Schema](#json-schema)
  - [Decision Encoding](#decision-encoding)
    - [Decision States](#decision-states)
    - [Signal Flow with Decisions](#signal-flow-with-decisions)
  - [Chain of Custody](#chain-of-custody)
  - [Examples](#examples)
    - [Complete Signal Flow with Receipts](#complete-signal-flow-with-receipts)
