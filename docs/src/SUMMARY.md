...
- [Getting Started with Marketplace Maturity](tutorials/getting-started-marketplace-maturity.md)
  - Assess individual packages
  - Understand maturity levels
  - Generate marketplace dashboards
...
- [Set Up Maturity Gates in CI/CD](how-to-guides/maturity-cicd-gates.md)
  ...
  - Prevent bad packages in production
...
- [Maturity Scoring Specification](reference/maturity-scoring.md)
  - Dimension definitions (0-20 points each)
  - Scoring formulas
  - Level thresholds
...
- [Understanding Marketplace Maturity](explanations/marketplace-maturity.md)
  ...
  - The six quality dimensions explained
  - Design philosophy and incentives
  - Solving real-world problems
  - How packages progress through levels
