...
- [Rust-GenAI Usage Guide for ggen-dspy](#rust-genai-usage-guide-for-ggen-dspy)
  ...
  - [Request/Response Patterns](#requestresponse-patterns)
    - [Basic Request Pattern](#basic-request-pattern)
    - [Multiple Output Fields](#multiple-output-fields)
  ...
  - [Adapter System](#adapter-system)
    ...
    - [ChatAdapter Usage](#chatadapter-usage)
    - [JSONAdapter Usage](#jsonadapter-usage)
    - [AdapterWithFallback](#adapterwithfallback)
    - [Custom Schema](#custom-schema)
    - [Few-Shot Demonstrations](#few-shot-demonstrations)
    - [IntegratedAdapter with Features](#integratedadapter-with-features)
  - [Error Handling](#error-handling)
    - [Error Types](#error-types)
    - [Error Handling Patterns](#error-handling-patterns)
      - [Basic Pattern](#basic-pattern)
      - [Error Context Pattern](#error-context-pattern)
      - [Error Recovery Pattern](#error-recovery-pattern-1)
  ...
  - [Async/Await Best Practices](#asyncawait-best-practices)
    ...
    - [Select Pattern (First to Complete)](#select-pattern-first-to-complete)
    - [Buffered Streams](#buffered-streams)
  - [Retry and Timeout Configuration](#retry-and-timeout-configuration)
    - [Retry Configuration](#retry-configuration)
    - [Exponential Backoff](#exponential-backoff)
    - [Timeout Configuration](#timeout-configuration)
    - [Retry with Conditions](#retry-with-conditions)
    - [Circuit Breaker Pattern](#circuit-breaker-pattern)
  - [Token Counting and Cost Tracking](#token-counting-and-cost-tracking)
    - [Basic Token Tracking](#basic-token-tracking)
    - [Integrated Token Tracking](#integrated-token-tracking)
    - [Cost Budget Enforcement](#cost-budget-enforcement)
    - [Per-Request Token Monitoring](#per-request-token-monitoring)
  - [Caching Strategies](#caching-strategies)
    - [Memory Cache](#memory-cache)
    - [Custom Cache Key](#custom-cache-key)
    - [Persistent Cache](#persistent-cache)
    - [Cache Invalidation](#cache-invalidation)
  - [Provider-Specific Guidance](#provider-specific-guidance)
    - [OpenAI (GPT-4, GPT-3.5)](#openai-gpt-4-gpt-35)
    - [Anthropic Claude](#anthropic-claude)
    - [Ollama (Local Models)](#ollama-local-models)
    - [Provider Comparison Table](#provider-comparison-table)
  - [Testing with DummyLM](#testing-with-dummylm)
    - [Overview](#overview-1)
    - [Sequential Mode](#sequential-mode)
    - [QueryBased Mode](#querybased-mode)
    - [ExampleFollowing Mode](#examplefollowing-mode)
    - [Call History Tracking](#call-history-tracking)
    - [Integration with Modules](#integration-with-modules)
    - [Property-Based Testing](#property-based-testing)
  - [Common Pitfalls](#common-pitfalls)
    - [1. Unwrap/Expect in Production](#1-unwrapexpect-in-production)
    - [2. Missing Input Validation](#2-missing-input-validation)
    - [3. Ignoring Model Capabilities](#3-ignoring-model-capabilities)
    - [4. No Retry Logic](#4-no-retry-logic)
    - [5. Not Handling Rate Limits](#5-not-handling-rate-limits)
    - [6. Inefficient Caching](#6-inefficient-caching)
    - [7. Missing Token Tracking](#7-missing-token-tracking)
    - [8. Blocking Async Code](#8-blocking-async-code)
    - [9. Poor Error Messages](#9-poor-error-messages)
    - [10. Not Testing with DummyLM](#10-not-testing-with-dummylm)
  - [Troubleshooting](#troubleshooting)
    - [Issue: "No model specified" Error](#issue-no-model-specified-error)
    - [Issue: API Authentication Failures](#issue-api-authentication-failures)
    - [Issue: Timeout Errors](#issue-timeout-errors)
    - [Issue: Field Extraction Failures](#issue-field-extraction-failures)
    - [Issue: Rate Limit Errors](#issue-rate-limit-errors)
    - [Issue: JSON Parsing Failures](#issue-json-parsing-failures)
    - [Issue: Memory Leaks from Caching](#issue-memory-leaks-from-caching)
    - [Issue: Slow Performance](#issue-slow-performance)
    - [Debugging Tips](#debugging-tips)
  - [Migration Guide](#migration-guide)
    - [From Custom LLM Clients to rust-genai](#from-custom-llm-clients-to-rust-genai)
    - [From Direct API Calls to Adapters](#from-direct-api-calls-to-adapters)
    - [From Manual Retry to Automatic](#from-manual-retry-to-automatic)
    - [From No Caching to Automatic Caching](#from-no-caching-to-automatic-caching)
  ...
  - [Quick Reference](#quick-reference)
    ...
    - [Predictor Template](#predictor-template)
    - [Adapter Usage Template](#adapter-usage-template)
