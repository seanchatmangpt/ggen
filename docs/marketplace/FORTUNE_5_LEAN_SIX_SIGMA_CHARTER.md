...
- [Lean Six Sigma Project Charter — ggen (Fortune 5 Enterprise Text Compiler)](#lean-six-sigma-project-charter--ggen-fortune-5-enterprise-text-compiler)
  - [Project Title](#project-title)
  - [Project Type](#project-type)
  - [Business Unit](#business-unit)
  - [Project Sponsor (roles — formal names on signoff)](#project-sponsor-roles--formal-names-on-signoff)
  - [Project Champion (role — formal name on signoff)](#project-champion-role--formal-name-on-signoff)
  - [Project Leader / Black Belt / Lead Architect](#project-leader--black-belt--lead-architect)
  - [Core Team](#core-team)
  ...
  - [5. Customers / Stakeholders](#5-customers--stakeholders)
    - [Primary Customers](#primary-customers)
    - [Secondary Customers](#secondary-customers)
  - [6. CTQs (Critical to Quality)](#6-ctqs-critical-to-quality)
  - [7. Project Objective](#7-project-objective)
  - [8. Target Outcomes](#8-target-outcomes)
    - [Strategic Outcomes](#strategic-outcomes)
    - [Operational Outcomes](#operational-outcomes)
  - [9. Baseline / Current State (evidence-aligned)](#9-baseline--current-state-evidence-aligned)
  - [10. Future State Vision](#10-future-state-vision)
  - [11. Measures of Success](#11-measures-of-success)
    - [Primary Metrics](#primary-metrics)
    - [Secondary Metrics](#secondary-metrics)
  - [12. Financial / Strategic Benefit Hypothesis](#12-financial--strategic-benefit-hypothesis)
  - [13. Risks](#13-risks)
    - [Key Risks](#key-risks)
  ...
  - [19. Tollgate Questions](#19-tollgate-questions)
  - [20. Charter Statement](#20-charter-statement)
  - [21. One-Page Executive Version](#21-one-page-executive-version)
    - [Project](#project)
    - [Why Now](#why-now)
    - [Goal](#goal)
    - [Success Looks Like](#success-looks-like)
    - [Critical Risks](#critical-risks)
    - [Strategic Payoff](#strategic-payoff)
  - [Appendix A — Corporate charter summary table (Six Sigma style)](#appendix-a--corporate-charter-summary-table-six-sigma-style)
    - [CTQ → KPI mapping (measurable acceptance)](#ctq-%E2%86%92-kpi-mapping-measurable-acceptance)
    - [Formal signoff (print / record in PLM)](#formal-signoff-print--record-in-plm)
  - [Appendix B — Implementation alignment and tollgate status](#appendix-b--implementation-alignment-and-tollgate-status)
    - [B.1 Charter phase → repository anchors](#b1-charter-phase-%E2%86%92-repository-anchors)
    - [B.2 Milestone tollgate vs current evidence (R/Y/G)](#b2-milestone-tollgate-vs-current-evidence-ryg)
