...
- [ggen AI Guide - AI-Powered Code Generation](#ggen-ai-guide---ai-powered-code-generation)
  - [🚀 Quick Start](#-quick-start)
    - [Setup AI Providers](#setup-ai-providers)
    - [Your First AI Generation](#your-first-ai-generation)
  - [🤖 Core AI Commands](#-core-ai-commands)
    ...
    - [Smart Frontmatter](#smart-frontmatter)
  - [🔍 Natural Language Search](#-natural-language-search)
    - [Conversational Marketplace](#conversational-marketplace)
  ...
  - [📚 Examples](#-examples)
    ...
    - [Advanced SPARQL Generation](#advanced-sparql-generation)
