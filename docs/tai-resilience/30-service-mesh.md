...
- [Service Mesh & Advanced Resilience Patterns (TAI v0.1.0)](#service-mesh--advanced-resilience-patterns-tai-v010)
  ...
  - [Advanced Circuit Breaker](#advanced-circuit-breaker)
    ...
    - [Failure Type Categorization](#failure-type-categorization)
  ...
  - [Outlier Detection](#outlier-detection)
    ...
    - [Automatic Re-injection](#automatic-re-injection)
    - [Respecting SLOs](#respecting-slos)
  - [Istio Integration](#istio-integration)
    - [VirtualService: Traffic Routing](#virtualservice-traffic-routing)
    - [DestinationRule: Load Balancing](#destinationrule-load-balancing)
    - [Gateway: Ingress Management](#gateway-ingress-management)
    - [PeerAuthentication: mTLS](#peerauthentication-mtls)
    - [AuthorizationPolicy: Access Control](#authorizationpolicy-access-control)
  ...
  - [Deployment Strategies](#deployment-strategies)
    - [Canary Deployment Checklist](#canary-deployment-checklist)
    - [Blue-Green Deployment Checklist](#blue-green-deployment-checklist)
  - [Troubleshooting Guide](#troubleshooting-guide)
    - [Problem: Circuit Breaker Not Opening](#problem-circuit-breaker-not-opening)
    - [Problem: Canary Deployment Rolls Back Unexpectedly](#problem-canary-deployment-rolls-back-unexpectedly)
    - [Problem: Traffic Not Splitting Correctly](#problem-traffic-not-splitting-correctly)
    - [Problem: Outlier Detection Ejects All Instances](#problem-outlier-detection-ejects-all-instances)
    - [Problem: High Memory Usage in Circuit Breaker](#problem-high-memory-usage-in-circuit-breaker)
    - [Problem: mTLS Certificate Errors](#problem-mtls-certificate-errors)
