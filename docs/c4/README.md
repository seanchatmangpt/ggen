...
- [C4 Diagram Universe: Complete Framework (46 Diagrams)](#c4-diagram-universe-complete-framework-46-diagrams)
  - [Quick Start](#quick-start)
    - [Generate All Diagrams](#generate-all-diagrams)
    - [View Generated Diagrams](#view-generated-diagrams)
  - [Architecture: 46 Diagrams Organized by Level](#architecture-46-diagrams-organized-by-level)
    - [Level 0: System Context (1 diagram)](#level-0-system-context-1-diagram)
    - [Level 1: Container (5 diagrams)](#level-1-container-5-diagrams)
    - [Level 2: Component (20 diagrams)](#level-2-component-20-diagrams)
      - [Signal Ingestion Components (4)](#signal-ingestion-components-4)
      - [Analytics & ML Components (4)](#analytics--ml-components-4)
      - [Action Executor Components (4)](#action-executor-components-4)
      - [Knowledge Graph Components (4)](#knowledge-graph-components-4)
      - [Marketplace Components (2)](#marketplace-components-2)
    - [Level 3: Code (20 diagrams)](#level-3-code-20-diagrams)
      - [Cost Optimization (3)](#cost-optimization-3)
      - [Performance Optimization (3)](#performance-optimization-3)
      - [Security Hardening (3)](#security-hardening-3)
      - [Compliance & Auditing (3)](#compliance--auditing-3)
      - [Autoscaling & Availability (3)](#autoscaling--availability-3)
      - [Data Protection & Network (2)](#data-protection--network-2)
      - [Receipt & Verification (1)](#receipt--verification-1)
      - [Advanced Features (2)](#advanced-features-2)
      - [Testing & Validation (2)](#testing--validation-2)
  - [Tera Template Framework](#tera-template-framework)
    - [Template Structure](#template-structure)
    - [Template Variables (Inheritance Model)](#template-variables-inheritance-model)
    - [Template Loops & Conditionals](#template-loops--conditionals)
    - [File Organization Pattern](#file-organization-pattern)
  - [Generation Triggers](#generation-triggers)
    - [Trigger 1: Full Regeneration (All 46 Diagrams)](#trigger-1-full-regeneration-all-46-diagrams)
    - [Trigger 2: Per-SKU Generation (8 × 3 = 24 SKU-Specific Diagrams)](#trigger-2-per-sku-generation-8-%C3%97-3--24-sku-specific-diagrams)
    - [Trigger 3: Per-Region Generation (4 Regions × 5 Container Diagrams = 20 Variants)](#trigger-3-per-region-generation-4-regions-%C3%97-5-container-diagrams--20-variants)
    - [Trigger 4: Per-Compliance-Tier Generation (4 Tiers × 5 = 20 Variants)](#trigger-4-per-compliance-tier-generation-4-tiers-%C3%97-5--20-variants)
    - [Trigger 5: Per-Deployment-Mode Generation (3 Modes × 6 Container = 18 Variants)](#trigger-5-per-deployment-mode-generation-3-modes-%C3%97-6-container--18-variants)
    - [Trigger 6: Matrix Generation (All Combinations)](#trigger-6-matrix-generation-all-combinations)
  - [How to Add New Diagram Types](#how-to-add-new-diagram-types)
    - [Step 1: Define RDF Fact Template](#step-1-define-rdf-fact-template)
    - [Step 2: Create Tera Template](#step-2-create-tera-template)
    - [Step 3: Register Template in Makefile.toml](#step-3-register-template-in-makefiletoml)
    - [Step 4: Validate & Test](#step-4-validate--test)
  - [Example: Generate All Diagrams for cost_guard in us-central1 in HIPAA Mode](#example-generate-all-diagrams-for-cost_guard-in-us-central1-in-hipaa-mode)
  - [Rendering & Display](#rendering--display)
    - [Local Markdown Rendering](#local-markdown-rendering)
    - [GitHub Rendering](#github-rendering)
    - [Marketplace Integration](#marketplace-integration)
  - [Variable Inheritance & Scoping](#variable-inheritance--scoping)
    - [Scope Resolution Order](#scope-resolution-order)
    - [Example: Variable Inheritance](#example-variable-inheritance)
  - [Versioning](#versioning)
    - [Version Tag Format](#version-tag-format)
    - [Breaking Changes](#breaking-changes)
  - [Role-Based Diagram Visibility](#role-based-diagram-visibility)
    - [Viewer Roles → Visible Diagrams](#viewer-roles-%E2%86%92-visible-diagrams)
  - [Marketplace Integration](#marketplace-integration-1)
    - [Auto-Generate SKU Listing with Diagrams](#auto-generate-sku-listing-with-diagrams)
    - [Diagram Versioning in Marketplace](#diagram-versioning-in-marketplace)
  - [Production Checklist](#production-checklist)
  - [Summary: The 46-Diagram Universe](#summary-the-46-diagram-universe)
  - [NEW: Level 3 Component Diagrams (Part B) - GCP Marketplace Autonomics](#new-level-3-component-diagrams-part-b---gcp-marketplace-autonomics)
    - [4 Primary Component Domains](#4-primary-component-domains)
    ...
    - [Component Template Framework](#component-template-framework)
    - [Integration Points](#integration-points)
    - [Navigation Guide](#navigation-guide)
    - [Production Checklist](#production-checklist-1)
