...
- [C4 Component Diagram Template Framework](#c4-component-diagram-template-framework)
  - [Overview](#overview)
  - [C4 Model Hierarchy & Variable Inheritance](#c4-model-hierarchy--variable-inheritance)
  - [Variable Inheritance Flow](#variable-inheritance-flow)
    - [Level 1 → Level 2 (System → Containers)](#level-1-%E2%86%92-level-2-system-%E2%86%92-containers)
    - [Level 2 → Level 3 (Containers → Components)](#level-2-%E2%86%92-level-3-containers-%E2%86%92-components)
    - [Level 3 → Level 4 (Components → Code)](#level-3-%E2%86%92-level-4-components-%E2%86%92-code)
  - [Domain-Driven Component Decomposition](#domain-driven-component-decomposition)
    - [Signal Normalization Domain](#signal-normalization-domain)
    - [Entitlement FSM Domain](#entitlement-fsm-domain)
    - [Policy Update Domain](#policy-update-domain)
    - [Tenant Isolation Domain](#tenant-isolation-domain)
  ...
  - [Tera Template Framework](#tera-template-framework)
    - [Master Template Structure](#master-template-structure)
  ...
  - [RDF Specification Template](#rdf-specification-template)
  - [Generation Workflow](#generation-workflow)
    - [Step 1: Validate RDF Specification](#step-1-validate-rdf-specification)
    - [Step 2: Execute SPARQL Queries](#step-2-execute-sparql-queries)
    - [Step 3: Render Tera Templates](#step-3-render-tera-templates)
    - [Step 4: Verify Generation](#step-4-verify-generation)
  - [Context Variables Reference Table](#context-variables-reference-table)
    - [Signal Normalization Context](#signal-normalization-context)
    - [Entitlement FSM Context](#entitlement-fsm-context)
    - [Policy Update Context](#policy-update-context)
    - [Tenant Isolation Context](#tenant-isolation-context)
  - [Validation & Consistency Rules](#validation--consistency-rules)
    - [Component Naming Conventions](#component-naming-conventions)
    - [Relationship Labels](#relationship-labels)
    - [Timeout SLO Format](#timeout-slo-format)
  - [Integration with Other Artifacts](#integration-with-other-artifacts)
    - [Relationship to Container Diagrams (Level 2)](#relationship-to-container-diagrams-level-2)
    - [Relationship to Code (Level 4)](#relationship-to-code-level-4)
    - [Relationship to Tests](#relationship-to-tests)
  - [Production Checklist](#production-checklist)
  - [Example: Full Workflow from RDF to Diagram](#example-full-workflow-from-rdf-to-diagram)
    - [1. Write RDF Specification](#1-write-rdf-specification)
    - [2. Execute SPARQL Query](#2-execute-sparql-query)
    - [3. Render Tera Template](#3-render-tera-template)
    - [4. Verify & Publish](#4-verify--publish)
  - [Troubleshooting](#troubleshooting)
    - [Issue: Mermaid Diagram Won't Render](#issue-mermaid-diagram-wont-render)
    - [Issue: Context Variable Not Populated](#issue-context-variable-not-populated)
    - [Issue: Component Missing from Diagram](#issue-component-missing-from-diagram)
