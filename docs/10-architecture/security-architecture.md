...
- [TAI 2030 Security Architecture](#tai-2030-security-architecture)
  - [Table of Contents](#table-of-contents)
  - [Executive Summary](#executive-summary)
  - [Security Governance](#security-governance)
    - [Security Principles](#security-principles)
    - [Security Roles & Responsibilities](#security-roles--responsibilities)
    - [Certification & Audit](#certification--audit)
  - [Identity & Access Management (IAM)](#identity--access-management-iam)
    - [Service Account Architecture](#service-account-architecture)
    - [Service Account Definitions](#service-account-definitions)
      - [1. Autonomic Governor (Cloud Run Controller)](#1-autonomic-governor-cloud-run-controller)
      - [2. Catalog Controller (Reconciliation Engine)](#2-catalog-controller-reconciliation-engine)
      - [3. Marketplace Webhook Processor](#3-marketplace-webhook-processor)
    - [IAM Boundary Enforcement](#iam-boundary-enforcement)
  - [Secrets Management](#secrets-management)
    - [GCP Secret Manager Integration](#gcp-secret-manager-integration)
    - [Secrets Inventory](#secrets-inventory)
      - [1. Marketplace Webhook HMAC Secret](#1-marketplace-webhook-hmac-secret)
      - [2. Marketplace API Client Secret (if applicable)](#2-marketplace-api-client-secret-if-applicable)
    - [Secret Access Protocol](#secret-access-protocol)
    - [No Service Account Keys](#no-service-account-keys)
  - [OIDC & Workload Identity](#oidc--workload-identity)
    - [Workload Identity Federation Setup](#workload-identity-federation-setup)
    - [Token Lifecycle](#token-lifecycle)
    - [Workload Identity Configuration (Terraform)](#workload-identity-configuration-terraform)
  - [Signature Verification](#signature-verification)
    - [Marketplace Webhook Signature Scheme](#marketplace-webhook-signature-scheme)
    - [Signature Verification Algorithm](#signature-verification-algorithm)
    - [Refusal Behavior](#refusal-behavior)
  - [Network Security](#network-security)
    - [Cloud Run Ingress Configuration](#cloud-run-ingress-configuration)
    - [IAM-Only Access Control](#iam-only-access-control)
    - [Network Isolation (Optional)](#network-isolation-optional)
  - [Data Encryption](#data-encryption)
    - [Encryption at Rest](#encryption-at-rest)
    - [Encryption in Transit](#encryption-in-transit)
  - [Audit Logging & Observability](#audit-logging--observability)
    - [Cloud Audit Logs Configuration](#cloud-audit-logs-configuration)
    - [Cloud Logging Configuration](#cloud-logging-configuration)
    - [SLO Monitoring](#slo-monitoring)
  - [Refusal Modes as Security Mechanisms](#refusal-modes-as-security-mechanisms)
    - [Refusal Philosophy](#refusal-philosophy)
    - [Refusal Categories](#refusal-categories)
    ...
    - [Refusal as Observable Behavior](#refusal-as-observable-behavior)
  - [Threat Model](#threat-model)
    - [Threat Categories](#threat-categories)
      - [1. Marketplace Compromise (Threat Actor: External)](#1-marketplace-compromise-threat-actor-external)
      - [2. Service Account Compromise (Threat Actor: Internal or Supply Chain)](#2-service-account-compromise-threat-actor-internal-or-supply-chain)
      - [3. Network Eavesdropping (Threat Actor: External)](#3-network-eavesdropping-threat-actor-external)
      - [4. Secret Exfiltration (Threat Actor: Internal)](#4-secret-exfiltration-threat-actor-internal)
      - [5. Unauthorized Entitlement Allocation (Threat Actor: Internal or Customer)](#5-unauthorized-entitlement-allocation-threat-actor-internal-or-customer)
      - [6. Denial of Service (Threat Actor: External)](#6-denial-of-service-threat-actor-external)
    - [Attack Surface](#attack-surface)
    - [Threat Risk Matrix](#threat-risk-matrix)
  - [Compliance Framework](#compliance-framework)
    ...
    - [FedRAMP Boundary (Baseline Compliance)](#fedramp-boundary-baseline-compliance)
  - [Incident Response](#incident-response)
    - [Incident Categories](#incident-categories)
      - [1. Signature Verification Failure Spike](#1-signature-verification-failure-spike)
      - [2. Service Account Key Discovered](#2-service-account-key-discovered)
      - [3. Unauthorized Firestore Modification](#3-unauthorized-firestore-modification)
  ...
  - [Receipt Contract](#receipt-contract)
    ...
    - [Receipt Storage & Retrieval](#receipt-storage--retrieval)
  - [Definition of Done](#definition-of-done)
    - [Security Architecture Completeness](#security-architecture-completeness)
