...
- [Cloud-Native State Machine Persistence with Firestore](#cloud-native-state-machine-persistence-with-firestore)
  - [Overview](#overview)
  ...
  - [Core Concepts](#core-concepts)
    - [1. State Snapshots](#1-state-snapshots)
    ...
    - [7. Eventual Consistency](#7-eventual-consistency)
      ...
      - [Causality-Aware](#causality-aware)
    - [8. Vector Clocks](#8-vector-clocks)
    - [9. Distributed Locking](#9-distributed-locking)
  - [Usage Patterns](#usage-patterns)
    - [Pattern 1: Simple State Persistence](#pattern-1-simple-state-persistence)
    - [Pattern 2: Optimistic Locking Update](#pattern-2-optimistic-locking-update)
    - [Pattern 3: ACID Transactions](#pattern-3-acid-transactions)
    - [Pattern 4: Event Sourcing](#pattern-4-event-sourcing)
    - [Pattern 5: Conflict Resolution](#pattern-5-conflict-resolution)
    - [Pattern 6: Distributed Locking](#pattern-6-distributed-locking)
  - [Data Modeling](#data-modeling)
    - [Good: Flat State with Metadata](#good-flat-state-with-metadata)
    - [Avoid: Deeply Nested Structures](#avoid-deeply-nested-structures)
    - [Better: Separate Aggregates](#better-separate-aggregates)
  ...
  - [Observability](#observability)
    ...
    - [Example Monitoring](#example-monitoring)
  - [Consistency Models](#consistency-models)
    - [Strong Consistency](#strong-consistency)
    - [Eventual Consistency](#eventual-consistency)
    - [Causal Consistency](#causal-consistency)
  - [Error Handling](#error-handling)
    - [Transient Errors (Retry)](#transient-errors-retry)
    - [Permanent Errors (Fail Fast)](#permanent-errors-fail-fast)
  - [Testing Strategies](#testing-strategies)
    - [Unit Tests](#unit-tests)
    - [Integration Tests](#integration-tests)
    - [Chaos Testing](#chaos-testing)
  - [Migration Guide](#migration-guide)
    - [From Naive In-Memory](#from-naive-in-memory)
    - [From Database with Manual Versioning](#from-database-with-manual-versioning)
