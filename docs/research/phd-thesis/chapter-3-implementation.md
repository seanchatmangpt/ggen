...
- [Chapter 3: System Architecture and Implementation](#chapter-3-system-architecture-and-implementation)
  - [Abstract](#abstract)
  - [3.1 System Overview](#31-system-overview)
    - [3.1.1 Architecture Philosophy](#311-architecture-philosophy)
    - [3.1.2 High-Level Architecture](#312-high-level-architecture)
    - [3.1.3 Data Flow](#313-data-flow)
    - [3.1.4 Technology Stack](#314-technology-stack)
    - [3.1.5 Design Principles](#315-design-principles)
  - [3.2 The 20-Agent Implementation](#32-the-20-agent-implementation)
    - [3.2.1 Agent Allocation Strategy](#321-agent-allocation-strategy)
    - [3.2.2 Agents 1-5: Ontologies & Schemas](#322-agents-1-5-ontologies--schemas)
      - [**Agent 1: Receipt Contract Ontology**](#agent-1-receipt-contract-ontology)
      - [**Agent 2: Verdict Ontology**](#agent-2-verdict-ontology)
      - [**Agent 3: Kernel IR Ontology**](#agent-3-kernel-ir-ontology)
      - [**Agent 4: Divergence Report Ontology**](#agent-4-divergence-report-ontology)
      - [**Agent 5: Replay Pack Ontology**](#agent-5-replay-pack-ontology)
    - [3.2.3 Summary: Ontologies (Agents 1-5)](#323-summary-ontologies-agents-1-5)
  - [3.3 SPARQL Extraction Layer](#33-sparql-extraction-layer)
    - [3.3.1 Agents 6-8: SPARQL Queries](#331-agents-6-8-sparql-queries)
      - [**Agent 6: Receipt Contract Extractor**](#agent-6-receipt-contract-extractor)
      - [**Agent 7: Kernel IR Extractor**](#agent-7-kernel-ir-extractor)
      - [**Agent 8: Outputs & Scenarios Extractor**](#agent-8-outputs--scenarios-extractor)
    - [3.3.2 Summary: SPARQL Queries (Agents 6-8)](#332-summary-sparql-queries-agents-6-8)
  - [3.4 Tera Template Rendering](#34-tera-template-rendering)
    - [3.4.1 Agents 9-12: Templates](#341-agents-9-12-templates)
      - [**Agent 9: Schema Templates**](#agent-9-schema-templates)
      - [**Agent 10: Golden Files Templates**](#agent-10-golden-files-templates)
      - [**Agent 11: Documentation Templates**](#agent-11-documentation-templates)
      - [**Agent 12: World Manifest Template**](#agent-12-world-manifest-template)
    - [3.4.2 Summary: Tera Templates (Agents 9-12)](#342-summary-tera-templates-agents-9-12)
  - [3.5 Verification Infrastructure](#35-verification-infrastructure)
    - [3.5.1 Agents 13-15: Verifier Implementation](#351-agents-13-15-verifier-implementation)
      - [**Agent 13: World Verifier (world.verify.mjs)**](#agent-13-world-verifier-worldverifymjs)
      - [**Agent 14: Divergence Reporter (divergence_reporter.mjs)**](#agent-14-divergence-reporter-divergence_reportermjs)
      - [**Agent 15: Swarm Coordination Loop (run_swarm.sh)**](#agent-15-swarm-coordination-loop-run_swarmsh)
    - [3.5.2 Summary: Verification Infrastructure (Agents 13-15)](#352-summary-verification-infrastructure-agents-13-15)
  - [3.6 Integration & Testing](#36-integration--testing)
    - [3.6.1 Agents 16-20: Wizard Integration & Examples](#361-agents-16-20-wizard-integration--examples)
      - [**Agent 16: Wizard.rs Integration**](#agent-16-wizardrs-integration)
      - [**Agent 17: Bash Script Integration**](#agent-17-bash-script-integration)
      - [**Agent 18: Example Directory Structure**](#agent-18-example-directory-structure)
  - [Architecture](#architecture)
  - [Verification](#verification)
      - [**Agent 20: End-to-End Testing**](#agent-20-end-to-end-testing)
    - [3.6.2 Summary: Integration & Testing (Agents 16-20)](#362-summary-integration--testing-agents-16-20)
  - [3.7 Code Generation Pipeline](#37-code-generation-pipeline)
    - [3.7.1 Pipeline Stages](#371-pipeline-stages)
    - [3.7.2 Complete Pipeline Performance](#372-complete-pipeline-performance)
  - [3.8 Swarm Coordination Loop](#38-swarm-coordination-loop)
    - [3.8.1 Closed-Loop Architecture](#381-closed-loop-architecture)
    - [3.8.2 Convergence Analysis](#382-convergence-analysis)
  - [3.9 Ontology Design Patterns](#39-ontology-design-patterns)
    - [3.9.1 Common Design Patterns](#391-common-design-patterns)
    - [3.9.2 Cross-Ontology Relationships](#392-cross-ontology-relationships)
    - [3.9.3 Extensibility Points](#393-extensibility-points)
  - [3.10 Discussion](#310-discussion)
    - [3.10.1 Design Decisions](#3101-design-decisions)
    - [3.10.2 Limitations](#3102-limitations)
    - [3.10.3 Comparison to Related Work](#3103-comparison-to-related-work)
  - [3.11 Conclusion](#311-conclusion)
  - [References](#references)
  - [Appendix A: Complete File Listing](#appendix-a-complete-file-listing)
    - [Ontologies (5 files, 1,225 lines)](#ontologies-5-files-1225-lines)
    - [SPARQL Queries (4 files, 117 lines)](#sparql-queries-4-files-117-lines)
    - [Templates (14 files, ~2,100 lines)](#templates-14-files-2100-lines)
    - [Scripts (4 files, 963 lines)](#scripts-4-files-963-lines)
    - [CLI & Tests (3 files, 354 lines)](#cli--tests-3-files-354-lines)
    - [Generated Outputs (examples, not counted in scaffold)](#generated-outputs-examples-not-counted-in-scaffold)
  - [Appendix B: Agent Coordination Timeline](#appendix-b-agent-coordination-timeline)
