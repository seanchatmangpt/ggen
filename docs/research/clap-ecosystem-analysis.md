...
- [clap Ecosystem Deep Dive](#clap-ecosystem-deep-dive)
  - [Executive Summary](#executive-summary)
  - [Architecture Overview](#architecture-overview)
    - [Three-Layer API Design](#three-layer-api-design)
    - [Core Types](#core-types)
  - [Derive API (Recommended)](#derive-api-recommended)
    - [Basic Usage](#basic-usage)
    - [Attribute Reference](#attribute-reference)
    - [Advanced Derive Features](#advanced-derive-features)
  - [Builder API (Dynamic Commands)](#builder-api-dynamic-commands)
    - [When to Use](#when-to-use)
    - [Example](#example)
    - [Dynamic Subcommands](#dynamic-subcommands)
  - [Shell Completion](#shell-completion)
    - [Built-in Completion Generation](#built-in-completion-generation)
    - [Adding Completions Subcommand](#adding-completions-subcommand)
    - [Value Hints for Smart Completion](#value-hints-for-smart-completion)
  - [Error Handling](#error-handling)
    - [Error Types](#error-types)
    - [Custom Error Messages](#custom-error-messages)
    - [Styled Errors (v4.0+)](#styled-errors-v40)
  - [clap v3 → v4 Migration](#clap-v3-%E2%86%92-v4-migration)
    - [Breaking Changes](#breaking-changes)
    - [Migration Checklist](#migration-checklist)
  - [Performance Benchmarks](#performance-benchmarks)
    - [Parsing Speed (clap v4.5)](#parsing-speed-clap-v45)
    - [Compile Time](#compile-time)
    - [Binary Size](#binary-size)
    - [Optimization Tips](#optimization-tips)
  - [Ecosystem Integration](#ecosystem-integration)
    - [Integration with serde (Config Files)](#integration-with-serde-config-files)
    - [Integration with config Crate](#integration-with-config-crate)
    - [Integration with tracing/logging](#integration-with-tracinglogging)
  - [Best Practices](#best-practices)
    - [1. Use Derive API by Default](#1-use-derive-api-by-default)
    - [2. Provide Defaults](#2-provide-defaults)
    - [3. Use ValueEnum for Restricted Choices](#3-use-valueenum-for-restricted-choices)
    - [4. Group Related Args](#4-group-related-args)
    - [5. Add Value Hints for Completion](#5-add-value-hints-for-completion)
    - [6. Use Custom Parsers for Validation](#6-use-custom-parsers-for-validation)
    - [7. Document with Help Text](#7-document-with-help-text)
    - [8. Handle Errors Gracefully](#8-handle-errors-gracefully)
  - [ggen-Specific Recommendations](#ggen-specific-recommendations)
    - [1. Fix clap-noun-verb Version Mismatch](#1-fix-clap-noun-verb-version-mismatch)
    - [2. Shared Types for CLI + TOML](#2-shared-types-for-cli--toml)
    - [3. Custom Validators for ggen.toml Fields](#3-custom-validators-for-ggentoml-fields)
    - [4. Environment Variable Naming Convention](#4-environment-variable-naming-convention)
    - [5. Add Shell Completions Subcommand](#5-add-shell-completions-subcommand)
