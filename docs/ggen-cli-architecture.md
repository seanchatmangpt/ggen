...
- [ggen CLI Architecture Design](#ggen-cli-architecture-design)
  ...
  - [2. ggen.toml + clap Integration](#2-ggentoml--clap-integration)
    - [2.1 Configuration Flow](#21-configuration-flow)
    - [2.2 ggen.toml Structure](#22-ggentoml-structure)
    - [2.3 Configuration Merging Logic](#23-configuration-merging-logic)
  - [3. Type System Design](#3-type-system-design)
    - [3.1 Type Safety Guarantees](#31-type-safety-guarantees)
    - [3.2 TOML Type Mapping](#32-toml-type-mapping)
  - [4. Validation Flow](#4-validation-flow)
    - [4.1 Validation Hierarchy](#41-validation-hierarchy)
    - [4.2 CLI Argument Validation](#42-cli-argument-validation)
    - [4.3 Configuration Validation](#43-configuration-validation)
  - [5. Security Model](#5-security-model)
    - [5.1 Defense-in-Depth Architecture](#51-defense-in-depth-architecture)
    - [5.2 Path Traversal Prevention](#52-path-traversal-prevention)
    - [5.3 Permission Model](#53-permission-model)
  - [6. Performance Characteristics](#6-performance-characteristics)
    - [6.1 Benchmarks](#61-benchmarks)
    - [6.2 Memory Usage](#62-memory-usage)
    - [6.3 Scalability](#63-scalability)
  - [7. Error Handling](#7-error-handling)
    - [7.1 Error Types](#71-error-types)
    - [7.2 Error Recovery](#72-error-recovery)
  - [8. Testing Strategy](#8-testing-strategy)
    - [8.1 Test Organization](#81-test-organization)
  ...
  - [10. Conclusion](#10-conclusion)
    - [10.1 Architecture Strengths](#101-architecture-strengths)
    - [10.2 Design Trade-offs](#102-design-trade-offs)
