...
- [ggen-dspy: Rust DSPy Implementation Guide](#ggen-dspy-rust-dspy-implementation-guide)
  ...
  - [Architecture Overview](#architecture-overview)
    ...
    - [Core Abstractions](#core-abstractions)
      ...
      - [2. Module Trait](#2-module-trait)
      - [3. Predictor](#3-predictor)
      - [4. ChainOfThought](#4-chainofthought)
  ...
  - [Module Catalog](#module-catalog)
    - [1. Predictor](#1-predictor)
    - [2. ChainOfThought](#2-chainofthought)
    - [3. OptimizedPredictor](#3-optimizedpredictor)
  - [Optimizer Comparison](#optimizer-comparison)
    - [BootstrapFewShot (Currently Implemented)](#bootstrapfewshot-currently-implemented)
    - [Planned Optimizers (See Roadmap)](#planned-optimizers-see-roadmap)
  - [Evaluation Patterns](#evaluation-patterns)
    - [Basic Evaluation](#basic-evaluation)
    - [Detailed Metrics](#detailed-metrics)
    - [Cross-Validation](#cross-validation)
  - [Best Practices](#best-practices)
    - [1. Signature Design](#1-signature-design)
    - [2. Error Handling](#2-error-handling)
    - [3. Metric Functions](#3-metric-functions)
    - [4. Optimization Workflow](#4-optimization-workflow)
  ...
  - [Roadmap](#roadmap)
    ...
    - [Phase 2: Retrieval & RAG (2-4 weeks)](#phase-2-retrieval--rag-2-4-weeks)
    - [Phase 3: Tool System & Agents (2-3 weeks)](#phase-3-tool-system--agents-2-3-weeks)
    - [Phase 4: Advanced Optimizers (4-6 weeks)](#phase-4-advanced-optimizers-4-6-weeks)
    - [Phase 5: Advanced Patterns (3-4 weeks)](#phase-5-advanced-patterns-3-4-weeks)
    - [Phase 6: Production Features (2-3 weeks)](#phase-6-production-features-2-3-weeks)
  - [API Reference](#api-reference)
    - [Signature API](#signature-api)
    - [Module API](#module-api)
    - [Predictor API](#predictor-api)
    - [ChainOfThought API](#chainofthought-api)
    - [Optimizer API](#optimizer-api)
    - [Example API](#example-api)
    - [Assertion API](#assertion-api)
    - [DummyLM API (Testing)](#dummylm-api-testing)
