...
- [Autonomy vs Automation: The Critical Distinction](#autonomy-vs-automation-the-critical-distinction)
  - [TL;DR](#tldr)
  - [Table of Contents](#table-of-contents)
  - [Defining Autonomy vs Automation](#defining-autonomy-vs-automation)
    - [Automation: The Obedient Executor](#automation-the-obedient-executor)
    - [Autonomy: The Intelligent Agent](#autonomy-the-intelligent-agent)
    - [Side-by-Side Comparison](#side-by-side-comparison)
  - [The Admission Control Principle](#the-admission-control-principle)
    - [What Is Admission Control?](#what-is-admission-control)
    - [The Two Critical Capabilities](#the-two-critical-capabilities)
    - [Examples of Admission Control](#examples-of-admission-control)
    - [Why Refusal Is Critical](#why-refusal-is-critical)
  - [The Seatbelt Installer Anti-Pattern](#the-seatbelt-installer-anti-pattern)
    - [The Pattern](#the-pattern)
    - [Why It Breaks TPS (Toyota Production System)](#why-it-breaks-tps-toyota-production-system)
    - [Common Seatbelt Installer Anti-Patterns](#common-seatbelt-installer-anti-patterns)
      - [Anti-Pattern 1: Manual Approval Gates](#anti-pattern-1-manual-approval-gates)
      - [Anti-Pattern 2: Post-Generation Manual Edits](#anti-pattern-2-post-generation-manual-edits)
      - [Anti-Pattern 3: Exception-Based Flow Control](#anti-pattern-3-exception-based-flow-control)
      - [Anti-Pattern 4: Configuration Wizards](#anti-pattern-4-configuration-wizards)
    - [The Human Intervention Test](#the-human-intervention-test)
  - [Why Automation Alone Is Insufficient](#why-automation-alone-is-insufficient)
    - [The Automation Trap](#the-automation-trap)
    - [The Four Failure Modes of Automation](#the-four-failure-modes-of-automation)
      - [1. Silent Corruption](#1-silent-corruption)
      - [2. Fail-and-Wait](#2-fail-and-wait)
      - [3. Cascade Failure](#3-cascade-failure)
      - [4. Assumption Violations](#4-assumption-violations)
    - [Why Teams Choose Automation Over Autonomy](#why-teams-choose-automation-over-autonomy)
  - [Designing Autonomous Systems](#designing-autonomous-systems)
    - [The Five Principles of Autonomy](#the-five-principles-of-autonomy)
      - [1. Admission Control First](#1-admission-control-first)
      - [2. Explicit Refusal](#2-explicit-refusal)
      - [3. State Resolution Without Human Intervention](#3-state-resolution-without-human-intervention)
      - [4. Idempotency](#4-idempotency)
      - [5. Observable Boundaries](#5-observable-boundaries)
    - [Design Checklist: Autonomy vs Automation](#design-checklist-autonomy-vs-automation)
  - [False Autonomy: Detection Guide](#false-autonomy-detection-guide)
    - [The Seven Signs of False Autonomy](#the-seven-signs-of-false-autonomy)
      - [Sign 1: "Autonomous... With Human Verification"](#sign-1-autonomous-with-human-verification)
      - [Sign 2: "Autonomous... Most of the Time"](#sign-2-autonomous-most-of-the-time)
      - [Sign 3: "Autonomous... With Manual Rollback"](#sign-3-autonomous-with-manual-rollback)
      - [Sign 4: "Autonomous... After Initial Setup"](#sign-4-autonomous-after-initial-setup)
      - [Sign 5: "Autonomous... With Escape Hatches"](#sign-5-autonomous-with-escape-hatches)
      - [Sign 6: "Autonomous... In Staging"](#sign-6-autonomous-in-staging)
      - [Sign 7: "Autonomous... Except for Secrets"](#sign-7-autonomous-except-for-secrets)
    - [The False Autonomy Matrix](#the-false-autonomy-matrix)
  - [State Machine Examples](#state-machine-examples)
    - [Example 1: File Processing System](#example-1-file-processing-system)
      - [Automated State Machine (Naive)](#automated-state-machine-naive)
      - [Autonomous State Machine (Correct)](#autonomous-state-machine-correct)
    - [Example 2: Database Migration Runner](#example-2-database-migration-runner)
      - [Automated Migration Runner (Naive)](#automated-migration-runner-naive)
      - [Autonomous Migration Runner (Correct)](#autonomous-migration-runner-correct)
  - [Decision Flow Diagrams](#decision-flow-diagrams)
    - [Decision Flow 1: Request Handling](#decision-flow-1-request-handling)
    - [Decision Flow 2: State Transition Validation](#decision-flow-2-state-transition-validation)
    - [Decision Flow 3: Error Recovery Strategy](#decision-flow-3-error-recovery-strategy)
  - [Real-World Examples](#real-world-examples)
    - [Example 1: Package Managers](#example-1-package-managers)
      - [apt (Automation)](#apt-automation)
      - [Autonomous Package Manager (Design)](#autonomous-package-manager-design)
    - [Example 2: CI/CD Pipelines](#example-2-cicd-pipelines)
      - [GitHub Actions (Automation)](#github-actions-automation)
      - [Autonomous CI/CD (Design)](#autonomous-cicd-design)
    - [Example 3: Database Backup Systems](#example-3-database-backup-systems)
      - [Automated Backup (Naive)](#automated-backup-naive)
      - [Autonomous Backup (Correct)](#autonomous-backup-correct)
  - [Migration Path: Automation → Autonomy](#migration-path-automation-%E2%86%92-autonomy)
    - [Four-Stage Migration](#four-stage-migration)
      - [Stage 1: Add Admission Control](#stage-1-add-admission-control)
      - [Stage 2: Add Explicit Refusal](#stage-2-add-explicit-refusal)
      - [Stage 3: Add State Resolution](#stage-3-add-state-resolution)
      - [Stage 4: Add Observable Boundaries](#stage-4-add-observable-boundaries)
