...
- [CLI Business Logic Extraction Analysis](#cli-business-logic-extraction-analysis)
  - [Executive Summary](#executive-summary)
  - [1. MARKETPLACE CLI ANALYSIS](#1-marketplace-cli-analysis)
    - [1.1 Architecture Pattern (ALREADY IMPLEMENTED)](#11-architecture-pattern-already-implemented)
    - [1.2 Functions Analysis](#12-functions-analysis)
    - [1.3 Extraction Candidates (MINIMAL)](#13-extraction-candidates-minimal)
      - [BLOCKER 1: List Maturity Filtering Logic (Lines 252-285)](#blocker-1-list-maturity-filtering-logic-lines-252-285)
      - [BLOCKER 2: Template Improvements Application (Lines 1677-1693)](#blocker-2-template-improvements-application-lines-1677-1693)
  - [2. TEMPLATE CLI ANALYSIS](#2-template-cli-analysis)
    - [2.1 Architecture Pattern (ALREADY IMPLEMENTED)](#21-architecture-pattern-already-implemented)
    - [2.2 Functions Analysis](#22-functions-analysis)
    - [2.3 Extraction Candidates (MINIMAL)](#23-extraction-candidates-minimal)
      - [LOW PRIORITY: Variable Parsing Helper (Lines 303-316)](#low-priority-variable-parsing-helper-lines-303-316)
  - [3. PROJECT CLI ANALYSIS](#3-project-cli-analysis)
    - [3.1 Architecture Pattern (ALREADY IMPLEMENTED)](#31-architecture-pattern-already-implemented)
    - [3.2 Functions Analysis](#32-functions-analysis)
    - [3.3 Extraction Candidates (MINIMAL)](#33-extraction-candidates-minimal)
      - [LOW PRIORITY: Variable Validation (Lines 182-200, 258-276)](#low-priority-variable-validation-lines-182-200-258-276)
      - [LOW PRIORITY: Variable Parsing Helper (Lines 777-790)](#low-priority-variable-parsing-helper-lines-777-790)
  - [4. COMMON PATTERNS ANALYSIS](#4-common-patterns-analysis)
    - [4.1 Code Duplication](#41-code-duplication)
    - [4.2 Shared Validation Logic](#42-shared-validation-logic)
    - [4.3 Shared Business Logic](#43-shared-business-logic)
  - [5. EXTRACTION MATRIX](#5-extraction-matrix)
    - [5.1 Priority 1 - CRITICAL (None!)](#51-priority-1---critical-none)
    - [5.2 Priority 2 - IMPORTANT (Minimal)](#52-priority-2---important-minimal)
    - [5.3 Priority 3 - NICE-TO-HAVE (Code quality)](#53-priority-3---nice-to-have-code-quality)
  - [6. DEPENDENCY ANALYSIS](#6-dependency-analysis)
    - [6.1 CLI Dependencies (What CLI uses)](#61-cli-dependencies-what-cli-uses)
    - [6.2 Domain Dependencies (What would be needed)](#62-domain-dependencies-what-would-be-needed)
    - [6.3 Circular Dependency Risk](#63-circular-dependency-risk)
  - [7. BLOCKERS & RISKS](#7-blockers--risks)
    - [7.1 Technical Blockers](#71-technical-blockers)
    - [7.2 State Management Issues](#72-state-management-issues)
    - [7.3 Async/Timing Issues](#73-asynctiming-issues)
  - [8. RECOMMENDATIONS](#8-recommendations)
    - [8.1 High Priority (Do Now)](#81-high-priority-do-now)
    - [8.2 Medium Priority (Do This Week)](#82-medium-priority-do-this-week)
    - [8.3 Low Priority (Nice to Have)](#83-low-priority-nice-to-have)
  - [9. SUCCESS METRICS](#9-success-metrics)
    - [9.1 Current State](#91-current-state)
    - [9.2 Target State (After Recommendations)](#92-target-state-after-recommendations)
  - [10. CONCLUSION](#10-conclusion)
  - [APPENDIX A: File Statistics](#appendix-a-file-statistics)
    - [Marketplace CLI (marketplace.rs)](#marketplace-cli-marketplacers)
    - [Template CLI (template.rs)](#template-cli-templaters)
    - [Project CLI (project.rs)](#project-cli-projectrs)
  - [APPENDIX B: Domain Module Coverage](#appendix-b-domain-module-coverage)
    - [Marketplace Domain (`ggen-domain/src/marketplace/`)](#marketplace-domain-ggen-domainsrcmarketplace)
    - [Template Domain (`ggen-domain/src/template/`)](#template-domain-ggen-domainsrctemplate)
    - [Project Domain (`ggen-domain/src/project/`)](#project-domain-ggen-domainsrcproject)
