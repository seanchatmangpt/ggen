...
- [The 2029 Architecture Paradigm: Why Ontologies Must Be Packs](#the-2029-architecture-paradigm-why-ontologies-must-be-packs)
  - [Executive Summary](#executive-summary)
  - [1. The Anti-Pattern: Direct Code Generation](#1-the-anti-pattern-direct-code-generation)
    - [What Was Built (Commit 74362e9d)](#what-was-built-commit-74362e9d)
    - [Problems Identified](#problems-identified)
      - [1.1 Hardcoded Language Support](#11-hardcoded-language-support)
      - [1.2 No Marketplace Integration](#12-no-marketplace-integration)
      - [1.3 Violates Single Responsibility Principle](#13-violates-single-responsibility-principle)
      - [1.4 No Template Reuse](#14-no-template-reuse)
      - [1.5 No Composition or Discovery](#15-no-composition-or-discovery)
  - [2. The 2029 Approach: Ontologies as First-Class Packs](#2-the-2029-approach-ontologies-as-first-class-packs)
    - [Architecture Overview](#architecture-overview)
    - [Example: Ontology Pack Structure](#example-ontology-pack-structure)
    - [Pack Manifest (`gpack.toml`)](#pack-manifest-gpacktoml)
    - [Template Example (`types.ts.tmpl`)](#template-example-typeststmpl)
  - [3. Why Templates Are Foundational (Not Optional)](#3-why-templates-are-foundational-not-optional)
    - [3.1 Separation of Concerns](#31-separation-of-concerns)
    - [3.2 Reusability and Composition](#32-reusability-and-composition)
    - [3.3 Community Extension](#33-community-extension)
    - [3.4 Versioning and Stability](#34-versioning-and-stability)
  - [4. Why Composition and Discovery Matter](#4-why-composition-and-discovery-matter)
    - [4.1 The Network Effect](#41-the-network-effect)
    - [4.2 Dependency Management](#42-dependency-management)
    - [4.3 Quality and Validation](#43-quality-and-validation)
  - [5. Separating Concerns: CLI vs Domain vs Templates](#5-separating-concerns-cli-vs-domain-vs-templates)
    - [5.1 CLI Layer Responsibilities](#51-cli-layer-responsibilities)
    - [5.2 Domain Layer Responsibilities](#52-domain-layer-responsibilities)
    - [5.3 Template Layer Responsibilities](#53-template-layer-responsibilities)
  - [6. Identifying "Old Thinking" in Other Parts of ggen](#6-identifying-old-thinking-in-other-parts-of-ggen)
    - [6.1 Red Flags to Watch For](#61-red-flags-to-watch-for)
      - [Code Generation in CLI](#code-generation-in-cli)
      - [Hardcoded Output Formats](#hardcoded-output-formats)
      - [Business Logic in Templates](#business-logic-in-templates)
    - [6.2 Audit Checklist](#62-audit-checklist)
  - [7. The Philosophy Behind "Ontologies as Packs"](#7-the-philosophy-behind-ontologies-as-packs)
    - [7.1 First-Class Citizenship](#71-first-class-citizenship)
    - [7.2 Convention Over Configuration (with Escape Hatches)](#72-convention-over-configuration-with-escape-hatches)
    - [7.3 Composition Over Inheritance](#73-composition-over-inheritance)
    - [7.4 Data-Driven Over Code-Driven](#74-data-driven-over-code-driven)
  - [8. Scaling to Other Extensible Systems](#8-scaling-to-other-extensible-systems)
    - [8.1 Database Migrations](#81-database-migrations)
    - [8.2 API Generators](#82-api-generators)
    - [8.3 Documentation Generators](#83-documentation-generators)
    - [8.4 Universal Pattern](#84-universal-pattern)
  - [9. Implementation Roadmap](#9-implementation-roadmap)
    - [Phase 1: Core Infrastructure (Week 1)](#phase-1-core-infrastructure-week-1)
    - [Phase 2: Template Packs (Week 2)](#phase-2-template-packs-week-2)
    - [Phase 3: Marketplace Integration (Week 3)](#phase-3-marketplace-integration-week-3)
    - [Phase 4: Migration (Week 4)](#phase-4-migration-week-4)
    - [Phase 5: Community Enablement (Ongoing)](#phase-5-community-enablement-ongoing)
  - [10. Lessons Learned: Universal Principles](#10-lessons-learned-universal-principles)
    - [10.1 Architecture Principles](#101-architecture-principles)
    - [10.2 Product Principles](#102-product-principles)
    - [10.3 Code Quality Principles](#103-code-quality-principles)
  - [11. Conclusion](#11-conclusion)
    - [The Core Lesson](#the-core-lesson)
    - [The 2029 Mindset](#the-2029-mindset)
