...
- [Watch Mode Feature](#watch-mode-feature)
  - [Overview](#overview)
  - [Purpose](#purpose)
  - [Usage](#usage)
  ...
  - [Debounce Behavior](#debounce-behavior)
    - [Default Debounce](#default-debounce)
    - [Customizable Debounce](#customizable-debounce)
    - [Burst Protection](#burst-protection)
  - [Workflow Examples](#workflow-examples)
    - [Example 1: Ontology-Driven Development](#example-1-ontology-driven-development)
    - [Example 2: Template Development](#example-2-template-development)
    - [Example 3: SHACL Validation Iteration](#example-3-shacl-validation-iteration)
    - [Example 4: Multi-Rule Development](#example-4-multi-rule-development)
  - [Intelligent Rule Filtering](#intelligent-rule-filtering)
    - [Example: Query Change](#example-query-change)
    - [Example: Ontology Change](#example-ontology-change)
    - [Example: Template Change](#example-template-change)
  - [Output Formats](#output-formats)
    - [Terminal Output (Default)](#terminal-output-default)
    - [Verbose Output](#verbose-output)
    - [JSON Output (for tools)](#json-output-for-tools)
  ...
  - [Advanced Configuration](#advanced-configuration)
    - [Polling vs Native](#polling-vs-native)
    - [Resource Limits](#resource-limits)
    - [Graceful Shutdown](#graceful-shutdown)
  - [Integration Examples](#integration-examples)
    - [Example 1: Docker Development](#example-1-docker-development)
    - [Example 2: VS Code Integration](#example-2-vs-code-integration)
    - [Example 3: GitHub Codespaces](#example-3-github-codespaces)
  - [Troubleshooting](#troubleshooting)
    - [Issue: Watch mode not triggering](#issue-watch-mode-not-triggering)
    - [Issue: Too many files watched](#issue-too-many-files-watched)
    - [Issue: Debounce too short/long](#issue-debounce-too-shortlong)
    - [Issue: Watch mode exits immediately](#issue-watch-mode-exits-immediately)
