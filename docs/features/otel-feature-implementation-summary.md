...
- [OpenTelemetry Optional Feature - Implementation Summary](#opentelemetry-optional-feature---implementation-summary)
  - [Overview](#overview)
  - [Changes Implemented](#changes-implemented)
    - [1. Workspace Configuration (`/home/user/ggen/Cargo.toml`)](#1-workspace-configuration-homeuserggencargotoml)
      - [Added Feature Flag](#added-feature-flag)
      - [Made Workspace Dependencies Optional](#made-workspace-dependencies-optional)
      - [Removed OTEL from Dev Dependencies](#removed-otel-from-dev-dependencies)
    - [2. ggen-core Configuration (`/home/user/ggen/crates/ggen-core/Cargo.toml`)](#2-ggen-core-configuration-homeuserggencratesggen-corecargotoml)
      - [Made Dependencies Optional](#made-dependencies-optional)
      - [Added Feature Flag](#added-feature-flag-1)
    - [3. Telemetry Module (`/home/user/ggen/crates/ggen-core/src/telemetry.rs`)](#3-telemetry-module-homeuserggencratesggen-coresrctelemetryrs)
      - [Added Feature Gates to Imports](#added-feature-gates-to-imports)
      - [Added Conditional Implementations](#added-conditional-implementations)
    - [4. ggen-dod Cleanup (`/home/user/ggen/crates/ggen-dod/Cargo.toml`)](#4-ggen-dod-cleanup-homeuserggencratesggen-dodcargotoml)
      - [Removed Unused Dependencies](#removed-unused-dependencies)
    - [5. knhk-otel (No Changes Needed)](#5-knhk-otel-no-changes-needed)
  - [Files Modified](#files-modified)
  - [Files Created](#files-created)
  - [Files Updated](#files-updated)
  - [Technical Design](#technical-design)
    - [Feature Gate Pattern](#feature-gate-pattern)
    - [Dependency Propagation](#dependency-propagation)
    - [No-Op Implementations](#no-op-implementations)
  - [Expected Performance Impact](#expected-performance-impact)
    - [Dependency Reduction](#dependency-reduction)
  ...
  - [Validation Status](#validation-status)
    ...
    - [Validation Status](#validation-status-1)
  - [Validation Command](#validation-command)
  - [Known Limitations](#known-limitations)
    - [1. OTEL in Tests](#1-otel-in-tests)
    - [2. Cross-Crate Feature Propagation](#2-cross-crate-feature-propagation)
    - [3. Documentation Visibility](#3-documentation-visibility)
