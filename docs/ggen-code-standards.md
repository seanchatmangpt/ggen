...
- [ggen Code Standards & Style Guide](#ggen-code-standards--style-guide)
  - [Purpose](#purpose)
  - [1. General Principles](#1-general-principles)
    - [1.1 SOLID Principles](#11-solid-principles)
    - [1.2 Lean Manufacturing Principles](#12-lean-manufacturing-principles)
  - [2. Naming Conventions](#2-naming-conventions)
    - [2.1 Crate Names](#21-crate-names)
    - [2.2 Module Names](#22-module-names)
    - [2.3 Type Names](#23-type-names)
    - [2.4 Function Names](#24-function-names)
    - [2.5 Constants and Statics](#25-constants-and-statics)
    - [2.6 Variable Names](#26-variable-names)
  - [3. Error Handling Standards](#3-error-handling-standards)
    - [3.1 Error Type Definition](#31-error-type-definition)
    - [3.2 Result Type Alias](#32-result-type-alias)
    - [3.3 Error Messages](#33-error-messages)
    - [3.4 Panic Documentation](#34-panic-documentation)
  - [4. Documentation Standards](#4-documentation-standards)
    - [4.1 Module-Level Documentation](#41-module-level-documentation)
    - [4.2 Type Documentation](#42-type-documentation)
    - [4.3 Function Documentation](#43-function-documentation)
    - [4.4 Documentation Style](#44-documentation-style)
  - [5. Testing Standards](#5-testing-standards)
    - [5.1 Test Organization](#51-test-organization)
    - [5.2 Test Naming](#52-test-naming)
    - [5.3 Test Coverage Goals](#53-test-coverage-goals)
    - [5.4 Test Assertions](#54-test-assertions)
  - [6. Code Organization Standards](#6-code-organization-standards)
    - [6.1 Module Structure](#61-module-structure)
    - [6.2 Import Organization](#62-import-organization)
    - [6.3 File Size Limits](#63-file-size-limits)
  - [7. Type Safety Standards](#7-type-safety-standards)
    - [7.1 Avoid Stringly-Typed APIs](#71-avoid-stringly-typed-apis)
    - [7.2 Use Newtypes for Domain Concepts](#72-use-newtypes-for-domain-concepts)
    - [7.3 Builder Pattern for Complex Types](#73-builder-pattern-for-complex-types)
  - [8. Performance Standards](#8-performance-standards)
    - [8.1 Avoid Unnecessary Allocations](#81-avoid-unnecessary-allocations)
    - [8.2 Use Iterators Over Loops](#82-use-iterators-over-loops)
    - [8.3 Benchmark Critical Paths](#83-benchmark-critical-paths)
  - [9. Clippy and Linting](#9-clippy-and-linting)
    - [9.1 Required Lints](#91-required-lints)
    - [9.2 Allowed Exceptions](#92-allowed-exceptions)
    - [9.3 Pre-Commit Checks](#93-pre-commit-checks)
  - [10. Security Standards](#10-security-standards)
    - [10.1 Input Validation](#101-input-validation)
    - [10.2 No Secrets in Code](#102-no-secrets-in-code)
    - [10.3 Path Traversal Prevention](#103-path-traversal-prevention)
  - [11. Git and Versioning Standards](#11-git-and-versioning-standards)
    - [11.1 Commit Messages](#111-commit-messages)
    - [11.2 Version Numbering](#112-version-numbering)
  ...
  - [14. Examples and Anti-Patterns](#14-examples-and-anti-patterns)
    - [✅ Good Example: Complete Module](#-good-example-complete-module)
    - [❌ Anti-Pattern: Bad Example](#-anti-pattern-bad-example)
