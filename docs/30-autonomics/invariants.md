...
- [System Invariants: Checkable Constraints](#system-invariants-checkable-constraints)
  - [Executive Summary](#executive-summary)
  - [Invariant 1: Entitlement Active Required](#invariant-1-entitlement-active-required)
    - [Statement](#statement)
    - [Checkable Condition](#checkable-condition)
    - [When Checked](#when-checked)
    - [State Transitions Affected](#state-transitions-affected)
    - [Receipt on Violation](#receipt-on-violation)
  ...
  - [Invariant 2: Permission Required for Every Action](#invariant-2-permission-required-for-every-action)
    ...
    - [Checkable Condition](#checkable-condition-1)
    - [When Checked](#when-checked-1)
    - [Permission Matrix](#permission-matrix)
    - [Receipt on Violation](#receipt-on-violation-1)
    - [Recovery Path](#recovery-path-1)
  - [Invariant 3: Quota Not Exceeded](#invariant-3-quota-not-exceeded)
    - [Statement](#statement-2)
    - [Checkable Condition](#checkable-condition-2)
    - [When Checked](#when-checked-2)
    - [Quota Policies](#quota-policies)
    - [Receipt on Violation](#receipt-on-violation-2)
    - [Recovery Path](#recovery-path-2)
  - [Invariant 4: Receipt Ledger Available](#invariant-4-receipt-ledger-available)
    - [Statement](#statement-3)
    - [Checkable Condition](#checkable-condition-3)
    - [When Checked](#when-checked-3)
    - [Health Check Interval](#health-check-interval)
    - [Receipt on Violation](#receipt-on-violation-3)
    - [Recovery Path](#recovery-path-3)
  - [Invariant 5: Policy Pack Loaded](#invariant-5-policy-pack-loaded)
    - [Statement](#statement-4)
    - [Checkable Condition](#checkable-condition-4)
    - [When Checked](#when-checked-4)
    - [Policy Load Sequence](#policy-load-sequence)
    - [Receipt on Violation](#receipt-on-violation-4)
    - [Recovery Path](#recovery-path-4)
  - [Invariant 6: Signal Storm Prevention](#invariant-6-signal-storm-prevention)
    - [Statement](#statement-5)
    - [Checkable Condition](#checkable-condition-5)
    - [When Checked](#when-checked-5)
    - [Throttling Behavior](#throttling-behavior)
    - [Receipt on Violation](#receipt-on-violation-5)
    - [Recovery Path](#recovery-path-5)
  - [Invariant 7: Action Concurrency Bounded](#invariant-7-action-concurrency-bounded)
    - [Statement](#statement-6)
    - [Checkable Condition](#checkable-condition-6)
    - [When Checked](#when-checked-6)
    - [Queue Management](#queue-management)
    - [Receipt on Violation (Concurrency Limited)](#receipt-on-violation-concurrency-limited)
  ...
  - [Invariant 8: Deterministic Behavior](#invariant-8-deterministic-behavior)
    ...
    - [Checkable Condition](#checkable-condition-7)
    - [When Checked](#when-checked-7)
    - [Determinism Requirements](#determinism-requirements)
    - [Receipt on Violation](#receipt-on-violation-6)
    - [Recovery Path](#recovery-path-6)
  - [Invariant Checking Summary Table](#invariant-checking-summary-table)
