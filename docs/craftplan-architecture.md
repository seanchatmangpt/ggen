...
- [Craftplan Integration Architecture for A2A-RS Ecosystem](#craftplan-integration-architecture-for-a2a-rs-ecosystem)
  ...
  - [Architecture Principles](#architecture-principles)
    ...
    - [4. Async-First Design](#4-async-first-design)
  - [Component Architecture](#component-architecture)
    - [A2A-RS Core Framework](#a2a-rs-core-framework)
    - [A2A-Agents](#a2a-agents)
    - [A2A-MCP Bridge](#a2a-mcp-bridge)
    - [Craftplan Integration Layer](#craftplan-integration-layer)
      - [Option 1: Direct HTTP Client (Recommended)](#option-1-direct-http-client-recommended)
      - [Option 2: Dedicated A2A Endpoint in Craftplan](#option-2-dedicated-a2a-endpoint-in-craftplan)
  - [Data Flow](#data-flow)
    - [1. Agent Message Processing Flow](#1-agent-message-processing-flow)
    - [2. WebSocket Streaming Flow](#2-websocket-streaming-flow)
    - [3. MCP Bridge Flow (A2A → MCP)](#3-mcp-bridge-flow-a2a-%E2%86%92-mcp)
  - [Integration Patterns](#integration-patterns)
    - [Pattern 1: Agent per Domain](#pattern-1-agent-per-domain)
    - [Pattern 2: Intent-Based Message Routing](#pattern-2-intent-based-message-routing)
    - [Pattern 3: Caching Layer](#pattern-3-caching-layer)
    - [Pattern 4: Event-Driven Updates](#pattern-4-event-driven-updates)
    - [Pattern 5: Composite Agents](#pattern-5-composite-agents)
  - [Security & Authentication](#security--authentication)
    - [Authentication Architecture](#authentication-architecture)
    - [Token Management](#token-management)
    - [Authorization Patterns](#authorization-patterns)
  - [API Contracts](#api-contracts)
    - [1. A2A → Craftplan (JSON:API)](#1-a2a-%E2%86%92-craftplan-jsonapi)
    - [2. Craftplan → A2A (Direct A2A Protocol)](#2-craftplan-%E2%86%92-a2a-direct-a2a-protocol)
    - [3. Message Schema Mapping](#3-message-schema-mapping)
  ...
  - [Appendix](#appendix)
    ...
    - [C. Performance Considerations](#c-performance-considerations)
    - [D. Troubleshooting Guide](#d-troubleshooting-guide)
