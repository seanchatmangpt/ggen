...
```mermaid
graph TD
    A["🎯 Opportunity Capture<br/>(Day 0-2)<br/>Identify + Qualify"] --> B["📋 Qualification Phase<br/>(Day 2-5)<br/>Budget? Timeline? Fit?"]
    B --> C["🔍 Discovery/Sales<br/>Engineering<br/>(Day 5-15)<br/>Pain points + Compliance"]
    C --> D["🎯 Bid Strategy<br/>(Day 10-15)<br/>SKU selection + Pricing"]
    D --> E["📄 RFP Response<br/>(Day 15-28)<br/>Compliance matrix + C4s"]
    E --> F["🏆 Proposal<br/>Submission<br/>(Day 28-30)<br/>Final review + Sign-off"]
    F --> G["📞 Contract<br/>Negotiation<br/>(Post-submit)<br/>Legal + Insurance"]
    G --> H["📊 Win/Loss<br/>Analysis<br/>(Post-close)<br/>Capture insights"]

    B -->|No Fit| I["❌ Disqualify<br/>Archive opportunity"]
    C -->|Insufficient Data| J["⏱️ Defer<br/>Watch for RFP"]
...
### Deliverables (Day 2)
- ✅ Customer Summary document (1 page)
- ✅ Pain Points analysis (3–5 points mapped to SKUs)
- ✅ Go/No-Go decision: **Proceed to Qualification** or **Archive**
- ✅ Primary contact (name, phone, email) added to CRM
...
- **Accept**: Budget identified and ≥$250K
...
|-----------|--------|-------|---------|
| Budget | ≥$250K identified | TBD, revisit | <$250K or unknown |
...
### Deliverables (Day 5)
- ✅ Qualification scorecard (completed matrix)
- ✅ Updated customer profile (budget, timeline, decision authority)
- ✅ Compliance framework list (initial)
- ✅ Go/No-Go decision: **Proceed to Discovery** or **Defer/Archive**
...
- ✅ SKU fit analysis for each recommended SKU (using template)
- ✅ Competitive landscape analysis
- ✅ Draft compliance bundle recommendation
- ✅ Compliance gap assessment (which controls are NOT covered, why)
- ✅ 3 customer references identified (for RFP response)
...
- **Tier Decision**:
  ...
  - Budget $1.5M+ → **Enterprise Tier** ($750K+ base SKU)

- **Volume Discounts**:
  - Single program (1 agency) → no discount (100%)
  - Multi-program (5+ agencies) → 10% discount (90%)
  - Large consortium (10+ agencies) → 20% discount (80%)
...
### Deliverables (Day 15)
- ✅ Final SKU bundle recommendation (with compliance coverage matrix)
- ✅ Pricing proposal (3-year preferred option, 1-year fallback)
- ✅ Competitive win/loss strategy
- ✅ Proposal differentiation themes (5 key messages)
- ✅ Implementation timeline (8-week Gantt chart)
- ✅ Risk register (top 5 deployment risks + mitigation)
...
- **Control-by-Control Mapping**: Customer specifies control (e.g., AC-2 Account Management)
  ...
  - Status: ✅ Covered, 🔶 Partial, ❌ Not Covered (+ mitigation)
...
|--------------|--------------|--------|----------|-----------------|
| AC-2 Account Management | IAM Bundle (SKU-01) | ✅ Covered | SOC 2 Type II Report (Jan 2026) | None |
| AU-2 Audit Events | Compliance Monitor (SKU-02) | ✅ Covered | FedRAMP SSP Control Implementation (Feb 2025) | None |
| CA-7 Continuous Monitoring | Monitoring Stack (SKU-03) | 🔶 Partial | Real-time alerts covered; annual risk assessment manual | Risk assessment will be automated in Y2 (included in contract) |
| IR-2 Incident Response | Not covered | ❌ Not Covered | Recommend Incident Response Engine (SKU-08) | Partner with [X] for IR orchestration (subcontractor, not ggen responsibility) |
...
4. **Data Flow**: How data moves from customer systems → ggen → reporting
...
- ✅ Compliance Matrix with evidence artifacts
- ✅ C4 Architecture diagrams (context, container, component)
- ✅ Pricing proposal (BOE with line items, quantities, rates)
- ✅ References (3 contacts with verified willingness)
- ✅ Executive summary (2 pages, printable standalone)
- ✅ Final compliance checklist (all customer requirements addressed)
...
**Legal & Compliance**:
- ✅ All insurance/bonding requirements addressed
- ✅ FAR/DFARS compliance (if government)
- ✅ Pricing authority approved (Finance)
- ✅ No conflicting commitments or past performance issues
- ✅ Confidential information properly marked

**Technical**:
- ✅ All RFP requirements addressed (section-by-section map)
- ✅ Compliance Matrix complete and auditor-ready
- ✅ C4 diagrams correct and clear
- ✅ References verified (willing to discuss)
- ✅ Pricing realistic (no overcommitment on delivery)

**Quality**:
- ✅ Grammar/spelling (spell-check + manual review)
- ✅ Formatting (consistent fonts, margins, headers)
- ✅ Pagination (proper references and bookmarks)
- ✅ Evidence artifacts complete (no broken links)
...
### Deliverables (Day 30)
- ✅ Final RFP response (signed by authorized official if required)
- ✅ Evidence artifacts bundle (compliance reports, certifications)
- ✅ Internal approval sign-off sheet
- ✅ Submission confirmation (timestamp + system receipt)
- ✅ Archive file (proposal + all attachments, for post-win reference)
...
- ❌ Unlimited liability (demand cap)
- ❌ Customer owns all IP / source code escrow (not acceptable)
- ❌ Performance penalties >10% of contract value
- ❌ Payment terms >Net 60 (cash flow impact)
- ❌ Compliance certification in Year 1 (unrealistic, propose Year 1 evidence roadmap)
...
- ✅ Negotiation log (issues, positions, resolutions)
- ✅ Final contract review (Legal approval)
- ✅ Signed contract (executed by both parties)
- ✅ Insurance certificates (proof of coverage)
- ✅ Performance bond (if contract >$250K)
...
- ✅ Customer interview notes (with quotes if possible)
- ✅ Competitive analysis (who won, why we lost)
- ✅ Lessons learned document (5–7 key takeaways)
- ✅ Process improvements recommendation (1-page action items)
...
**NIST 800-53 Controls**: 11 of 12 required ✅

| Control | Status | Evidence | Gap |
|---------|--------|----------|-----|
| AC-2 | ✅ Covered | SOC 2 Type II Report | None |
| AU-2 | ✅ Covered | FedRAMP SSP | None |
| CA-7 | 🔶 Partial | Real-time only; manual annual | Annual will be automated Y2 |
...
- **SKU + Bundle Price**: $280K/year ✅ (56% of budget)
...
✅ **PROCEED** with confidence 8.5/10
...
2. **Key Competitive Advantages We Leveraged**:
   - 8-week deployment vs. 20 weeks ✅
   - Built-in FedRAMP evidence ✅
...
DAY 5  ★ DISCOVERY CALLS COMPLETE
...
DAY 15 ★ RFP RESPONSE KICKED OFF
...
DAY 28 ★ FINAL REVIEW & SUBMISSION PREP
...
|--------|--------|---------|--------|
| **Capture Rate** | >80% of identified opportunities move past Qualification | [X]% | 🟡 Track |
| **Win Rate** | >40% of submitted proposals (gov't avg: 25–35%) | [X]% | 🟡 Track |
| **Average Deal Size** | >$250K/year | $[X]K | 🟡 Track |
| **Capture Timeline** | 30 days from opportunity to RFP submission | [X] days | 🟡 Track |
| **Proposal Quality** | 100% include compliance matrix, C4 diagrams, references | [X]% | 🟡 Track |
| **Customer Satisfaction** | >8/10 post-engagement debrief rating | [X]/10 | 🟡 Track |
| **Competitive Win Rate** | Win vs. incumbent >50% | [X]% | 🟡 Track |
...
- ✅ Pipeline phases (8 phases documented)
- ✅ Activity checklists (per phase)
- ✅ Decision gates (qualification, bid strategy, legal review)
- ✅ Templates (8+ included: customer summary, SKU fit, competitive analysis, etc.)
- ✅ Timeline (30-day sprint with daily milestones)
- ✅ Success metrics (win rate >40%, deal size >$250K, capture in 30 days)
- ✅ Cross-references (compliance-matrix.md, boe-pricing.md, capabilities-statement.md)
...
- ✅ All 8 pipeline phases documented (Capture → Win/Loss Analysis)
- ✅ All phase activities, deliverables, and decision gates defined
- ✅ 8+ templates created and integrated (customer summary, pain point, SKU fit, etc.)
- ✅ 30-day timeline validated (realistic milestones)
- ✅ Success metrics defined and measurable (win rate, deal size, capture speed)
- ✅ References to related documents correct (compliance-matrix.md, boe-pricing.md, capabilities-statement.md)
- ✅ Mermaid diagrams rendered (pipeline flowchart, timeline)
- ✅ Receipt Contract section completed (evidence artifacts, signatures)
- ✅ Document formatted for government procurement (professional, auditor-ready)
- ✅ Glossary.md references updated (key terms defined)
