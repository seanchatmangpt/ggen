% Glossary Appendix for PhD Thesis
...
%
% Usage: Include this file as an appendix in the main thesis document
%   This should be inserted before other appendices (e.g., SPARQL Reference)
