...
- [Deployment Guide: ggen v5.0.2](#deployment-guide-ggen-v502)
  - [Quick Start](#quick-start)
    - [Fastest Path to Production](#fastest-path-to-production)
  - [Deployment Scenarios](#deployment-scenarios)
    - [Scenario 1: Developer Workstations (Ubuntu/Debian)](#scenario-1-developer-workstations-ubuntudebian)
    - [Scenario 2: Corporate APT Repository](#scenario-2-corporate-apt-repository)
      - [Using reprepro:](#using-reprepro)
      - [Using Artifactory:](#using-artifactory)
    - [Scenario 3: Docker Containerization](#scenario-3-docker-containerization)
      - [Basic Docker Image:](#basic-docker-image)
      - [Multi-Stage Build (Smaller Image):](#multi-stage-build-smaller-image)
    - [Scenario 4: Kubernetes Deployment](#scenario-4-kubernetes-deployment)
      - [Step 1: Push Image to Registry](#step-1-push-image-to-registry)
      - [Step 2: Deploy as Job](#step-2-deploy-as-job)
      - [Step 3: Deploy as CronJob (Scheduled)](#step-3-deploy-as-cronjob-scheduled)
    - [Scenario 5: CI/CD Pipeline Integration](#scenario-5-cicd-pipeline-integration)
      - [GitHub Actions:](#github-actions)
      - [GitLab CI:](#gitlab-ci)
      - [Jenkins:](#jenkins)
    - [Scenario 6: Serverless / Lambda Deployment](#scenario-6-serverless--lambda-deployment)
      - [Step 1: Build Lambda-Compatible Image](#step-1-build-lambda-compatible-image)
  - [Security Best Practices](#security-best-practices)
    - [1. Checksum Verification (MANDATORY)](#1-checksum-verification-mandatory)
    - [2. gVisor Sandbox (Recommended for Multi-Tenant)](#2-gvisor-sandbox-recommended-for-multi-tenant)
    - [3. Least Privilege Execution](#3-least-privilege-execution)
  ...
  - [Troubleshooting](#troubleshooting)
    - [Common Issues](#common-issues)
      - [Issue 1: `dpkg: dependency problems`](#issue-1-dpkg-dependency-problems)
      - [Issue 2: `ggen: command not found` after installation](#issue-2-ggen-command-not-found-after-installation)
      - [Issue 3: `error while loading shared libraries`](#issue-3-error-while-loading-shared-libraries)
      - [Issue 4: gVisor runtime not found](#issue-4-gvisor-runtime-not-found)
      - [Issue 5: Permission denied in Kubernetes](#issue-5-permission-denied-in-kubernetes)
  - [Rollback Procedures](#rollback-procedures)
    - [Debian Package Rollback](#debian-package-rollback)
