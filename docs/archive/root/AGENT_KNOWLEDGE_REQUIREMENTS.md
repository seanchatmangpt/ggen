...
- [Agent Knowledge Requirements for Building Advanced ggen Projects](#agent-knowledge-requirements-for-building-advanced-ggen-projects)
  - [Purpose](#purpose)
  - [1. Workspace Architecture](#1-workspace-architecture)
    - [1.1 Crate Organization](#11-crate-organization)
    - [1.2 Module Hierarchy](#12-module-hierarchy)
  - [2. CLI Command Implementation (clap-noun-verb)](#2-cli-command-implementation-clap-noun-verb)
    - [2.1 Command Discovery Pattern](#21-command-discovery-pattern)
    - [2.2 CLI-to-Domain Bridge](#22-cli-to-domain-bridge)
  - [3. RDF & SPARQL Integration (Oxigraph)](#3-rdf--sparql-integration-oxigraph)
    - [3.1 Graph Management](#31-graph-management)
    - [3.2 Template-RDF Integration](#32-template-rdf-integration)
    - [3.3 Ggen Ontology](#33-ggen-ontology)
  - [4. Template Generation System (Tera)](#4-template-generation-system-tera)
    - [4.1 Template Processing Flow](#41-template-processing-flow)
    - [4.2 Template Structure](#42-template-structure)
    - [4.3 Custom Tera Filters](#43-custom-tera-filters)
  - [5. Marketplace Package System](#5-marketplace-package-system)
    - [5.1 Package Structure](#51-package-structure)
    - [5.2 Package Discovery](#52-package-discovery)
    - [5.3 Package Validation](#53-package-validation)
  - [6. Configuration System](#6-configuration-system)
    - [6.1 ggen.toml Structure](#61-ggentoml-structure)
    - [6.2 Makefile.toml (Lifecycle)](#62-makefiletoml-lifecycle)
  - [7. Build System & CI/CD](#7-build-system--cicd)
    - [7.1 Cargo Make Integration](#71-cargo-make-integration)
    - [7.2 Pre-Commit Hooks](#72-pre-commit-hooks)
    - [7.3 Performance SLOs](#73-performance-slos)
  - [8. Error Handling & Validation](#8-error-handling--validation)
    - [8.1 Error Type Hierarchy](#81-error-type-hierarchy)
    - [8.2 Validation Chains](#82-validation-chains)
  - [9. Testing Strategy (Chicago TDD)](#9-testing-strategy-chicago-tdd)
    - [9.1 Test Categories](#91-test-categories)
    - [9.2 Chicago TDD Principles](#92-chicago-tdd-principles)
    - [9.3 Test Utilities](#93-test-utilities)
  - [10. Polyglot Code Generation](#10-polyglot-code-generation)
    - [10.1 Language Target Patterns](#101-language-target-patterns)
    - [10.2 Language-Specific Templates](#102-language-specific-templates)
  - [11. Key Interfaces & Traits](#11-key-interfaces--traits)
    - [11.1 Core Traits](#111-core-traits)
    - [11.2 Type-Level Patterns](#112-type-level-patterns)
  - [12. Performance Optimization Points](#12-performance-optimization-points)
    - [12.1 Compilation Performance](#121-compilation-performance)
    - [12.2 Runtime Performance](#122-runtime-performance)
    - [12.3 Benchmarking](#123-benchmarking)
  - [13. Advanced Agent Integration Patterns](#13-advanced-agent-integration-patterns)
    - [13.1 Autonomous Project Generation](#131-autonomous-project-generation)
    - [13.2 Marketplace Package Creation](#132-marketplace-package-creation)
    - [13.3 Debugging Compilation Issues](#133-debugging-compilation-issues)
  - [14. Extending the System](#14-extending-the-system)
    - [14.1 Adding New CLI Commands](#141-adding-new-cli-commands)
    - [14.2 Adding New Template Filters](#142-adding-new-template-filters)
    - [14.3 Adding New Marketplace Categories](#143-adding-new-marketplace-categories)
  - [15. Critical Implementation Rules](#15-critical-implementation-rules)
    - [15.1 Poka-Yoke (Error Prevention)](#151-poka-yoke-error-prevention)
    - [15.2 Andon Signals (Stop the Line)](#152-andon-signals-stop-the-line)
    - [15.3 Quality Gates](#153-quality-gates)
  - [16. Example Workflows](#16-example-workflows)
    - [16.1 Creating a REST API Project](#161-creating-a-rest-api-project)
    - [16.2 Creating a Custom Marketplace Package](#162-creating-a-custom-marketplace-package)
    - [16.3 Debugging Generation Issues](#163-debugging-generation-issues)
  - [17. Agent Decision Tree](#17-agent-decision-tree)
    - [17.1 Command Selection](#171-command-selection)
    - [17.2 Template vs Package](#172-template-vs-package)
    - [17.3 Language Selection](#173-language-selection)
  - [18. References](#18-references)
    - [18.1 Key Files to Study](#181-key-files-to-study)
    - [18.2 Essential Dependencies](#182-essential-dependencies)
