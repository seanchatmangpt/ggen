...
- [ggen Research Index - Complete Reference](#ggen-research-index---complete-reference)
  - [Quick Navigation](#quick-navigation)
  - [Research Summaries](#research-summaries)
  - [Thesis & Academic Materials](#thesis--academic-materials)
    - [Main Thesis Files](#main-thesis-files)
    - [Thesis Chapters & Topics](#thesis-chapters--topics)
    - [Academic Archive](#academic-archive)
  - [Agent & Swarm Systems](#agent--swarm-systems)
    - [Agent Documentation](#agent-documentation)
    - [Agent Research Findings](#agent-research-findings)
  - [Specifications & RDF](#specifications--rdf)
    - [Core Specification Directory](#core-specification-directory)
    - [Specification Topics](#specification-topics)
    - [RDF/TTL Files](#rdfttl-files)
  - [Performance & Benchmarking](#performance--benchmarking)
    - [Performance Overview](#performance-overview)
    - [Performance Documentation](#performance-documentation)
    - [Benchmarking Research](#benchmarking-research)
    - [Benchmark Audits](#benchmark-audits)
  ...
  - [Evidence & Corpus Data](#evidence--corpus-data)
    - [Primary Evidence Storage](#primary-evidence-storage)
    - [Graph Processing Tools](#graph-processing-tools)
  - [Learning & Documentation](#learning--documentation)
    - [Diataxis Documentation System](#diataxis-documentation-system)
  ...
  - [Infrastructure & Deployment](#infrastructure--deployment)
    ...
    - [Deployment Quality](#deployment-quality)
  - [Claude Code & Agent System](#claude-code--agent-system)
    - [Claude Code Configuration](#claude-code-configuration)
    - [Agent Skills](#agent-skills)
    - [Claude Best Practices](#claude-best-practices)
  ...
  - [Metrics & Health Assessment](#metrics--health-assessment)
    - [Metrics System](#metrics-system)
    - [Progress Tracking](#progress-tracking)
    - [Archive Metrics](#archive-metrics)
  - [Error Analysis & Troubleshooting](#error-analysis--troubleshooting)
    - [Error Documentation](#error-documentation)
    - [Troubleshooting](#troubleshooting)
  - [Financial & Business Research](#financial--business-research)
  ...
  - [Reference Materials](#reference-materials)
    ...
    - [Root-Level References](#root-level-references)
