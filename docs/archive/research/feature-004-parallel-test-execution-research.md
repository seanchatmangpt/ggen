...
- [Feature 004: Parallel Test Execution Research](#feature-004-parallel-test-execution-research)
  - [Executive Summary](#executive-summary)
    - [Decision](#decision)
    - [Rationale](#rationale)
  - [Research Findings](#research-findings)
    - [1. cargo-nextest](#1-cargo-nextest)
      - [Features](#features)
      - [Configuration (.config/nextest.toml)](#configuration-confignextesttoml)
      - [Performance Characteristics](#performance-characteristics)
      - [Compatibility](#compatibility)
      - [Integration with cargo-make](#integration-with-cargo-make)
    - [2. rayon](#2-rayon)
      - [Core Concepts](#core-concepts)
      - [Current Usage in ggen](#current-usage-in-ggen)
      - [Parallel Test Collection Optimization](#parallel-test-collection-optimization)
      ...
      - [Integration with cargo-nextest](#integration-with-cargo-nextest)
    - [3. Optimal Thread Count Configuration](#3-optimal-thread-count-configuration)
      - [DOE Analysis (Design of Experiments)](#doe-analysis-design-of-experiments)
      - [Platform-Specific Notes](#platform-specific-notes)
    - [4. Test Isolation Strategies](#4-test-isolation-strategies)
      - [Process Isolation (cargo-nextest)](#process-isolation-cargo-nextest)
      - [Filesystem Isolation](#filesystem-isolation)
      - [Port Allocation (testcontainers)](#port-allocation-testcontainers)
      - [Environment Variable Isolation](#environment-variable-isolation)
    - [5. Performance Measurement & CPU Utilization](#5-performance-measurement--cpu-utilization)
      - [CPU Utilization Measurement](#cpu-utilization-measurement)
      - [Performance Budgets](#performance-budgets)
      - [Flaky Test Detection](#flaky-test-detection)
      - [Target Validation Script](#target-validation-script)
    - [6. Alternatives Comparison](#6-alternatives-comparison)
      - [Option A: GNU Parallel](#option-a-gnu-parallel)
      - [Option B: Custom Test Harness](#option-b-custom-test-harness)
      - [Option C: cargo-nextest + rayon](#option-c-cargo-nextest--rayon)
  - [Implementation Recommendations](#implementation-recommendations)
    - [Phase 1: cargo-nextest Installation](#phase-1-cargo-nextest-installation)
    - [Phase 2: Configuration](#phase-2-configuration)
    - [Phase 3: Makefile.toml Integration](#phase-3-makefiletoml-integration)
    - [Phase 4: CI Integration](#phase-4-ci-integration)
    - [Phase 5: Performance Validation](#phase-5-performance-validation)
  - [Validation Against Targets](#validation-against-targets)
    - [Target 1: Test Duration ≤ 11s (90th percentile)](#target-1-test-duration-%E2%89%A4-11s-90th-percentile)
    - [Target 2: CPU Utilization ≥ 80%](#target-2-cpu-utilization-%E2%89%A5-80)
    - [Target 3: Cross-Platform Compatibility](#target-3-cross-platform-compatibility)
  - [Risk Assessment](#risk-assessment)
    - [Risk 1: Flaky Tests (Parallelism)](#risk-1-flaky-tests-parallelism)
    - [Risk 2: Doc Test Incompatibility](#risk-2-doc-test-incompatibility)
    - [Risk 3: Binary Size Overhead](#risk-3-binary-size-overhead)
