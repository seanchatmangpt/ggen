...
- [Spec-Kit-3T Thesis Generator v2 - Production Edition](#spec-kit-3t-thesis-generator-v2---production-edition)
  ...
  - [Architecture: The 5-Stage Pipeline](#architecture-the-5-stage-pipeline)
    - [μ₁: SHACL Validation (Quality Gates)](#%CE%BC%E2%82%81-shacl-validation-quality-gates)
    - [μ₂: SPARQL Extraction (Query Knowledge)](#%CE%BC%E2%82%82-sparql-extraction-query-knowledge)
    - [μ₃: Tera Rendering (Template Emission)](#%CE%BC%E2%82%83-tera-rendering-template-emission)
    - [μ₄: Canonicalization (File Hashing)](#%CE%BC%E2%82%84-canonicalization-file-hashing)
    - [μ₅: Cryptographic Receipts (Provenance)](#%CE%BC%E2%82%85-cryptographic-receipts-provenance)
  - [Features](#features)
    - [🚨 Andon Signal System (Toyota Production System)](#-andon-signal-system-toyota-production-system)
    - [⚡ Incremental Build System](#-incremental-build-system)
    - [📋 Cargo-Make Style CLI](#-cargo-make-style-cli)
  ...
  - [Usage Examples](#usage-examples)
    - [Example 1: Basic Workflow](#example-1-basic-workflow)
    - [Example 2: Development Workflow](#example-2-development-workflow)
    - [Example 3: Quality Assurance](#example-3-quality-assurance)
    - [Example 4: Force Full Rebuild](#example-4-force-full-rebuild)
  - [Advanced: Modifying the Thesis](#advanced-modifying-the-thesis)
    - [Adding a New Chapter](#adding-a-new-chapter)
    - [Adding Diataxis Chapter](#adding-diataxis-chapter)
  - [Troubleshooting](#troubleshooting)
    - [SHACL Validation Fails](#shacl-validation-fails)
    - [Incremental Build Not Working](#incremental-build-not-working)
    - [PDF Compilation Errors](#pdf-compilation-errors)
  - [Design Decisions](#design-decisions)
    - [Why Python instead of Rust (for now)?](#why-python-instead-of-rust-for-now)
    - [Why SHACL instead of OWL Reasoning?](#why-shacl-instead-of-owl-reasoning)
    - [Why Jinja2 instead of Tera?](#why-jinja2-instead-of-tera)
  - [Comparison to Other Systems](#comparison-to-other-systems)
  - [Evolution Roadmap](#evolution-roadmap)
    - [v2 (Current): Production Python](#v2-current-production-python)
    - [v3 (Future): Rust Implementation](#v3-future-rust-implementation)
    - [v4 (Vision): AI-Enhanced](#v4-vision-ai-enhanced)
  - [FAQ](#faq)
    - [Q: Why generate a thesis from RDF?](#q-why-generate-a-thesis-from-rdf)
    - [Q: How does this compare to manual LaTeX?](#q-how-does-this-compare-to-manual-latex)
    - [Q: Can I use this for my own thesis?](#q-can-i-use-this-for-my-own-thesis)
    - [Q: What's the learning curve?](#q-whats-the-learning-curve)
    - [Q: Does this work for other document types?](#q-does-this-work-for-other-document-types)
