...
- [Research Phase: Grand Unified KGC Thesis](#research-phase-grand-unified-kgc-thesis)
  - [Executive Summary](#executive-summary)
  - [1. LaTeX PhD Thesis Best Practices](#1-latex-phd-thesis-best-practices)
    - [Decision: memoir + biblatex/biber + amsthm + thmtools + algorithm2e](#decision-memoir--biblatexbiber--amsthm--thmtools--algorithm2e)
    - [Required Packages (Load Order Critical)](#required-packages-load-order-critical)
    - [Theorem Environments](#theorem-environments)
    - [Compilation Sequence](#compilation-sequence)
    - [Alternatives Rejected](#alternatives-rejected)
  - [2. Hyperdimensional Information Theory](#2-hyperdimensional-information-theory)
    - [Decision: Shannon entropy + mutual information + HDC embedding framework](#decision-shannon-entropy--mutual-information--hdc-embedding-framework)
    - [Key Equations (15 provable formulas for thesis)](#key-equations-15-provable-formulas-for-thesis)
      - [2.1 Shannon Entropy for Ontology Complexity](#21-shannon-entropy-for-ontology-complexity)
      - [2.2 Mutual Information Preservation](#22-mutual-information-preservation)
      - [2.3 Semantic Fidelity Measure](#23-semantic-fidelity-measure)
      - [2.4 Multi-Target Superadditivity](#24-multi-target-superadditivity)
      - [2.5 Hyperdimensional Triple Encoding](#25-hyperdimensional-triple-encoding)
      - [2.6 Rate-Distortion Bound](#26-rate-distortion-bound)
    - [Key References](#key-references)
  - [3. @unrdf/kgc-4d Temporal Event Sourcing](#3-unrdfkgc-4d-temporal-event-sourcing)
    - [Decision: 4D temporal coordinate system with LogicalTime + GitBackbone](#decision-4d-temporal-coordinate-system-with-logicaltime--gitbackbone)
    - [Temporal Model](#temporal-model)
    - [Event Types](#event-types)
    - [GitBackbone Operations](#gitbackbone-operations)
    - [State Reconstruction Algorithm](#state-reconstruction-algorithm)
    - [Event Sourcing Calculus (Formal Definition)](#event-sourcing-calculus-formal-definition)
    - [Temporal SPARQL Extensions](#temporal-sparql-extensions)
    - [Theorems for Thesis Chapter 4](#theorems-for-thesis-chapter-4)
  - [4. @unrdf/hooks Knowledge Hooks Framework](#4-unrdfhooks-knowledge-hooks-framework)
    - [Decision: defineHook + executeHook + KnowledgeHookManager pattern](#decision-definehook--executehook--knowledgehookmanager-pattern)
    - [Hook Architecture](#hook-architecture)
    - [Hook Types](#hook-types)
    - [CRUD Lifecycle Hooks](#crud-lifecycle-hooks)
    - [SHACL Integration](#shacl-integration)
    - [Constraint Types (13 supported)](#constraint-types-13-supported)
    - [Formal Composition Model](#formal-composition-model)
  - [5. Thesis-Gen Architecture Patterns](#5-thesis-gen-architecture-patterns)
    - [Decision: Extend existing thesis-gen patterns with GUT-specific entities](#decision-extend-existing-thesis-gen-patterns-with-gut-specific-entities)
    - [Query Patterns (7 proven patterns)](#query-patterns-7-proven-patterns)
    - [Template Patterns (5 proven patterns)](#template-patterns-5-proven-patterns)
    - [Generation Rules (15 rules for complete thesis)](#generation-rules-15-rules-for-complete-thesis)
    - [Ordering Mechanism](#ordering-mechanism)
    - [Cross-Reference System](#cross-reference-system)
  - [6. Architecture Design](#6-architecture-design)
    - [Decision: 15-rule ggen.toml with layered ontology](#decision-15-rule-ggentoml-with-layered-ontology)
    - [Ontology Structure](#ontology-structure)
    - [Base IRI: `https://ggen.io/thesis/kgc-unified/`](#base-iri-httpsggeniothesiskgc-unified)
    - [Key Classes (17 total)](#key-classes-17-total)
    - [Key Properties (30+ properties)](#key-properties-30-properties)
    - [Architecture Decisions (20 ADRs)](#architecture-decisions-20-adrs)
    - [Scalability](#scalability)
  - [Summary: All NEEDS CLARIFICATION Resolved](#summary-all-needs-clarification-resolved)
