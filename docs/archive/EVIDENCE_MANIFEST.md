...
- [ggen Evidence & Research Data Manifest](#ggen-evidence--research-data-manifest)
  - [Evidence Catalog](#evidence-catalog)
    - [Primary Evidence Files](#primary-evidence-files)
      - [1. evidence_catalog.json (306 KB)](#1-evidence_catalogjson-306-kb)
      - [2. evidence_graph_v2.json (141 KB)](#2-evidence_graph_v2json-141-kb)
      - [3. evidence_graph.json (41 KB)](#3-evidence_graphjson-41-kb)
      - [4. relationships_graph.json (35 KB)](#4-relationships_graphjson-35-kb)
      - [5. breadth_expansion_report.json (34 KB)](#5-breadth_expansion_reportjson-34-kb)
      - [6. depth_expansion_report.json (50 KB)](#6-depth_expansion_reportjson-50-kb)
      - [7. evidence_mining_interim.json (27 KB)](#7-evidence_mining_interimjson-27-kb)
      - [8. evidence_nodes.json (23 KB)](#8-evidence_nodesjson-23-kb)
      - [9. concept_coverage.json (6.7 KB)](#9-concept_coveragejson-67-kb)
      - [10. concept_gaps.json (1.4 KB)](#10-concept_gapsjson-14-kb)
      - [11. graph_metrics.json (1.2 KB)](#11-graph_metricsjson-12-kb)
  - [Graph Processing Tools](#graph-processing-tools)
    - [1. graph_merger.py](#1-graph_mergerpy)
    - [2. synthesize_graph.py](#2-synthesize_graphpy)
    - [3. validate_graph_v2.py](#3-validate_graph_v2py)
  - [Evidence Organization Structure](#evidence-organization-structure)
    - [By Category](#by-category)
  - [Research Domains in Evidence](#research-domains-in-evidence)
  ...
  - [Accessing the Evidence](#accessing-the-evidence)
    - [Method 1: Direct JSON Query](#method-1-direct-json-query)
    - [Method 2: Graph Analysis](#method-2-graph-analysis)
    - [Method 3: Research Documents](#method-3-research-documents)
    - [Method 4: Concept Lookup](#method-4-concept-lookup)
  - [Evidence Quality Metrics](#evidence-quality-metrics)
    - [Coverage Analysis](#coverage-analysis)
    - [Graph Statistics](#graph-statistics)
  - [Evidence Integrity Validation](#evidence-integrity-validation)
    - [Validation Checklist](#validation-checklist)
    - [Running Validation](#running-validation)
  - [Synthesis & Analysis](#synthesis--analysis)
    - [Available Syntheses](#available-syntheses)
  - [Evidence-Driven Documentation](#evidence-driven-documentation)
    - [Link Chain](#link-chain)
  - [Usage Examples](#usage-examples)
    - [Find All Evidence on a Topic](#find-all-evidence-on-a-topic)
    - [Explore Concept Relationships](#explore-concept-relationships)
    - [Check Coverage Gaps](#check-coverage-gaps)
    - [View Graph Health](#view-graph-health)
  ...
  - [Recent Evidence Expansions](#recent-evidence-expansions)
    - [Breadth Expansion Areas](#breadth-expansion-areas)
    - [Depth Expansion Areas](#depth-expansion-areas)
  - [Evidence Access Patterns](#evidence-access-patterns)
  ...
  - [Research Corpus Size](#research-corpus-size)
  - [Future Evidence Directions](#future-evidence-directions)
