...
- [TESTING GAPS ANALYSIS - 80/20 Opportunities](#testing-gaps-analysis---8020-opportunities)
  - [Executive Summary](#executive-summary)
  - [1. ERROR PATH TESTING GAPS](#1-error-path-testing-gaps)
    - [High Priority: Result Types Without Error Tests](#high-priority-result-types-without-error-tests)
      - [**ggen-core/src/graph/store.rs**](#ggen-coresrcgraphstorers)
      - [**ggen-domain/src/project/gen.rs**](#ggen-domainsrcprojectgenrs)
      - [**ggen-core/src/cache.rs**](#ggen-coresrccachers)
      - [**ggen-domain/src/marketplace/validate.rs**](#ggen-domainsrcmarketplacevalidaters)
      - [**ggen-domain/src/hook/create.rs**](#ggen-domainsrchookcreaters)
      - [**ggen-core/src/templates/file_tree_generator.rs**](#ggen-coresrctemplatesfile_tree_generatorrs)
      - [**ggen-core/src/lockfile.rs**](#ggen-coresrclockfilers)
      - [**ggen-domain/src/project/init.rs**](#ggen-domainsrcprojectinitrs)
      - [**ggen-core/src/resolver.rs**](#ggen-coresrcresolverrs)
      - [**ggen-domain/src/marketplace/install.rs**](#ggen-domainsrcmarketplaceinstallrs)
  - [2. BOUNDARY CONDITION TESTING GAPS](#2-boundary-condition-testing-gaps)
    - [Critical Boundaries Not Tested](#critical-boundaries-not-tested)
      - [**ggen-domain/src/project/gen.rs**](#ggen-domainsrcprojectgenrs-1)
      - [**ggen-domain/src/marketplace/validate.rs**](#ggen-domainsrcmarketplacevalidaters-1)
      - [**ggen-core/src/templates/file_tree_generator.rs**](#ggen-coresrctemplatesfile_tree_generatorrs-1)
      - [**ggen-core/src/graph/core.rs**](#ggen-coresrcgraphcorers)
      - [**ggen-core/src/template_cache.rs**](#ggen-coresrctemplate_cachers)
      - [**ggen-domain/src/marketplace/search.rs**](#ggen-domainsrcmarketplacesearchrs)
  - [3. RESOURCE CLEANUP TESTING GAPS](#3-resource-cleanup-testing-gaps)
    - [File/Persistent Resources Without Proper Cleanup Tests](#filepersistent-resources-without-proper-cleanup-tests)
      - [**ggen-core/src/graph/store.rs**](#ggen-coresrcgraphstorers-1)
      - [**ggen-core/src/cache.rs**](#ggen-coresrccachers-1)
      - [**ggen-domain/src/hook/create.rs**](#ggen-domainsrchookcreaters-1)
      - [**ggen-domain/src/marketplace/install.rs**](#ggen-domainsrcmarketplaceinstallrs-1)
      - [**ggen-core/src/templates/file_tree_generator.rs**](#ggen-coresrctemplatesfile_tree_generatorrs-2)
      - [**ggen-core/src/lifecycle/loader.rs**](#ggen-coresrclifecycleloaderrs)
  - [4. CONCURRENCY TESTING GAPS](#4-concurrency-testing-gaps)
    - [Arc/Mutex Usage Without Concurrent Access Tests](#arcmutex-usage-without-concurrent-access-tests)
      - [**ggen-core/src/template_cache.rs**](#ggen-coresrctemplate_cachers-1)
      - [**ggen-core/src/graph/core.rs**](#ggen-coresrcgraphcorers-1)
      - [**ggen-core/src/rdf/template_metadata.rs**](#ggen-coresrcrdftemplate_metadatars)
      - [**Shared Patterns Across Crates**](#shared-patterns-across-crates)
  - [SPECIFIC CRITICAL FINDINGS](#specific-critical-findings)
    - [1. **Lock Poisoning Never Tested** (Critical)](#1-lock-poisoning-never-tested-critical)
    - [2. **Path Traversal Security Not Fully Tested** (Critical)](#2-path-traversal-security-not-fully-tested-critical)
    - [3. **Empty Collection Handling Not Tested** (High)](#3-empty-collection-handling-not-tested-high)
    - [4. **File Permission Error Scenarios Never Tested** (High)](#4-file-permission-error-scenarios-never-tested-high)
    - [5. **Async Error Paths Not Fully Tested** (Medium)](#5-async-error-paths-not-fully-tested-medium)
  - [RECOMMENDED PRIORITY FIXES (80/20)](#recommended-priority-fixes-8020)
    - [Top 5 High-Impact Tests to Add (20% effort, 80% coverage improvement)](#top-5-high-impact-tests-to-add-20-effort-80-coverage-improvement)
  - [FILES TO PRIORITIZE FOR TESTING](#files-to-prioritize-for-testing)
    - [ggen-core/src](#ggen-coresrc)
    - [ggen-domain/src](#ggen-domainsrc)
    - [ggen-cli/src](#ggen-clisrc)
