...
- **[Local-First Architecture](../explanation/local-first-architecture.md)** - Why we built it this way
- **[Reactive Sync Patterns](../explanation/reactive-sync-patterns.md)** - How ElectricSQL works under the hood
