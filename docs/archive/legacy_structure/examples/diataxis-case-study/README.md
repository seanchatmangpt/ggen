...
### 💡 [Explanations](explanation/) - Understand the Concepts

**Goal**: Deepen your understanding of how and why

- **[Local-First Architecture](explanation/local-first-architecture.md)** - Why local-first matters
- **[Reactive Data Sync Patterns](explanation/reactive-sync-patterns.md)** - How ElectricSQL works
- **[Component Composition](explanation/component-composition.md)** - shadcn/ui design philosophy
- **[Offline-First Trade-offs](explanation/offline-tradeoffs.md)** - When to use local-first
...
3. **Understand with Explanations** (30 min)
   - Read [Local-First Architecture](explanation/local-first-architecture.md)
...
# 3. Explanation
cat docs/examples/diataxis-case-study/explanation/local-first-architecture.md
...
**Understand concepts** → Read [Explanations](explanation/)
- Why local-first?
- How does sync work?
...
- [ggen Explanations](../explanation/) - Conceptual documentation
