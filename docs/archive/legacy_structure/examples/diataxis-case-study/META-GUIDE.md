...
**Action**: Read [Explanation: Local-First Architecture](explanation/local-first-architecture.md)
...
**See**: [Explanation: Local-First](explanation/local-first-architecture.md)
...
See [Explanation: Reactive Sync](../explanation/sync.md)
```
...
- [Explanation: Local-First](explanation/local-first-architecture.md) - Architecture
