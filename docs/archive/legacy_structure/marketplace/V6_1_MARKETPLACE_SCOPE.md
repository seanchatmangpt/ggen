...
This document defines the **marketplace / governed packs** slice targeted for the **v26.5.19** minor release. It complements (does not replace) security-focused items listed for v26.5.19 in [docs/security/V6_MIGRATION.md](../security/V6_MIGRATION.md) (API authentication, multi-tenant isolation, enhanced audit logging).

## Minimum shippable (v26.5.19 packs)
