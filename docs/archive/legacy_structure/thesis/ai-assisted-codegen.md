...
- [Thesis: AI-Assisted Code Generation](#thesis-ai-assisted-code-generation)
  ...
  - [Future Directions](#future-directions)
    - [1. Fine-Tuned Models (v26.5.19.0)](#1-fine-tuned-models-v265190)
    - [2. Agentic Generation (v26.5.19.0)](#2-agentic-generation-v265190)
    - [3. Continuous Learning (v26.5.19.2.0)](#3-continuous-learning-v2651920)
