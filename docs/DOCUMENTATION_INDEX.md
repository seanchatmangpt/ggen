...
- 🏗️ [`marketplace-architecture-summary.md`](marketplace-architecture-summary.md) - Marketplace architecture summary
- 📋 [`marketplace-registry-cache-architecture.md`](marketplace-registry-cache-architecture.md) - Full marketplace architecture specification
- 🎨 [`marketplace-architecture-diagram.md`](marketplace-architecture-diagram.md) - Visual architecture diagrams
- 🛠️ [`marketplace-implementation-guide.md`](marketplace-implementation-guide.md) - Step-by-step implementation guide
...
- 📚 [`API_REFERENCE_V2.4.0.md`](API_REFERENCE_V2.4.0.md) - Complete API reference for marketplace
...
#### **Core Architecture**
- 🎯 [`architecture/v2-architecture-complete.md`](architecture/v2-architecture-complete.md) - Complete architecture documentation
- 📊 [`architecture/p2p-integration-architecture.md`](architecture/p2p-integration-architecture.md) - P2P architecture
- 🤖 [`architecture/llm-integration-design.md`](architecture/llm-integration-design.md) - LLM integration design
- 🔄 [`architecture/V1_TO_V2_REFACTORING_ARCHITECTURE.md`](architecture/V1_TO_V2_REFACTORING_ARCHITECTURE.md) - Migration architecture

#### **Architecture Diagrams (PlantUML)**
- 📐 [`ggen-v1.2.0-current-state.puml`](ggen-v1.2.0-current-state.puml) - Complete system state visualization
- 🏗️ [`lifecycle-architecture.puml`](lifecycle-architecture.puml) - Lifecycle system architecture
- 🔄 [`lifecycle-flow.puml`](lifecycle-flow.puml) - Phase execution flow
- 📋 [`make-toml-rust-equivalent.puml`](make-toml-rust-equivalent.puml) - make.toml specification
- 🎨 [`production-readiness-8020.puml`](production-readiness-8020.puml) - Production readiness status
