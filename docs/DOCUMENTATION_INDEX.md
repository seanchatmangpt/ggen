...
- [📚 ggen Documentation Index](#-ggen-documentation-index)
  - [🎯 Quick Access](#-quick-access)
    - [🚀 **New to ggen? Start Here**](#-new-to-ggen-start-here)
  ...
  - [📖 Documentation Categories](#-documentation-categories)
    ...
    - [🧠 **AI Integration & Intelligence**](#-ai-integration--intelligence)
      - [**Core AI Documentation**](#core-ai-documentation)
      - [**Provider-Specific Guides**](#provider-specific-guides)
    - [🏭 **Lifecycle & Automation**](#-lifecycle--automation)
      - [**Core Lifecycle Documentation**](#core-lifecycle-documentation)
    ...
    - [📚 **Advanced Topics & Research**](#-advanced-topics--research)
    ...
    - [🏛️ **Architecture Documentation**](#-architecture-documentation)
      ...
      - [**Architecture Diagrams (PlantUML)**](#architecture-diagrams-plantuml)
  - [🎓 **Learning Paths & Tutorials**](#-learning-paths--tutorials)
    - [**Beginner Path** (Start here if new to ggen)](#beginner-path-start-here-if-new-to-ggen)
    - [**Intermediate Path** (For regular users)](#intermediate-path-for-regular-users)
    - [**Expert Path** (For contributors and advanced users)](#expert-path-for-contributors-and-advanced-users)
  ...
  - [🔍 **Search & Discovery**](#-search--discovery)
    - [**Topic-Based Search**](#topic-based-search)
    - [**Use Case Search**](#use-case-search)
  ...
  - [🔄 **Contributing to Documentation**](#-contributing-to-documentation)
    ...
    - [**Improving Existing Docs**](#improving-existing-docs)
    - [**Documentation Standards**](#documentation-standards)
  - [🎯 **Finding What You Need**](#-finding-what-you-need)
    - [**"How do I...?" Questions**](#how-do-i-questions)
    - [**"I need help with..." Scenarios**](#i-need-help-with-scenarios)
