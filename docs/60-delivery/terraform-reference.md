...
- [Terraform Reference - ggen Erlang Autonomic System](#terraform-reference---ggen-erlang-autonomic-system)
  - [📋 Overview](#-overview)
  - [🏗️ Module Index](#-module-index)
  - [Module 1: infra/state/ — Terraform State Backend](#module-1-infrastate--terraform-state-backend)
    - [Purpose](#purpose)
    - [Use Case](#use-case)
    ...
    - [Example tfvars.json](#example-tfvarsjson)
    - [Key Commands](#key-commands)
  - [Module 2: infra/shared/ — Shared VPC & Networks](#module-2-infrashared--shared-vpc--networks)
    - [Purpose](#purpose-1)
    - [Use Case](#use-case-1)
    - [Input Variables](#input-variables-1)
    - [Output Values](#output-values-1)
    - [Required IAM Roles](#required-iam-roles-1)
    - [Deployment Time](#deployment-time-1)
    - [Example tfvars.json](#example-tfvarsjson-1)
  - [Module 3: infra/catalog/ — Marketplace Catalog Infrastructure](#module-3-infracatalog--marketplace-catalog-infrastructure)
    - [Purpose](#purpose-2)
    - [Use Case](#use-case-2)
    - [Input Variables](#input-variables-2)
    - [Output Values](#output-values-2)
    - [Required IAM Roles](#required-iam-roles-2)
    - [Deployment Time](#deployment-time-2)
    - [Example tfvars.json](#example-tfvarsjson-2)
    - [for_each Pattern Example](#for_each-pattern-example)
  - [Module 4: infra/controller/ — Cloud Run Job + Cloud Scheduler](#module-4-infracontroller--cloud-run-job--cloud-scheduler)
    - [Purpose](#purpose-3)
    - [Use Case](#use-case-3)
    - [Input Variables](#input-variables-3)
    - [Output Values](#output-values-3)
    - [Required IAM Roles](#required-iam-roles-3)
    - [Deployment Time](#deployment-time-3)
    - [Example tfvars.json](#example-tfvarsjson-3)
  - [Module 5: infra/cloudbuild/ — CI/CD Pipeline](#module-5-infracloudbuild--cicd-pipeline)
    - [Purpose](#purpose-4)
    - [Use Case](#use-case-4)
    - [Input Variables](#input-variables-4)
    - [Output Values](#output-values-4)
    - [Required IAM Roles](#required-iam-roles-4)
    - [Deployment Time](#deployment-time-4)
    - [Example tfvars.json](#example-tfvarsjson-4)
  - [Module 6: infra/security/ — IAM, Service Accounts, Secrets](#module-6-infrasecurity--iam-service-accounts-secrets)
    - [Purpose](#purpose-5)
    - [Use Case](#use-case-5)
    - [Input Variables](#input-variables-5)
    - [Output Values](#output-values-5)
    - [Required IAM Roles](#required-iam-roles-5)
    - [Deployment Time](#deployment-time-5)
    - [Example tfvars.json](#example-tfvarsjson-5)
  - [Module 7: infra/firestore/ — Firestore Database + Collections](#module-7-infrafirestore--firestore-database--collections)
    - [Purpose](#purpose-6)
    - [Use Case](#use-case-6)
    - [Input Variables](#input-variables-6)
    - [Output Values](#output-values-6)
    - [Required IAM Roles](#required-iam-roles-6)
    - [Deployment Time](#deployment-time-6)
    - [Example tfvars.json](#example-tfvarsjson-6)
  - [Module 8: infra/pubsub/ — Pub/Sub Topics + Subscriptions](#module-8-infrapubsub--pubsub-topics--subscriptions)
    - [Purpose](#purpose-7)
    - [Use Case](#use-case-7)
    - [Input Variables](#input-variables-7)
    - [Output Values](#output-values-7)
    - [Required IAM Roles](#required-iam-roles-7)
    - [Deployment Time](#deployment-time-7)
    - [Example tfvars.json](#example-tfvarsjson-7)
  - [Module 9: infra/monitoring/ — Cloud Logging, Budgets, Alerts](#module-9-inframonitoring--cloud-logging-budgets-alerts)
    - [Purpose](#purpose-8)
    - [Use Case](#use-case-8)
    - [Input Variables](#input-variables-8)
    - [Output Values](#output-values-8)
    - [Required IAM Roles](#required-iam-roles-8)
    - [Deployment Time](#deployment-time-8)
    - [Example tfvars.json](#example-tfvarsjson-8)
  - [Module 10: infra/governance/ — Policy Constraints, Governance Rules](#module-10-infragovernance--policy-constraints-governance-rules)
    - [Purpose](#purpose-9)
    - [Use Case](#use-case-9)
    - [Input Variables](#input-variables-9)
    - [Output Values](#output-values-9)
    - [Required IAM Roles](#required-iam-roles-9)
    - [Deployment Time](#deployment-time-9)
    - [Example tfvars.json](#example-tfvarsjson-9)
  - [🔄 Common Patterns](#-common-patterns)
    - [Multi-SKU Deployment (for_each)](#multi-sku-deployment-for_each)
    - [Data Source Pattern (Query Existing Resources)](#data-source-pattern-query-existing-resources)
    - [Locals Pattern (Computed Values)](#locals-pattern-computed-values)
  ...
  - [🔑 Secrets Handling](#-secrets-handling)
    - [Correct Pattern: Secret Manager](#correct-pattern-secret-manager)
    - [Initialize Secret Manually](#initialize-secret-manually)
    - [Never in tfvars.json](#never-in-tfvarsjson)
  - [🌍 Workspace Strategy](#-workspace-strategy)
    - [tfvars per Workspace](#tfvars-per-workspace)
    - [State Isolation](#state-isolation)
  - [🗑️ Destroy Strategy](#-destroy-strategy)
    - [Destroyed Resources](#destroyed-resources)
    - [Preserved Resources](#preserved-resources)
    - [Safe Destroy](#safe-destroy)
  - [⚠️ Troubleshooting](#-troubleshooting)
    - [Error: Permission Denied](#error-permission-denied)
    - [Error: State Lock Held](#error-state-lock-held)
    - [Error: Backend Not Found](#error-backend-not-found)
    - [Error: Variable Type Mismatch](#error-variable-type-mismatch)
  - [📊 Deployment Time Summary](#-deployment-time-summary)
