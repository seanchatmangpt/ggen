...
- [Craftplan Integration Guide - Step-by-Step Setup](#craftplan-integration-guide---step-by-step-setup)
  ...
  - [Quick Start (5 minutes)](#quick-start-5-minutes)
    ...
    - [Step 3: Create Docker Compose File](#step-3-create-docker-compose-file)
    - [Step 4: Generate Secrets](#step-4-generate-secrets)
    - [Step 5: Build and Start Services](#step-5-build-and-start-services)
    - [Step 6: Verify Setup](#step-6-verify-setup)
    - [Step 7: Access the Services](#step-7-access-the-services)
  - [Development Setup](#development-setup)
    - [Option A: Develop A2A Agents (Rust)](#option-a-develop-a2a-agents-rust)
      - [1. Install Rust Toolchain](#1-install-rust-toolchain)
      - [2. Setup a2a-agents Project](#2-setup-a2a-agents-project)
      - [3. Local Development with Craftplan](#3-local-development-with-craftplan)
      - [4. Hot Reload Development](#4-hot-reload-development)
    - [Option B: Customize Craftplan (Elixir)](#option-b-customize-craftplan-elixir)
      - [1. Install Elixir/Erlang](#1-install-elixirerlang)
      - [2. Setup Craftplan for Development](#2-setup-craftplan-for-development)
      - [3. Access Development Tools](#3-access-development-tools)
    - [Option C: Full Stack Development](#option-c-full-stack-development)
      - [1. Terminal 1 - Craftplan (Elixir)](#1-terminal-1---craftplan-elixir)
      - [2. Terminal 2 - A2A Agents (Rust)](#2-terminal-2---a2a-agents-rust)
      - [3. Terminal 3 - A2A Client (Rust)](#3-terminal-3---a2a-client-rust)
      - [4. Browser](#4-browser)
  - [Agent Implementation Guide](#agent-implementation-guide)
    - [Agent Template](#agent-template)
    - [Register Agent](#register-agent)
    - [Add Agent to Server](#add-agent-to-server)
    - [Test Agent](#test-agent)
  - [Testing](#testing)
    - [Unit Tests (Rust)](#unit-tests-rust)
  ...
  - [Troubleshooting](#troubleshooting)
    - [Common Issues](#common-issues)
      - [1. "Connection refused" to Craftplan](#1-connection-refused-to-craftplan)
      - [2. "Invalid JWT" errors](#2-invalid-jwt-errors)
      - [3. Agent not responding](#3-agent-not-responding)
