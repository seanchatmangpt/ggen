...
use mcpp_marketplace::cache::{CacheConfig, CachedPack, PackCache};
use mcpp_marketplace::install::Installer;
use mcpp_marketplace::models::{PackageId, PackageVersion};
use mcpp_marketplace::registry::Registry;
...
fn test_installer_rejects_blocked_trust_tier() {
    ...
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        if matches!(blocked_tier, TrustTier::Blocked) {
            Err::<(), _>(mcpp_marketplace::error::Error::trust_tier_check_failed(
