...
impl Signature {
    pub fn new(algorithm: SignatureAlgorithm, value: Vec<u8>, public_key: PublicKey) -> Self {
        Self {
            algorithm,
            value,
            public_key,
    ...
    pub fn from_hex(
        algorithm: SignatureAlgorithm, hex_value: &str, public_key: PublicKey,
...
impl VerificationResult {
    ...
    pub fn to_result(&self) -> crate::error::Result<()> {
        match self {
            ...
            Self::UnsupportedAlgorithm => Err(crate::error::MarketplaceError::verification_error(
