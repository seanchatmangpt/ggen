...
impl MaturityEvaluator {
    ...
    fn evaluate_testing(
        test_coverage: f32, has_unit_tests: bool, has_integration_tests: bool, has_e2e_tests: bool,
    ) -> TestingScore {
    ...
    fn evaluate_performance(
        has_benchmarks: bool, has_optimization_docs: bool, determinism_verified: bool,
    ) -> PerformanceScore {
