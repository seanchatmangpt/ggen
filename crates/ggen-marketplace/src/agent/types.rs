...
//! facade.
//!
//! Ported verbatim from `ggen-core/src/agent/types.rs` into `ggen-cli` during the
...
//! tasks T048/T062: this file has no external dependencies beyond
//! `serde`/`thiserror`, so it moves unchanged both times.
//!
