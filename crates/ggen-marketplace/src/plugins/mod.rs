...
// Removed Default trait implementation - users must explicitly call PluginManager::new()
// which returns Result to handle potential WASM engine creation failures
