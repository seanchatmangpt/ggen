...
impl Bundles {
    ...
    pub fn mcp_rust() -> Bundle {
        Bundle::new(
            ...
            vec![
                AtomicPackId::new(
                    crate::marketplace::atomic::AtomicPackClass::SurfaceMcp,
                    "mcp".to_string(),
                ),
                AtomicPackId::new(
                    crate::marketplace::atomic::AtomicPackClass::ProjectionRust,
                    "rust".to_string(),
                ),
            ],
    ...
    pub fn mcp_rust_stdio() -> Bundle {
        Bundle::with_runtime(
            ...
            vec![
                ...
                AtomicPackId::new(
                    crate::marketplace::atomic::AtomicPackClass::RuntimeStdio,
                    "stdio".to_string(),
                ),
            ],
    ...
    pub fn mcp_rust_axum() -> Bundle {
        Bundle::with_runtime(
            ...
            vec![
                ...
                AtomicPackId::new(
                    crate::marketplace::atomic::AtomicPackClass::RuntimeAxum,
                    "axum".to_string(),
                ),
            ],
    ...
    pub fn a2a_rust() -> Bundle {
        Bundle::new(
            ...
            vec![
                AtomicPackId::new(
                    crate::marketplace::atomic::AtomicPackClass::SurfaceA2a,
                    "a2a".to_string(),
                ),
                AtomicPackId::new(
                    crate::marketplace::atomic::AtomicPackClass::ProjectionRust,
    ...
    pub fn openapi_rust() -> Bundle {
        Bundle::new(
            ...
            vec![
                AtomicPackId::new(
                    crate::marketplace::atomic::AtomicPackClass::ContractOpenapi,
                    "openapi".to_string(),
                ),
                AtomicPackId::new(
                    crate::marketplace::atomic::AtomicPackClass::ProjectionRust,
    ...
    pub fn graphql_typescript() -> Bundle {
        Bundle::new(
            ...
            vec![
                AtomicPackId::new(
                    crate::marketplace::atomic::AtomicPackClass::ContractGraphql,
                    "graphql".to_string(),
                ),
                AtomicPackId::new(
                    crate::marketplace::atomic::AtomicPackClass::ProjectionTypescript,
