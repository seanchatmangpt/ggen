...
impl FileSystemRepository {
    ...
    pub fn discover() -> Result<Self> {
        ...
        Err(Error::Other(
            "Packs directory not found. Expected marketplace/packs/ or ~/.ggen/packs/".to_string(),
        ))
    }
    ...
    fn validate_pack_id(&self, pack_id: &str) -> Result<()> {
        ...
        {
            return Err(Error::Other(
                "Invalid pack ID: must contain only alphanumeric characters, hyphens, and underscores".to_string(),
            ));
        }
