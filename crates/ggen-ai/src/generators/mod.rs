//! AI-powered generators for mcpp
//!
...
//! ## Generators
//!
//! - **TemplateGenerator**: Generate mcpp templates from natural language descriptions
...
//! ## Features
//!
//! - **Multi-provider Support**: Works with any LLM provider configured in mcpp-ai
