...
pub struct CliProject {
    ...
    /// CLI crate name (e.g., "my-cli") - 2026 extension
    #[serde(default)]
    pub cli_crate: Option<String>,
    /// Domain crate name (e.g., "my-core") - 2026 extension
    #[serde(default)]
    pub domain_crate: Option<String>,
    /// Workspace resolver version (default: "2") - 2026 extension
...
pub struct Verb {
    ...
    /// Domain function path (e.g., "my_core::user::create_user") - 2026 extension
    #[serde(default)]
    pub domain_function: Option<String>,
    /// Domain module path (e.g., "user") - 2026 extension
    #[serde(default)]
