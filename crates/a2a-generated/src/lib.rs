// Generated by mcpp from A2A ontology
// Do not edit - regenerate with: mcpp sync

//! A2A-RS Integration Code
//!
//! This module contains the A2A (Agent-to-Agent) protocol integration code generated
//! from the RDF ontology by mcpp. It provides type-safe interfaces for agent communication,
