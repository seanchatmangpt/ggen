...
impl Default for PokaYokeConfig {
    fn default() -> Self {
        Self {
            generated_file_header: "DO NOT EDIT - This file is auto-generated by mcpp".into(),
            gitignore_patterns: vec![".mcpp/".into()],
            gitattributes_patterns: vec![".mcpp/** linguist-generated=true".into()],
        }
    }
}
