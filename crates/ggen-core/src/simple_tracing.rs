...
//!
//! ```rust,no_run
//! use mcpp_core::simple_tracing::SimpleTracer;
//! use std::path::Path;
//!
...
//!
//! ```rust,no_run
//! use mcpp_core::simple_tracing::SimpleTimer;
//!
...
impl SimpleTracer {
    ...
    /// Log error
    pub fn error(error: &mcpp_utils::error::Error, context: &str) {
        Self::trace(
            TraceLevel::Error,
