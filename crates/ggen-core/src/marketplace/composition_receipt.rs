        ...
        F: Fn(&str) -> Result<CompositionReceipt>,
    {
        ...
        loop {
            ...
            if depth > MAX_CHAIN_DEPTH {
                return Err(crate::marketplace::error::Error::ValidationFailed {
...
mod tests {
    ...
    fn test_validate_chain_on_root() {
        ...
        let result = root.validate_chain(|_| {
            Err(crate::marketplace::error::Error::ValidationFailed {
    ...
    fn create_test_receipt_for_adv(id: &str) -> CompositionReceipt {
        ...
        r.receipt_id = Some(id.to_string());
        r
    }

    #[test]
    fn test_adversarial_fake_hash_in_middle() {
        let r1 = create_test_receipt_for_adv("operator1");
        ...
        let resolver = |id: &str| -> Result<CompositionReceipt> {
            ...
            // Resolver is tricked
                ...
                Err(crate::marketplace::error::Error::PackageNotFound {
