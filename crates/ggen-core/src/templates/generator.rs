...
//!
//! ```rust,no_run
//! use mcpp_core::templates::{FileTreeTemplate, TemplateContext, generate_file_tree};
//! use mcpp_core::templates::format::{TemplateFormat, FileTreeNode, NodeType};
//! use std::path::Path;
//!
...
///
/// ```rust,no_run
/// use mcpp_core::templates::generator::FileTreeGenerator;
/// use mcpp_core::templates::{FileTreeTemplate, TemplateContext};
...
impl FileTreeGenerator {
    ...
    fn generate_node(
        ...
        let rendered_name = self.context.render_string(&node.name).map_err(|e| {
            mcpp_utils::error::Error::with_context(
...
///
/// ```rust
/// use mcpp_core::templates::generator::GenerationResult;
///
