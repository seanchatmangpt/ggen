...
//!
//! ```rust
//! use mcpp_core::rdf::query_builder::{SparqlQueryBuilder, Variable, Iri};
//!
...
//!
//! ```rust
//! use mcpp_core::rdf::query_builder::{SparqlQueryBuilder, Iri};
//!
//! # fn main() -> mcpp_utils::error::Result<()> {
...
impl Iri {
    ...
    ///
    /// ```rust
    /// use mcpp_core::rdf::query_builder::Iri;
    ///
    /// # fn main() -> mcpp_utils::error::Result<()> {
...
impl Variable {
    ...
    ///
    /// ```rust
    /// use mcpp_core::rdf::query_builder::Variable;
    ///
    /// # fn main() -> mcpp_utils::error::Result<()> {
...
impl Literal {
    ...
    ///
    /// ```rust
    /// use mcpp_core::rdf::query_builder::Literal;
    ///
...
impl SparqlQueryBuilder<Select, Building> {
    ...
    ///
    /// ```rust
    /// use mcpp_core::rdf::query_builder::SparqlQueryBuilder;
    ///
