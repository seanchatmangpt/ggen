...
mod adapter_conversion_tests {
    ...
    use mcpp_marketplace_v2::models::{Package as V2Package, PackageId, PackageVersion};

    /// Helper: Create V1 test package
    fn create_v1_package(id: &str, name: &str, version: &str) -> V1Package {
        use chrono::Utc;
        use mcpp_marketplace::{MaturityLevel, PackageMetadata};
    ...
    fn v1_to_v2(v1: &V1Package) -> V2Package {
        use chrono::Utc;
        use mcpp_marketplace_v2::models::PackageMetadata as V2Metadata;
