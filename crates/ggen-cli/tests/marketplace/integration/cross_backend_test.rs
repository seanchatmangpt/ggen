...
mod cross_backend_tests {
    use chrono::Utc;
    use mcpp_marketplace::Package as V1Package;
    use mcpp_marketplace_v2::models::Package as V2Package;
    ...
    fn create_test_packages(id: &str, name: &str, version: &str) -> (V1Package, V2Package) {
        use mcpp_marketplace::{MaturityLevel, PackageMetadata as V1Meta};
        use mcpp_marketplace_v2::models::{PackageId, PackageMetadata as V2Meta, PackageVersion};
