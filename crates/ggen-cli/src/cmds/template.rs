...
fn new(name: String, template_type: Option<String>) -> NounVerbResult<NewOutput> {
    use mcpp_domain::template::new as template_new;
    use mcpp_domain::template::TemplateService;
...
fn generate_tree(
    ...
    use mcpp_domain::template::generate_tree;
