...
/// ```
#[verb]
fn init(name: String, workflow_type: Option<String>, output_dir: Option<PathBuf>) -> Result<WorkflowInitOutput> {
...
/// ```
#[verb]
fn discover(workflow_file: String, export_format: Option<String>, pareto: bool) -> Result<WorkflowDiscoveryOutput> {
    let _workflow_file = workflow_file;
...
/// ```
#[verb]
fn report(workflow_file: String, format: Option<String>, output: Option<String>) -> Result<serde_json::Value> {
    let _workflow_file = workflow_file;
