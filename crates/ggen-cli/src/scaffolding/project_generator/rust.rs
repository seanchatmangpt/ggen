...
//!
//! ```rust,no_run
//! use ggen_cli_lib::scaffolding::project_generator::{ProjectConfig, ProjectType, ProjectGenerator};
//! use ggen_cli_lib::scaffolding::project_generator::rust::RustProjectGenerator;
