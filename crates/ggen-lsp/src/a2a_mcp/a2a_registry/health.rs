...
use crate::a2a_mcp::a2a_registry::error::RegistryError;
use crate::a2a_mcp::a2a_registry::store::AgentStore;
use crate::a2a_mcp::a2a_registry::types::HealthStatus;

// Re-export so downstream consumers can use `crate::a2a_mcp::a2a_registry::HealthConfig`.
#[doc(hidden)]
pub use crate::a2a_mcp::a2a_registry::types::HealthConfig;
...
async fn check_single_agent(
    agent: &crate::a2a_mcp::a2a_registry::types::AgentEntry, config: &HealthConfig,
) -> HealthStatus {
...
pub async fn ping_agent(
    agent: &crate::a2a_mcp::a2a_registry::types::AgentEntry, ping_timeout: Duration,
