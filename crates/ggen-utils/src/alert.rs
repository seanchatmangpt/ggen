...
//!
//! ```rust
//! use mcpp_utils::alert_critical;
//! use mcpp_utils::alert_warning;
//! use mcpp_utils::alert_info;
//!
...
///
/// ```rust
/// use mcpp_utils::alert::write_alert;
