...
//!
//! ```rust
//! use ggen_core::utils::safe_command::{SafeCommand, CommandName, CommandArg};
//!
//! // Valid command
...
impl CommandName {
    ...
    ///
    /// ```rust
    /// use ggen_core::utils::safe_command::CommandName;
    ///
    /// // Valid commands
...
impl CommandArg {
    ...
    ///
    /// ```rust
    /// use ggen_core::utils::safe_command::CommandArg;
    ///
    /// // Valid arguments
