...
//!
//! Implements `[generation.poka_yoke].warning_headers` behavior from mcpp.toml
...
/// Mirrors [generation.poka_yoke] from mcpp.toml.
...
///
/// Local definition to avoid cyclic dependency with mcpp-config.
/// Mirrors [generation] from mcpp.toml.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
...
impl HeaderInjectionConfig {
    ...
    pub fn from_config(config: &GenerationSafetyConfig) -> Self {
        ...
        let header_text = config.generated_header.clone().unwrap_or_else(|| {
            "DO NOT EDIT - Generated by mcpp. Changes will be overwritten.".to_string()
        });
    ...
    pub fn default_config() -> Self {
        Self {
            enabled: true,
            header_text: "DO NOT EDIT - Generated by mcpp. Changes will be overwritten."
                .to_string(),
        }
    }
