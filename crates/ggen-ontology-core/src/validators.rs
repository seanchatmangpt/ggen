...
///
/// ```rust,no_run
/// use mcpp_ontology_core::validators::validate_rdf_xml;
///
...
///
/// ```rust,no_run
/// use mcpp_ontology_core::validators::validate_sparql_query;
///
...
///
/// ```rust,no_run
/// use mcpp_ontology_core::validators::validate_ontology;
///
