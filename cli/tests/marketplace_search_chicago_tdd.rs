...
// ============================================================================
// AUTHOR FILTERING TESTS - 2 tests
// ============================================================================
...
// ============================================================================
// STAR/DOWNLOAD FILTERING TESTS - 3 tests
// ============================================================================
...
// ============================================================================
// PAGINATION AND LIMITING TESTS - 3 tests
// ============================================================================
...
async fn test_search_unicode_characters() -> Result<()> {
    ...
    create_test_index(
        temp_dir.path(),
        vec![
            TestPackage::new("tool-with-umlaut").description("Tool with ümlauts"),
            TestPackage::new("japanese-tool").description("日本語ツール"),
            TestPackage::new("emoji-tool").description("Tool 🚀"),
        ],
    )?;
