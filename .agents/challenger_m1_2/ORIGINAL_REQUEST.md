...
You are Challenger 2 for Milestone M1 (Setup & Scaffolding).
Your working directory is `/Users/sac/ggen/.agents/challenger_m1_2`.
...
Output: Write a detailed challenge report to `/Users/sac/ggen/.agents/challenger_m1_2/handoff.md` summarizing build commands run and test successes.
