...
mod tests {
    ...
    fn test_coverage_data_serialization() {
        ...
        assert_eq!(
            data.line_coverage_percentage,
            deserialized.line_coverage_percentage
        );
        assert_eq!(
            data.branch_coverage_percentage,
            deserialized.branch_coverage_percentage
        );
        assert_eq!(
            data.function_coverage_percentage,
            deserialized.function_coverage_percentage
        );
    }
    ...
    fn test_coverage_data_add_uncovered_branch() {
        ...
        assert_eq!(
            data.uncovered_branches.get("src/main.rs"),
            Some(&vec!["if condition".to_string()])
        );
        assert_eq!(
            data.uncovered_branches.get("src/lib.rs"),
            Some(&vec!["match arm".to_string()])
        );
    }
    ...
    fn test_coverage_data_add_uncovered_function() {
        ...
        assert_eq!(
            data.uncovered_functions.get("src/main.rs"),
            Some(&vec!["test_function".to_string()])
        );
        assert_eq!(
            data.uncovered_functions.get("src/lib.rs"),
            Some(&vec!["helper_function".to_string()])
        );
    }
    ...
    fn test_coverage_data_clone() {
        ...
        assert_eq!(
            data1.overall_coverage_percentage,
            data2.overall_coverage_percentage
        );
