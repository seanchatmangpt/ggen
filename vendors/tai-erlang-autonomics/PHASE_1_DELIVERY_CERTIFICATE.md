...
### Production Code
```
~/.ggen/mcpp/tai-erlang-autonomics/pricing-engine/src/
...
### Test Suite
```
~/.ggen/mcpp/tai-erlang-autonomics/pricing-engine/test/
...
### Examples
```
~/.ggen/mcpp/tai-erlang-autonomics/pricing-engine/examples/
├── eval_mode_integration_example.erl   [250 LOC]
├── receipt_ledger_example.erl          [540 LOC]
└── detailed_epoch_rotation_example.erl [300+ LOC]
```
