...
**File**: `./tai-erlang-autonomics/apps/tai_autonomics/src/tai_receipts.erl`
...
**File**: `./tai-erlang-autonomics/apps/tai_autonomics/test/tai_receipts_tests.erl`
**Size**: 26 KB
**Lines**: 450+
...
**Primary**: `./tai-erlang-autonomics/docs/RECEIPT_ENGINE_PHASE_1.md`
...
**Secondary**: `./tai-erlang-autonomics/examples/RECEIPT_SAMPLE_OUTPUT.txt`
