...
### 1. Production Module
**File**: `~/.ggen/mcpp/tai-erlang-autonomics/pricing-engine/src/ac_eval_mode.erl`
...
### 2. Test Suite
**File**: `~/.ggen/mcpp/tai-erlang-autonomics/pricing-engine/test/ac_eval_mode_tests.erl`
...
**File**: `~/.ggen/mcpp/tai-erlang-autonomics/pricing-engine/docs/AC_EVAL_MODE.md`
...
### 4. Quick Reference
**File**: `~/.ggen/mcpp/tai-erlang-autonomics/pricing-engine/docs/EVAL_MODE_QUICK_REFERENCE.md`
...
**File**: `~/.ggen/mcpp/tai-erlang-autonomics/pricing-engine/examples/eval_mode_integration_example.erl`
...
**File**: `~/.ggen/mcpp/tai-erlang-autonomics/pricing-engine/EVAL_MODE_IMPLEMENTATION.md`
...
### 7. Executive Summary
**File**: `~/.ggen/mcpp/tai-erlang-autonomics/pricing-engine/README_EVAL_MODE.md`
