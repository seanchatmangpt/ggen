...
**File**: `./tai-erlang-autonomics/tools/gcp-build-image.sh` (11 KB)
...
**File**: `./tai-erlang-autonomics/tools/gcp-verify-deployment.sh` (13 KB)
...
**File**: `./tai-erlang-autonomics/DEPLOYMENT_GUIDE.md` (8 KB)
...
**File**: `./tai-erlang-autonomics/.env.example` (5.5 KB)
...
**File**: `./tai-erlang-autonomics/.github/workflows/release-deploy.yml` (7.5 KB)
...
### Files Delivered
1. `./tai-erlang-autonomics/tools/gcp-build-image.sh` (11 KB)
2. `./tai-erlang-autonomics/tools/gcp-verify-deployment.sh` (13 KB)
3. `./tai-erlang-autonomics/DEPLOYMENT_GUIDE.md` (8 KB)
4. `./tai-erlang-autonomics/.env.example` (5.5 KB)
5. `./tai-erlang-autonomics/.github/workflows/release-deploy.yml` (7.5 KB)
