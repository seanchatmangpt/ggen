...
- `./tai-erlang-autonomics/docs/TAIEA_GOVERNOR_STATE_GRAPH.md` - Full state machine specification
- Module source: `./tai-erlang-autonomics/apps/tai_autonomics/src/taiea_governor.erl`
- Test suite: `./tai-erlang-autonomics/apps/tai_autonomics/test/taiea_governor_SUITE.erl`
