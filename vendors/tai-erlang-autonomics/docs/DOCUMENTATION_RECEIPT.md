...
**File**: `./tai-erlang-autonomics/docs/ARCHITECTURE.md`
...
**File**: `./tai-erlang-autonomics/docs/DEVELOPER_GUIDE.md`
...
**File**: `./tai-erlang-autonomics/docs/OPERATIONAL_GUIDE.md`
...
### 4. README.md (Updated ✓)
**File**: `./tai-erlang-autonomics/README.md`
...
**File**: `./tai-erlang-autonomics/CONTRIBUTING.md`
...
### 6. .gitignore (Updated ✓)
**File**: `./tai-erlang-autonomics/.gitignore`
