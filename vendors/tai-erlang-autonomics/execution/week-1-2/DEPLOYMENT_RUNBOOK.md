...
chmod +x ./tai-erlang-autonomics/execution/week-1-2/firestore-schema-init.sh

# Run schema initialization
./tai-erlang-autonomics/execution/week-1-2/firestore-schema-init.sh \
  $PROJECT_ID \
  "us-central1"
...
```bash
chmod +x ./tai-erlang-autonomics/execution/week-1-2/monitoring-alerts-setup.sh

./tai-erlang-autonomics/execution/week-1-2/monitoring-alerts-setup.sh \
  $PROJECT_ID \
  "us-central1" \
  "tai-autonomics"
