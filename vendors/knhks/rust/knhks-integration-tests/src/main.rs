// rust/knhks-integration-tests/src/main.rs
...
async fn test_kafka_connector_integration() -> Result<()> {
    ...
    use knhks_connectors::{KafkaConnector, DataFormat};
...
async fn test_end_to_end_integration() -> Result<()> {
    ...
    use knhks_etl::integration::IntegratedPipeline;
