// knhks-hot v1.0 — Rust hot API (FFI-safe, ≤8 ticks)
...
#[link(name = "knhks")]
extern "C" {
    pub fn knhks_init_ctx(ctx: *mut Ctx, S: *const u64, P: *const u64, O: *const u64);
    pub fn knhks_pin_run(ctx: *mut Ctx, run: Run);
    pub fn knhks_eval_bool(ctx: *const Ctx, ir: *mut Ir, rcpt: *mut Receipt) -> i32;
    pub fn knhks_eval_construct8(ctx: *const Ctx, ir: *mut Ir, rcpt: *mut Receipt) -> i32;
    pub fn knhks_eval_batch8(ctx: *const Ctx, irs: *mut Ir, n: usize, rcpts: *mut Receipt) -> i32;
}
...
impl Engine {
    ...
    pub fn new(s: *const u64, p: *const u64, o: *const u64) -> Self {
        ...
        unsafe { knhks_init_ctx(&mut ctx, s, p, o) };
        Self { ctx }
    }
    ...
    pub fn pin_run(&mut self, run: Run) -> Result<(), &'static str> {
        ...
        unsafe { knhks_pin_run(&mut self.ctx, run) };
        Ok(())
    }

    /// μ: boolean reflex, τ ≤ 8. Returns bool and fills rcpt.
    pub fn eval_bool(&self, ir: &mut Ir, rcpt: &mut Receipt) -> bool {
        let r = unsafe { knhks_eval_bool(&self.ctx as *const Ctx, ir as *mut Ir, rcpt as *mut Receipt) };
        r != 0
    }
    ...
    pub fn eval_construct8(&self, ir: &mut Ir, rcpt: &mut Receipt) -> usize {
        let n = unsafe { knhks_eval_construct8(&self.ctx as *const Ctx, ir as *mut Ir, rcpt as *mut Receipt) };
        n as usize
    }
    ...
    pub fn eval_batch8(&self, irs: &mut [Ir; NROWS], n: usize, rcpts: &mut [Receipt; NROWS]) -> usize {
        ...
        let got = unsafe {
            knhks_eval_batch8(&self.ctx as *const Ctx, irs.as_mut_ptr(), n, rcpts.as_mut_ptr())
        };
        got as usize
    }
