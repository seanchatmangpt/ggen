...
pub mod cli_validation {
    ...
    pub fn validate_cli_binary_exists() -> ValidationResult {
        ...
        let cli_paths = [
            "target/release/knhks",
            "target/release/knhks.exe",
            "target/debug/knhks",
            "target/debug/knhks.exe",
        ];
...
pub mod configuration_validation {
    ...
    pub fn validate_config_file_parsing() -> ValidationResult {
        ...
        let config_path = std::path::Path::new("~/.knhks/config.toml");
        ValidationResult {
            passed: true,
...
pub mod performance_validation {
    ...
    pub fn validate_hot_path_performance() -> ValidationResult {
        use knhks_hot::{Engine, Op, Ir, Receipt, Run};
