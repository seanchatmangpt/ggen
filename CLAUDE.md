...
Stack: Rust (nightly, pinned via `rust-toolchain.toml`) | Tokio | Oxigraph | Tera | Serde | Clap | Chicago TDD ONLY | 14-crate workspace
...
| Lifecycle order (SPARQL over RDF) | `ggen-graph/ocel/lifecycle.rs` (see its own module docstring for the scoped-exception rationale) | pm4py, subprocess, Python |
