// Traditional Approach: Hand-written authentication logic
// File: auth.rs (147 LOC)
...
use types::{User, Session};
use errors::AuthError;

/// In-memory authentication service (for demonstration)
...
impl AuthService {
    ...
    /// Register a new user
    pub fn register(&mut self, email: String, password: String) -> Result<User, AuthError> {
        // Validate email
    ...
    pub fn login(&mut self, email: String, password: String) -> Result<Session, AuthError> {
        // Find user
        let user = self.users
            .get(&email)
...
// Manual documentation in separate README.md file
// Manual tests in separate auth_test.rs file
// Manual error handling throughout
// Manual validation logic scattered across methods
