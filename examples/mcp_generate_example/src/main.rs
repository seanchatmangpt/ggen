...
async fn main() -> Result<()> {
    ...
    let ontology_path = concat!(env!("CARGO_MANIFEST_DIR"), "/../../.specify/specs/016-self-play/ggen-meta.ttl");
  ...
  "id": 1
    ...
    println!("   cd . && cargo run --bin ggen -- sync --ontology {} --output {}", ontology_path, output_dir);
