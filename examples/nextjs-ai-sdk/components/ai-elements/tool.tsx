...
export function Tool({ defaultOpen, className, ...props }: HTMLAttributes<HTMLDetailsElement> & { defaultOpen?: boolean }) { return <details open={defaultOpen} className={cn("w-full rounded-lg border", className)} {...props} />; }
