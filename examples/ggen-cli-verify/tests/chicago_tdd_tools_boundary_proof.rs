...
const EXPECTED: [ExpectedBoundaryTest; EXPECTED_TEST_COUNT] = [
    // ggen_graph_validate_missing_file_fails_closed
    ExpectedBoundaryTest {
        fn_signature: "fn ggen_graph_validate_missing_file_fails_closed()",
        exit_code_field: "exit_code: 1,",
        stdout_field: None,
        stderr_field: Some("stderr_needle: Some(\"file(s) invalid\"),"),
        axiom_doc: "/// Covers: graph validate against a nonexistent file fails closed with a named-file error, not a panic",
    },
    // ggen_help_lists_usage
    ExpectedBoundaryTest {
        fn_signature: "fn ggen_help_lists_usage()",
        exit_code_field: "exit_code: 0,",
        stdout_field: Some("stdout_needle: Some(\"Usage\"),"),
        stderr_field: None,
        axiom_doc: "/// Covers: ggen --help exits 0 with usage text",
    },
    // ggen_unknown_subcommand_fails_closed
    ExpectedBoundaryTest {
        fn_signature: "fn ggen_unknown_subcommand_fails_closed()",
        exit_code_field: "exit_code: 1,",
        stdout_field: None,
        stderr_field: Some("stderr_needle: Some(\"unrecognized subcommand\"),"),
        axiom_doc: "/// Covers: an unknown ggen subcommand exits nonzero with a clap error on stderr",
    },
    // ggen_version_emits_name
    ExpectedBoundaryTest {
        fn_signature: "fn ggen_version_emits_name()",
        exit_code_field: "exit_code: 0,",
        stdout_field: Some("stdout_needle: Some(\"ggen \"),"),
        stderr_field: None,
        axiom_doc: "/// Covers: ggen --version exits 0 and prints its own name and version",
    },
