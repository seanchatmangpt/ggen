...
impl CentralizedRegistry {
    ...
    pub fn new(base_url: impl Into<String>) -> Result<Self> {
        let client = reqwest::Client::builder()
            ...
            .build()
            .map_err(|e| MarketplaceError::network_error(e.to_string(), "registry client"))?;
    ...
    async fn fetch_index(&self) -> Result<RegistryIndex> {
        ...
        response
            .json::<RegistryIndex>()
            .await
            .map_err(|e| MarketplaceError::parse_error(e.to_string(), "registry index"))
    }
    ...
    async fn search_with_retry(&self, query: &Query, retries: usize) -> Result<Vec<Package>> {
        ...
        Err(last_error.unwrap_or_else(|| {
            MarketplaceError::network_error("all retries failed", "search")
        }))
    }
    ...
    async fn search_internal(&self, query: &Query) -> Result<Vec<Package>> {
        ...
        let search_response: SearchResponse = response
            .json()
            .await
            .map_err(|e| MarketplaceError::parse_error(e.to_string(), "search response"))?;
...
impl Registry for CentralizedRegistry {
    ...
    async fn get_package(&self, id: &PackageId) -> Result<Package> {
        ...
        response
            .json::<Package>()
            .await
            .map_err(|e| MarketplaceError::parse_error(e.to_string(), "package"))
    }
    ...
    async fn get_package_version(&self, id: &PackageId, version: &str) -> Result<Package> {
        ...
        response
            .json::<Package>()
            .await
            .map_err(|e| MarketplaceError::parse_error(e.to_string(), "package version"))
    }
    ...
    async fn list_versions(&self, id: &PackageId) -> Result<Vec<Package>> {
        ...
        let versions_response: VersionsResponse = response
            .json()
            .await
            .map_err(|e| MarketplaceError::parse_error(e.to_string(), "versions list"))?;
    ...
    async fn metadata(&self) -> Result<RegistryMetadata> {
        ...
        response
            ...
            .await
            .map_err(|e| MarketplaceError::parse_error(e.to_string(), "registry metadata"))
    }
}
