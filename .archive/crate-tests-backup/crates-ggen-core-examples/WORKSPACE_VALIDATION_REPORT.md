...
### 1. Root Cargo.toml (./ggen-core/examples/Cargo.toml)
...
### 2. Master make.toml (./ggen-core/examples/make.toml)
...
### 3. Comprehensive README.md (./ggen-core/examples/README.md)
...
### 4. Environment Configuration (./ggen-core/examples/.env.example)
...
### 5. CI/CD Pipeline (./ggen-core/examples/.github/workflows/examples-ci.yml)
...
### 6. Build Artifact Exclusions (./ggen-core/examples/.gitignore)
...
**Workspace Location**: `./ggen-core/examples/`
